...
| --------------------- | --------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------- |
| `autoclose`           | `autoclose`           | toast notification can close by itself                                                       | `number`                                                                                                                                                                                                                                                                                                                                                                                         | `undefined` |
| `closebutton`         | `closebutton`         | toast notification's closing icon                                                            | `boolean`                                                                                                                                                                                                                                                                                                                                                                                        | `undefined` |
...
| `transition`          | `transition`          | toast notification animation type: slide-in-left, slide-in-right, slide-in-down, slide-in-up | `ToastNotificationTransisionsEnum.slideInDown \| ToastNotificationTransisionsEnum.slideInLeft \| ToastNotificationTransisionsEnum.slideInRight \| ToastNotificationTransisionsEnum.slideInUp \| ToastNotificationTransisionsEnum.slideOutDown \| ToastNotificationTransisionsEnum.slideOutLeft \| ToastNotificationTransisionsEnum.slideOutRight \| ToastNotificationTransisionsEnum.slideOutUp` | `undefined` |
