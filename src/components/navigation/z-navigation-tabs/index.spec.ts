...
describe("Suite test ZNavigationTabs", () => {
  it("Test render ZNavigationTab Horizontal", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-navigation-tabs class="interactive-1" role="tablist" orientation="horizontal" size="big">
        <mock:shadow-root>
          <nav>
            <slot></slot>
          </nav>
  ...
  it("Test render ZNavigationTab Horizontal small", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-navigation-tabs class="interactive-2" role="tablist" orientation="horizontal" size="small">
        <mock:shadow-root>
          <nav>
            <slot></slot>
          </nav>
  ...
  it("Test render ZNavigationTab Vertical", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-navigation-tabs class="interactive-1" role="tablist" size="big" orientation="vertical">
        <mock:shadow-root>
          <nav>
            <slot></slot>
          </nav>
