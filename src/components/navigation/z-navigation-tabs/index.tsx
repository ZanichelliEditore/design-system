...
export class ZNavigationTabs {
  ...
  @Prop({ reflect: true }) orientation?: TabOrientationBean =
    TabOrientationEnum.horizontal;
  ...
  @State() direction: "Top" | "Left" =
    this.orientation == TabOrientationEnum.vertical ? "Top" : "Left";
  @State() dimension: "Height" | "Width" =
    this.orientation == TabOrientationEnum.vertical ? "Height" : "Width";
  ...
  checkScrollVisible() {
    ...
    this.canNavigate =
      ...
      this.tabsNav[`client${this.dimension}`];
  ...
  checkScrollEnabled() {
    ...
    this.canNavigateNext =
      this.tabsNav[`scroll${this.direction}`] +
        this.tabsNav[`client${this.dimension}`] <
      this.tabsNav[`scroll${this.dimension}`];
  ...
  navigatePrevious() {
    this.tabsNav.scrollBy({
      [this.direction.toLowerCase()]:
        0 - this.tabsNav[`client${this.dimension}`] / 2,
      behavior: "smooth",
    });
  }
  ...
  navigateNext() {
    this.tabsNav.scrollBy({
      [this.direction.toLowerCase()]:
        this.tabsNav.scrollTop + this.tabsNav[`client${this.dimension}`] / 2,
      behavior: "smooth",
    });
  }
  ...
  render() {
    return (
      <Host
        class={this.size === "small" ? "interactive-2" : "interactive-1"}
      ...
      >
        {this.canNavigate && (
          ...
          >
            <z-icon
              name={
                this.orientation == "horizontal" ? "chevron-left" : "chevron-up"
              }
              width={16}
              height={16}
            />
