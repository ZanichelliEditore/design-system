...
describe("Suite test ZLink", () => {
  it("Test render ZLink vuoto", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link>
        <mock:shadow-root>
          <a class="primary false" role="button" tabindex="0" target="_self">
            <slot></slot>
          </a>
        </mock:shadow-root>
      </z-link>
  ...
  it("Test render ZLink con link", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link href="http://www.google.com/">
        <mock:shadow-root>
          <a href="http://www.google.com/" class="primary false" role="link"  tabindex="0" target="_self">
            <slot></slot>
          </a>
        </mock:shadow-root>
      </z-link>
  ...
  it("Test render ZLink disabled", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link isdisabled>
        <mock:shadow-root>
          <a class="primary disabled false" role="button"  tabindex="-1" target="_self">
            <slot></slot>
          </a>
        </mock:shadow-root>
      </z-link>
  ...
  it("Test render ZLink white", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link iswhite>
        <mock:shadow-root>
          <a class="primary white false" role="button" tabindex="0" target="_self">
            <slot></slot>
          </a>
        </mock:shadow-root>
      </z-link>
  ...
  it("Test render ZLink target", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link target="_blank">
        <mock:shadow-root>
          <a class="primary false" role="button" tabindex="0" target="_blank">
            <slot></slot>
          </a>
        </mock:shadow-root>
      </z-link>
  ...
  it("Test render ZLink active", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link isactive>
        <mock:shadow-root>
          <a class="active primary false" role="button" tabindex="0" target="_self">
            <slot></slot>
          </a>
        </mock:shadow-root>
      </z-link>
