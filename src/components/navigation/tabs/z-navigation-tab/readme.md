...
| -------------- | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | -------------------------------------- |
| `ariaControls` | `aria-controls` | The aria-controls attribute refers to the id of the HTML element that has role="tabpanel" and that contains the actual content of this tab. ref: https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-controls | `string`                                                                     | `undefined`                            |
...
| `tabId`        | `tab-id`        | set id attribute to tab property identifying a corresponding tabpanel attribute aria-labelledby. ref: https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/tab_role                                                      | `string`                                                                     | `undefined`                            |
