...
export const setUseInverseColors = () =>
  (useInverseColors = boolean("Use inverse color combination (useful for light themes)", false));
import "./index";

<Meta
  title="Navigation/ZUserDropdown"
  component="z-user-dropdown"
/>
...
<Preview>
  <Story name="ZUserDropdown, user not logged">
    {html` <div
      style="background-color: ${setUseInverseColors()
        ? lightBackground
        : darkBackground}; padding: 16px; height: 40px; width: fit-content; border-radius: 8px;"
    >
      <z-user-dropdown
        logged=${false}
  ...
  <Story name="ZUserDropdown, user logged">
    {html`
      <div
        style="background-color: ${setUseInverseColors()
          ? lightBackground
          : darkBackground}; padding:16px; height: 40px; width: 400px; border-radius: 8px;"
      >
        <z-user-dropdown
          logged=${true}
          use-inverse-colors=${setUseInverseColors()}
