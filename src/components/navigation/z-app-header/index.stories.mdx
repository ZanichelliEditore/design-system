...
<Preview>
  <Story name="Hero">
    {html`<z-app-header .drawer=${boolean('Drawer', false)} overlay style="--app-header-height: 400px;" flow="${select('Flow', ['auto', 'stack'], 'auto')}">
        <h1 slot="title">Applicazione</h1>
        <h2 slot="subtitle">Payoff dell'applicazione</h2>
  ...
  <Story name="With topbar">
    {html`
      <div id="z-app-header-with-topbar-wrapper">
        ...
        <z-app-header .stuck=${boolean('Stuck', true)} .drawer=${boolean('Drawer', true)}
          style="--app-header-bg: ${text('Background color')}; --app-header-text-color: ${text('Text color')}"
        >
            <h1 slot="title">Applicazione</h1>
            <h2 slot="subtitle">Payoff dell'applicazione</h2>
            <z-menu slot="menu">
