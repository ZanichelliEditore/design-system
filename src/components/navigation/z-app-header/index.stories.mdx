...
<Preview>
  <Story name="Hero">
    {html`<z-app-header .stuck=${boolean('Stuck', false)} .drawer=${boolean('Drawer', false)} overlay style="--app-header-height: 400px;" flow="${select('Flow', ['auto', 'stack'], 'auto')}">
        <h1 slot="title">Applicazione</h1>
        <h2 slot="subtitle">Payoff dell'applicazione</h2>
...
<Preview>
  <Story name="With topbar">
    ...
    <z-app-header drawer .stuck=${boolean('Stuck', false)}>
        <h1 slot="title">Applicazione</h1>
        <h2 slot="subtitle">Payoff dell'applicazione</h2>
        <z-menu slot="menu">
          <h3>Menu label</h3>
