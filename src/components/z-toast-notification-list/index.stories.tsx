...
import {ControlSize, ToastNotification, ToastNotificationPosition, ToastNotificationTransition} from "../../beans";
import {ZToastNotificationList} from "./index";
import "./index.stories.css";

const template = (
  args,
  notificationTransition = ToastNotificationTransition.SLIDE_IN_DOWN,
  slottedMessage?: string
) => (
  <div class="z-toast-notification-container">
...
const StoryMeta = {
  ...
  component: ZToastNotificationList,
  argTypes: {
    position: {
      control: {
        type: "select",
