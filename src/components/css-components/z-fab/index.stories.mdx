...
- Color variants: `.z-fab-primary03`, `.z-fab-surface01`, `.z-fab-surface04`. Default with no color classes, is `primary01`
...
<Meta
  ...
  argTypes={{
    ...
    colorVariant: {
      options: ["default", "z-fab-primary03", "z-fab-surface01", "z-fab-surface04"],
      control: {type: "inline-radio"},
    },
  }}
  args={{
