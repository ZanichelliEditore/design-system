    ...
    {(args) => html`
      <div class="z-anchor-navigation-story-wrapper">
        <z-anchor-navigation .hideUnselected=${args.hideUnselected}>
          <div>
            <a href="#first-section" target="_self">First section</a>
            <z-button variant="tertiary" icon="share"></z-button>
          </div>
          <div>
            <a href="#second-section" target="_self">Second section</a>
            <z-icon name="share" tabindex="0"></z-icon>
          </div>
          <div>
...
<ArgsTable of="z-anchor-navigation" />
