...
| `autocomplete`    | `autocomplete`    | the input has autocomplete option (optional): available for input                                 | `boolean \| string`                                                                              | `undefined`          |
...
| `hasmessage`      | `hasmessage`      | show input helper message (optional): available for text, password, number, email, textarea       | `boolean`                                                                                        | `true`               |
...
| `interactiveicon` | `interactiveicon` | icon is interactive (optional): available for text                                                | `boolean`                                                                                        | `undefined`          |
| `label`           | `label`           | the input label                                                                                   | `string`                                                                                         | `undefined`          |
| `labelafter`      | `labelafter`      | the input label position: available for checkbox, radio                                           | `boolean`                                                                                        | `true`               |
| `message`         | `message`         | input helper message (optional): available for text, password, number, email, textarea            | `string`                                                                                         | `undefined`          |
...
| `status`          | `status`          | the input status (optional): available for text, password, number, email, textarea                | `"error" \| "selecting" \| "success" \| "warning"`                                               | `undefined`          |
| `type`            | `type`            | input types                                                                                       | `"checkbox" \| "email" \| "number" \| "password" \| "radio" \| "select" \| "text" \| "textarea"` | `undefined`          |
