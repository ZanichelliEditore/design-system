...
| `labelPosition` | `label-position` | the input label position: available for checkbox, radio                                                                               | `LabelPositions.LEFT \| LabelPositions.RIGHT`                                                                                                                                                                                              | `LabelPositions.RIGHT` |
...
| `status`        | `status`         | the input status (optional): available for text, password, number, email, textarea                                                    | `InputStatusEnum.ERROR \| InputStatusEnum.SUCCESS \| InputStatusEnum.WARNING`                                                                                                                                                              | `undefined`            |
