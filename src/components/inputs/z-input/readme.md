...
| `max`           | `max`            | max page number value (optional): available for number                                                                                | `number`                                                                                               | `undefined`            |
...
| `min`           | `min`            | min page number value (optional): available for number                                                                                | `number`                                                                                               | `undefined`            |
| `name`          | `name`           | the input name                                                                                                                        | `string`                                                                                               | `undefined`            |
| `pattern`       | `pattern`        | pattern value (optional): available for tel                                                                                           | `string`                                                                                               | `undefined`            |
