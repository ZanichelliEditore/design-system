...
| `ariaExpanded`         | `aria-expanded`         | the input aria-expaded (optional): available for text, password, number, email                                                        | `string`                                                                                                                                                                                           | `undefined`           |
...
| `innerTabIndex`        | `inner-tab-index`       | set tabindex to input tag (optional). Defaults to native behaviour.                                                                   | `number`                                                                                                                                                                                           | `undefined`           |
