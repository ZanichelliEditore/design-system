...
import {SfPopoverPosition} from "../../beans";
import {CSSVarsArguments, extractCSSVars, getColorTokenArgConfig} from "../../utils/storybook-utils";
import {ZSfPopover} from "./index";
import "./index.stories.css";

type ZSfPopoverStoriesArgs = ZSfPopover &
  CSSVarsArguments<
...
const openPopover = (event: MouseEvent): void => {
  const popover = (event.target as HTMLElement).closest(".popover-container")?.querySelector("z-sf-popover");
  if (!popover) {
    return;
  }
...
const StoryMeta = {
  title: "ZSfPopover",
  component: "z-sf-popover",
  argTypes: {
    "position": {
      options: [null, ...Object.values(SfPopoverPosition).filter((value) => value !== SfPopoverPosition.AUTO)],
      control: {
        type: "select",
        labels: {
          null: "-",
...
} satisfies Meta<ZSfPopoverStoriesArgs>;

export default StoryMeta;

type Story = StoryObj<ZSfPopoverStoriesArgs>;
...
//     "--z-popover-theme--surface": "var(--color-surface01)",
//     "--z-popover-padding": "var(--space-unit)",
//     "position": SfPopoverPosition.RIGHT_BOTTOM,
//   },
//   render: (args) => (
//     <div class="popover-container">
//       <z-sf-popover
...
//   args: {
//     "position": SfPopoverPosition.TOP,
//     "--z-popover-padding": "var(--space-unit)",
//   },
//   render: (args) => (
//     <div class="popover-container popover-container-tooltip">
