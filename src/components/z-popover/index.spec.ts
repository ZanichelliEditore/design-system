...
describe("Suite test ZPopover", () => {
  it("Test render ZPopover default", async () => {
    const page = await newSpecPage({
      components: [ZPopover],
      html: `<z-popover><z-button-deprecated slot="trigger">Trigger</z-button-deprecated><div slot="popover">Content</div></z-popover>`,
    });

    expect(page.root).toEqualHtml(`
      <z-popover>
        <div tabindex="0">
          <z-button-deprecated slot="trigger">Trigger</z-button-deprecated>
        </div>
  ...
  it("Test render ZPopover position prop", async () => {
    const page = await newSpecPage({
      components: [ZPopover],
      html: `<z-popover position="after-center"><z-button-deprecated slot="trigger">Trigger</z-button-deprecated><div slot="popover">Content</div></z-popover>`,
    });
  ...
  it("Test render ZPopover radius prop", async () => {
    const page = await newSpecPage({
      components: [ZPopover],
      html: `<z-popover border-radius="medium"><z-button-deprecated slot="trigger">Trigger</z-button-deprecated><div slot="popover">Content</div></z-popover>`,
    });
  ...
  it("Test render ZPopover shadow prop", async () => {
    const page = await newSpecPage({
      components: [ZPopover],
      html: `<z-popover box-shadow="shadow-4"><z-button-deprecated slot="trigger">Trigger</z-button-deprecated><div slot="popover">Content</div></z-popover>`,
    });
  ...
  it("Test render ZPopover background prop", async () => {
    const page = await newSpecPage({
      components: [ZPopover],
      html: `<z-popover background-color="blue800"><z-button-deprecated slot="trigger">Trigger</z-button-deprecated><div slot="popover">Content</div></z-popover>`,
    });
  ...
  it("Test render ZPopover show-arrow prop", async () => {
    const page = await newSpecPage({
      components: [ZPopover],
      html: `<z-popover show-arrow="true"><z-button-deprecated slot="trigger">Trigger</z-button-deprecated><div slot="popover">Content</div></z-popover>`,
    });
