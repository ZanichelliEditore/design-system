...
export class ZDatepickerFlatpickr {
  ...
  parseMonths() {
    ...
    const monthBox = this.element.querySelector(
    ...
    DivContainer.setAttribute(
      "style",
      "display: flex!important; width: 150px;"
    );
    ...
    ZSelectElement.addEventListener("optionSelect", (e: any) => {
      ...
      this.sampleFlatpickrInstance.changeMonth(
        e.detail.selected - currentMonth
      );
  ...
  parseHours() {
    ...
    DivContainer.setAttribute(
      "style",
      "display: flex!important; margin-left: 14px!important"
    );

    const ZSelectWrapper = document.createElement("div");
    ZSelectWrapper.setAttribute(
      "style",
      "margin-right: 12px!important; width: 87px!important"
    );
    ...
    ZSelectElement.setAttribute(
      "items",
      `[{"id":"00","name":"00","selected":false},{"id":"01","name":"01","selected":false},{"id":"02","name":"02","selected":false}]`
    );
    ZSelectElement.addEventListener("optionSelect", (e: any) =>
    ...
    return (
      <div>
        <div style={{ margin: "40px 0px" }}>
          <z-heading level={2}>Sample DatePicker</z-heading>
        </div>
        <z-input
          class="flatpickr"
          type="text"
        ...
        <z-divider></z-divider>
        <div style={{ margin: "40px 0px" }}>
          <z-heading level={2}>DatePicker with time</z-heading>
        </div>
        <z-input
        ...
        <z-divider></z-divider>
        <div style={{ margin: "40px 0px" }}>
          <z-heading level={2}>Range DatePicker</z-heading>
        </div>
        <div>
          <z-input
        ...
        <z-divider></z-divider>
        <div style={{ margin: "40px 0px" }}>
          <z-heading level={2}>DatePicker with custom trigger</z-heading>
        </div>
