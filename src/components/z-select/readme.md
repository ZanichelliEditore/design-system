...
| `items` _(required)_           | `items`                            | the input select options                                                                                                      | `SelectItem[] \| string`                                          | `undefined`              |
...
| `required`                     | `required`                         | the input is required                                                                                                         | `boolean`                                                         | `false`                  |
| `resetItem`                    | `reset-item`                       |                                                                                                                               | `string`                                                          | `undefined`              |
| `showChildrenOfMatchingParent` | `show-children-of-matching-parent` | If true and an item matches the search string, children of matching item are shown even if they don't match the search string | `boolean`                                                         | `undefined`              |
