            ...
            <div class="open">
              <div class="ul-scroll-wrapper">
                <z-list class="z-scrollbar" id="checkid_list" role="listbox" aria-label="default" tabindex="0" size="medium">
                  <z-list-element clickable="" aria-selected="false" dividertype="header" id="checkid_key_0" role="option" size="medium" html-tabindex="0">
                  <div class="list-element-container">
            ...
            <div class="open">
              <div class="ul-scroll-wrapper">
                <z-list id="checkid_list" role="listbox" aria-label="default" size="medium" tabindex="0" class="z-scrollbar">
                  ...
                  <z-list-element aria-selected="true" clickable="" dividertype="header" id="checkid_key_0" role="option" size="medium" html-tabindex="0">
                  <div class="list-element-container">
