...
| `sortDirection`   | `sort-direction`   | Current sorting direction.                                                                                                                                   | `SortDirection.ASC \| SortDirection.DESC`                                                                                                                                                                                                                                                                                                                                | `undefined`            |
| `sorted`          | `sorted`           | Sorted state of the column.                                                                                                                                  | `boolean`                                                                                                                                                                                                                                                                                                                                                                | `false`                |
