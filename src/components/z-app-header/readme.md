...
| `searchButtonLabel` | `search-button-label` | Label of the search button.                                                                                                                                                                     | `string`  | `undefined` |
| `searchLabel`       | `search-label`        | Visible label for the search bar.                                                                                                                                                               | `string`  | `undefined` |
