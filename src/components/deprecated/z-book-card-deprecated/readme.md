...
| `variant`           | `variant`            | Card variant: expanded, compact, search                          | `BookCardVariant.COMPACT \| BookCardVariant.EXPANDED \| BookCardVariant.LANDSCAPE \| BookCardVariant.PORTRAIT \| BookCardVariant.SEARCH` | `undefined` |
...
graph TD;
  ...
  style z-book-card-deprecated fill:#f9f,stroke:#333,stroke-width:4px
```
