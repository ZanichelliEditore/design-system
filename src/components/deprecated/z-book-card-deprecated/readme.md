...
| `variant`           | `variant`            | Card variant: expanded, compact, search                          | `BookCardDeprecatedVariant.COMPACT \| BookCardDeprecatedVariant.EXPANDED \| BookCardDeprecatedVariant.SEARCH` | `undefined` |
