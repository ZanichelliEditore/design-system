...
<Canvas>
  <Story name="ZCarousel-over-arrows">
    {(args) => html`<z-carousel label=${args.label || ""} arrows-position=${CarouselArrowsPosition.OVER}>
      <li tabindex="0">
...
<Canvas>
  ...
  >
    {(args) => html`<z-carousel label=${args.label}>
      <li>
