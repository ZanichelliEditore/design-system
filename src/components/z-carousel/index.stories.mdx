...
<Preview>
  <Story name="ZCarousel-with-div">
    {html`<z-carousel style="${text("gutter", "--z-carousel-gutter: 8px")}">
      <li>
        <div
...
One `z-carousel`component wraps `N` `li`.

Any type of element must be passed into a `li` element.

The size of the carousel children fits to the size of the children
