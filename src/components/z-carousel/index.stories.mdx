...
import { CarouselButtonOptions, CarouselProgressOptions } from "../../beans";
...
<Meta
  ...
  argTypes={{
    ...
    buttons: {
      options: Object.values(CarouselButtonOptions),
      control: { type: "select" },
    },
    progress: {
      options: Object.values(CarouselProgressOptions),
      control: { type: "select" },
    },
...
<Canvas>
  <Story
    ...
    args={{
      buttons: CarouselButtonOptions.TOP,
      progress: CarouselProgressOptions.DOTS,
    }}
  >
