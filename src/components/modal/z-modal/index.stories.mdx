    ...
    {(args) => html`
      ...
      >
        <div slot="modalContent">
          ...
          <br />
          <button class="close-modal-${args.modalid}">custom closing button</button>
        </div>
      </z-modal>
      <div>
        <button class="open-modal-${args.modalid}">apri modale</button>
      </div>
      <script>
        document.querySelector(".open-modal-${args.modalid}").addEventListener("click", () => {
          document.querySelector("[modalid='${args.modalid}").openModal();
        });
        document.querySelector(".close-modal-${args.modalid}").addEventListener("click", () => {
          document.querySelector("[modalid='${args.modalid}").closeModal();
        });
      </script>
    `}
  </Story>
    ...
    {(args) => html`
      ...
      >
        ...
        <button
          ...
          aria-label="close"
          class="close-modal-${args.modalid}"
        >
          X
        </button>
      </z-modal>
