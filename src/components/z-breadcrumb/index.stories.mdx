...
## ZBreadcrumb with path prop valued

### Usage

The first element of the array will be used as a home link and it will have a default value which cannot be overwritten ("Home" text or an icon) so don't value the field "text" of the first object of the array because it will be overwritten.
