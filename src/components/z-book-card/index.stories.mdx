...
<Canvas>
  <Story name="All props">
    {(args) =>
      html`<z-book-card
        ...
        class=${args.theme}
        style="--z-book-card-ribbon-background-color: ${args[
          "--z-book-card-ribbon-background-color"
        ]}; --z-book-card-ribbon-shadow-color: ${args[
          "--z-book-card-ribbon-shadow-color"
        ]}; --z-book-card-compact-width: ${args["--z-book-card-compact-width"]}; --z-book-card-compact-height: ${args[
          "--z-book-card-compact-height"
        ]};"
      ></z-book-card>`
    }
  ...
  <Story
    ...
    parameters={{
      controls: {
        exclude: ["borderless", "theme", "--z-book-card-compact-width", "--z-book-card-compact-height"],
      },
    }}
  >
    {(args) =>
  ...
  <Story
    ...
    parameters={{
      controls: {
        exclude: ["ribbon", "--z-book-card-ribbon-background-color", "--z-book-card-ribbon-shadow-color"],
      },
    }}
  >
    {(args) =>
      html`<z-book-card
        ...
        opera-title-tag=${args.operaTitleTag}
        class=${args.theme}
        style="--z-book-card-compact-width: ${args[
          "--z-book-card-compact-width"
