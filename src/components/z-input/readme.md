...
| `htmlAriaActivedescendant` | `html-aria-activedescendant` | the input `aria-activedescendant` (optional): available for text, password, number, email                                             | `string`                                                                                                                                                                                           | `undefined`              |
| `htmlAriaAutocomplete`     | `html-aria-autocomplete`     | the input `aria-autocomplete` (optional): available for text, password, number, email                                                 | `string`                                                                                                                                                                                           | `undefined`              |
| `htmlAriaControls`         | `html-aria-controls`         | the input `aria-controls` (optional): available for text, password, number, email                                                     | `string`                                                                                                                                                                                           | `undefined`              |
| `htmlAriaDescribedby`      | `html-aria-describedby`      | the input `aria-describedby` (optional)                                                                                               | `string`                                                                                                                                                                                           | `undefined`              |
| `htmlAriaExpanded`         | `html-aria-expanded`         | the input `aria-expanded`: available for text, password, number, email                                                                | `string`                                                                                                                                                                                           | `undefined`              |
| `htmlAriaLabel`            | `html-aria-label`            | the input `aria-label`                                                                                                                | `string`                                                                                                                                                                                           | `undefined`              |
| `htmlAriaLabelledby`       | `html-aria-labelledby`       | the input `aria-labelledby` (optional)                                                                                                | `string`                                                                                                                                                                                           | `undefined`              |
| `htmlRole`                 | `html-role`                  | the input `role`                                                                                                                      | `string`                                                                                                                                                                                           | `undefined`              |
...
| `indeterminate`            | `indeterminate`              | indeterminate: available for checkbox                                                                                                 | `boolean`                                                                                                                                                                                          | `false`                  |
...
| `name`                     | `name`                       | the input `name` attribute                                                                                                            | `string`                                                                                                                                                                                           | `undefined`              |
...
| `type`                     | `type`                       | Input type                                                                                                                            | `InputType.CHECKBOX \| InputType.EMAIL \| InputType.NUMBER \| InputType.PASSWORD \| InputType.RADIO \| InputType.SEARCH \| InputType.TEL \| InputType.TEXT \| InputType.TEXTAREA \| InputType.URL` | `InputType.TEXT`         |
