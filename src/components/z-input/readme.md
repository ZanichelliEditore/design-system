...
| `externalHelperId`         | `external-helper-id`         | external input helper message id (optional): available for text, password, number, email, textarea - if set, it will be used to populate the aria-describedby attribute, otherwise the attribute (if present) will be populated with an auto-generated value | `string`                                                                                                                                                                                           | `undefined`           |
...
| `htmlAriaExpanded`         | `html-aria-expanded`         | the input aria-expaded: available for text, password, number, email                                                                                                                                                                                          | `string`                                                                                                                                                                                           | `""`                  |
