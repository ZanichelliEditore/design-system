...
const onTabSelected = (event: ZNavigationTabsCustomEvent<number>) => {
  const zNavigationTabs = event.target as HTMLElement;
  const controlledPanel = zNavigationTabs
    .querySelectorAll('[role="tab"]')
    ?.[event.detail]?.getAttribute("aria-controls");
