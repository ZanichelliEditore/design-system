...
| `selectedlabelplural`   | `selectedlabelplural`   | label for selected items count in plural form (optional, e.g., "selezionati")   | `string`                                                      | `undefined`             |
| `selectedlabelsingular` | `selectedlabelsingular` | label for selected items count in singular form (optional, e.g., "selezionato") | `string`                                                      | `undefined`             |
