...
describe("Suite test zCardInfo", () => {
  ...
  it("Test render zCardInfo - with data", async () => {
    ...
    expect(page.root).toEqualHtml(`
    <z-card-info data='{"author":"Nicola Zingarelli","year":"2021","title":"Vocabolario della lingua italiana","description":"A cura di Mario Cannella, Beata Lazzarini","onlineLicense":{"expiration":"31/12/2021","expired":true},"offlineLicense":{"expiration":"30/06/2021","installations":"2","expired":false}}'>
      <mock:shadow-root>
        <div>
          <z-icon name="multiply-circled-filled" height="18" width="18" tabindex="0"></z-icon>
          <div class="content-wrapper">
  ...
  it("Test render zCardInfo - htmltabindex", async () => {
    ...
    expect(page.root).toEqualHtml(`
    <z-card-info htmltabindex='-1' data='{"author":"Nicola Zingarelli","year":"2021","title":"Vocabolario della lingua italiana","description":"A cura di Mario Cannella, Beata Lazzarini","onlineLicense":{"expiration":"31/12/2021","expired":true},"offlineLicense":{"expiration":"30/06/2021","installations":"2","expired":false}}'>
      <mock:shadow-root>
        <div>
