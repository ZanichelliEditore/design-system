...
describe("Suite test ZDragdropArea", () => {
  it("Test render ZDragdropArea senza contenuto slottato", async () => {
    const page = await newSpecPage({
      ...
      html: `<z-dragdrop-area draganddropbtnlabel="Rilascia i file in questa area per allegarli."></z-dragdrop-area>`,
    });
  ...
  it("Test render ZDragdropArea con contenuto slottato", async () => {
    const page = await newSpecPage({
      components: [ZDragdropArea],
      html: `<z-dragdrop-area draganddropbtnlabel="Rilascia i file in questa area per allegarli.">
