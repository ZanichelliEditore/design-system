...
| `buttonVariant`  | `button-variant`  | Prop indicating the button variant                                | `ButtonVariantEnum.DARK_BG \| ButtonVariantEnum.PRIMARY \| ButtonVariantEnum.SECONDARY \| ButtonVariantEnum.TERTIARY` | `undefined`                   |
