...
| `variant`             | `variant`             | Offcanvas variant. Can be one of "overlay", "pushcontent" Default variant: pushcontent | `OffCanvasVariants.OVERLAY \| OffCanvasVariants.PUSHCONTENT` | `OffCanvasVariants.PUSHCONTENT` |
