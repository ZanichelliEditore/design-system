...
describe("Suite test ZOffcanvas variant pushcontent with skipanimationonload", () => {
  it("Test render ZOffcanvas", async () => {
    const page = await newSpecPage({
      components: [ZOffcanvas],
    ...
    expect(page.root).toEqualHtml(`
			<z-offcanvas class="skip-animation" open="" skipanimationonload="" transitiondirection="left" variant="pushcontent">
				<div class="canvas-container" role="presentation">
					<div class="canvas-content" role="presentation">
						<div slot="canvasContent"></div>
					</div>
