...
import {
  ...
  PopoverPositions as PopoverPositions1,
} from "./beans/index";
import {
  AvatarSize,
  ButtonSizeEnum,
...
declare global {
  ...
  interface HTMLZCarouselElement
    extends Components.ZCarousel,
      HTMLStencilElement {}
  ...
  interface HTMLZFileUploadElement
    extends Components.ZFileUpload,
      HTMLStencilElement {}
  ...
  interface HTMLZIconPackageElement
    extends Components.ZIconPackage,
      HTMLStencilElement {}
  var HTMLZIconPackageElement: {
    prototype: HTMLZIconPackageElement;
    new (): HTMLZIconPackageElement;
  };
  interface HTMLZInfoBoxElement
    extends Components.ZInfoBox,
      HTMLStencilElement {}
  var HTMLZInfoBoxElement: {
    prototype: HTMLZInfoBoxElement;
    new (): HTMLZInfoBoxElement;
  };
  interface HTMLZInfoRevealElement
    extends Components.ZInfoReveal,
      HTMLStencilElement {}
  ...
  interface HTMLZInputDeprecatedElement
    extends Components.ZInputDeprecated,
      HTMLStencilElement {}
  var HTMLZInputDeprecatedElement: {
    prototype: HTMLZInputDeprecatedElement;
    new (): HTMLZInputDeprecatedElement;
  };
  interface HTMLZInputLabelElement
    extends Components.ZInputLabel,
      HTMLStencilElement {}
  var HTMLZInputLabelElement: {
    prototype: HTMLZInputLabelElement;
    new (): HTMLZInputLabelElement;
  };
  interface HTMLZInputMessageElement
    extends Components.ZInputMessage,
      HTMLStencilElement {}
  ...
  interface HTMLZListElementElement
    extends Components.ZListElement,
      HTMLStencilElement {}
  var HTMLZListElementElement: {
    prototype: HTMLZListElementElement;
    new (): HTMLZListElementElement;
  };
  interface HTMLZListGroupElement
    extends Components.ZListGroup,
      HTMLStencilElement {}
  ...
  interface HTMLZMenuDropdownElement
    extends Components.ZMenuDropdown,
      HTMLStencilElement {}
  var HTMLZMenuDropdownElement: {
    prototype: HTMLZMenuDropdownElement;
    new (): HTMLZMenuDropdownElement;
  };
  interface HTMLZMenuSectionElement
    extends Components.ZMenuSection,
      HTMLStencilElement {}
  var HTMLZMenuSectionElement: {
    prototype: HTMLZMenuSectionElement;
    new (): HTMLZMenuSectionElement;
  };
  interface HTMLZMessagesPocketElement
    extends Components.ZMessagesPocket,
      HTMLStencilElement {}
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      "z-app-header": LocalJSX.ZAppHeader &
        JSXBase.HTMLAttributes<HTMLZAppHeaderElement>;
      "z-app-switcher": LocalJSX.ZAppSwitcher &
        JSXBase.HTMLAttributes<HTMLZAppSwitcherElement>;
      "z-app-topbar": LocalJSX.ZAppTopbar &
        JSXBase.HTMLAttributes<HTMLZAppTopbarElement>;
      "z-aria-alert": LocalJSX.ZAriaAlert &
        JSXBase.HTMLAttributes<HTMLZAriaAlertElement>;
      ...
      "z-button-deprecated": LocalJSX.ZButtonDeprecated &
        JSXBase.HTMLAttributes<HTMLZButtonDeprecatedElement>;
      "z-button-filter": LocalJSX.ZButtonFilter &
        JSXBase.HTMLAttributes<HTMLZButtonFilterElement>;
      "z-button-sort": LocalJSX.ZButtonSort &
        JSXBase.HTMLAttributes<HTMLZButtonSortElement>;
      "z-candybar": LocalJSX.ZCandybar &
        JSXBase.HTMLAttributes<HTMLZCandybarElement>;
      "z-card": LocalJSX.ZCard & JSXBase.HTMLAttributes<HTMLZCardElement>;
      "z-carousel": LocalJSX.ZCarousel &
        JSXBase.HTMLAttributes<HTMLZCarouselElement>;
      "z-chip": LocalJSX.ZChip & JSXBase.HTMLAttributes<HTMLZChipElement>;
      "z-chip-deprecated": LocalJSX.ZChipDeprecated &
        JSXBase.HTMLAttributes<HTMLZChipDeprecatedElement>;
      "z-combobox": LocalJSX.ZCombobox &
        JSXBase.HTMLAttributes<HTMLZComboboxElement>;
      "z-contextual-menu": LocalJSX.ZContextualMenu &
        JSXBase.HTMLAttributes<HTMLZContextualMenuElement>;
      "z-cookiebar": LocalJSX.ZCookiebar &
        JSXBase.HTMLAttributes<HTMLZCookiebarElement>;
      "z-date-picker": LocalJSX.ZDatePicker &
        JSXBase.HTMLAttributes<HTMLZDatePickerElement>;
      "z-divider": LocalJSX.ZDivider &
        JSXBase.HTMLAttributes<HTMLZDividerElement>;
      "z-dragdrop-area": LocalJSX.ZDragdropArea &
        JSXBase.HTMLAttributes<HTMLZDragdropAreaElement>;
      "z-file": LocalJSX.ZFile & JSXBase.HTMLAttributes<HTMLZFileElement>;
      "z-file-upload": LocalJSX.ZFileUpload &
        JSXBase.HTMLAttributes<HTMLZFileUploadElement>;
      "z-footer": LocalJSX.ZFooter & JSXBase.HTMLAttributes<HTMLZFooterElement>;
      "z-footer-link": LocalJSX.ZFooterLink &
        JSXBase.HTMLAttributes<HTMLZFooterLinkElement>;
      "z-footer-section": LocalJSX.ZFooterSection &
        JSXBase.HTMLAttributes<HTMLZFooterSectionElement>;
      "z-footer-social": LocalJSX.ZFooterSocial &
        JSXBase.HTMLAttributes<HTMLZFooterSocialElement>;
      "z-ghost-loading": LocalJSX.ZGhostLoading &
        JSXBase.HTMLAttributes<HTMLZGhostLoadingElement>;
      "z-heading": LocalJSX.ZHeading &
        JSXBase.HTMLAttributes<HTMLZHeadingElement>;
      "z-icon": LocalJSX.ZIcon & JSXBase.HTMLAttributes<HTMLZIconElement>;
      "z-icon-package": LocalJSX.ZIconPackage &
        JSXBase.HTMLAttributes<HTMLZIconPackageElement>;
      "z-info-box": LocalJSX.ZInfoBox &
        JSXBase.HTMLAttributes<HTMLZInfoBoxElement>;
      "z-info-reveal": LocalJSX.ZInfoReveal &
        JSXBase.HTMLAttributes<HTMLZInfoRevealElement>;
      "z-input": LocalJSX.ZInput & JSXBase.HTMLAttributes<HTMLZInputElement>;
      "z-input-deprecated": LocalJSX.ZInputDeprecated &
        JSXBase.HTMLAttributes<HTMLZInputDeprecatedElement>;
      "z-input-label": LocalJSX.ZInputLabel &
        JSXBase.HTMLAttributes<HTMLZInputLabelElement>;
      "z-input-message": LocalJSX.ZInputMessage &
        JSXBase.HTMLAttributes<HTMLZInputMessageElement>;
      ...
      "z-list-element": LocalJSX.ZListElement &
        JSXBase.HTMLAttributes<HTMLZListElementElement>;
      "z-list-group": LocalJSX.ZListGroup &
        JSXBase.HTMLAttributes<HTMLZListGroupElement>;
      ...
      "z-menu-dropdown": LocalJSX.ZMenuDropdown &
        JSXBase.HTMLAttributes<HTMLZMenuDropdownElement>;
      "z-menu-section": LocalJSX.ZMenuSection &
        JSXBase.HTMLAttributes<HTMLZMenuSectionElement>;
      "z-messages-pocket": LocalJSX.ZMessagesPocket &
        JSXBase.HTMLAttributes<HTMLZMessagesPocketElement>;
      "z-modal": LocalJSX.ZModal & JSXBase.HTMLAttributes<HTMLZModalElement>;
      "z-modal-login": LocalJSX.ZModalLogin &
        JSXBase.HTMLAttributes<HTMLZModalLoginElement>;
      "z-myz-card": LocalJSX.ZMyzCard &
        JSXBase.HTMLAttributes<HTMLZMyzCardElement>;
      "z-myz-card-alert": LocalJSX.ZMyzCardAlert &
        JSXBase.HTMLAttributes<HTMLZMyzCardAlertElement>;
      "z-myz-card-body": LocalJSX.ZMyzCardBody &
        JSXBase.HTMLAttributes<HTMLZMyzCardBodyElement>;
      "z-myz-card-cover": LocalJSX.ZMyzCardCover &
        JSXBase.HTMLAttributes<HTMLZMyzCardCoverElement>;
      "z-myz-card-dictionary": LocalJSX.ZMyzCardDictionary &
        JSXBase.HTMLAttributes<HTMLZMyzCardDictionaryElement>;
      "z-myz-card-footer": LocalJSX.ZMyzCardFooter &
        JSXBase.HTMLAttributes<HTMLZMyzCardFooterElement>;
      "z-myz-card-footer-sections": LocalJSX.ZMyzCardFooterSections &
        JSXBase.HTMLAttributes<HTMLZMyzCardFooterSectionsElement>;
      "z-myz-card-header": LocalJSX.ZMyzCardHeader &
        JSXBase.HTMLAttributes<HTMLZMyzCardHeaderElement>;
      "z-myz-card-icon": LocalJSX.ZMyzCardIcon &
        JSXBase.HTMLAttributes<HTMLZMyzCardIconElement>;
      "z-myz-card-info": LocalJSX.ZMyzCardInfo &
        JSXBase.HTMLAttributes<HTMLZMyzCardInfoElement>;
      "z-myz-card-list": LocalJSX.ZMyzCardList &
        JSXBase.HTMLAttributes<HTMLZMyzCardListElement>;
      "z-myz-list": LocalJSX.ZMyzList &
        JSXBase.HTMLAttributes<HTMLZMyzListElement>;
      "z-myz-list-item": LocalJSX.ZMyzListItem &
        JSXBase.HTMLAttributes<HTMLZMyzListItemElement>;
      "z-myz-topbar": LocalJSX.ZMyzTopbar &
        JSXBase.HTMLAttributes<HTMLZMyzTopbarElement>;
      "z-navigation-tab": LocalJSX.ZNavigationTab &
        JSXBase.HTMLAttributes<HTMLZNavigationTabElement>;
      "z-navigation-tab-link": LocalJSX.ZNavigationTabLink &
        JSXBase.HTMLAttributes<HTMLZNavigationTabLinkElement>;
      "z-navigation-tabs": LocalJSX.ZNavigationTabs &
        JSXBase.HTMLAttributes<HTMLZNavigationTabsElement>;
      "z-notification": LocalJSX.ZNotification &
        JSXBase.HTMLAttributes<HTMLZNotificationElement>;
      "z-offcanvas": LocalJSX.ZOffcanvas &
        JSXBase.HTMLAttributes<HTMLZOffcanvasElement>;
      "z-otp": LocalJSX.ZOtp & JSXBase.HTMLAttributes<HTMLZOtpElement>;
      "z-pagination": LocalJSX.ZPagination &
        JSXBase.HTMLAttributes<HTMLZPaginationElement>;
      "z-pagination-bar": LocalJSX.ZPaginationBar &
        JSXBase.HTMLAttributes<HTMLZPaginationBarElement>;
      "z-pagination-page": LocalJSX.ZPaginationPage &
        JSXBase.HTMLAttributes<HTMLZPaginationPageElement>;
      "z-panel-elem": LocalJSX.ZPanelElem &
        JSXBase.HTMLAttributes<HTMLZPanelElemElement>;
      "z-pocket": LocalJSX.ZPocket & JSXBase.HTMLAttributes<HTMLZPocketElement>;
      "z-pocket-body": LocalJSX.ZPocketBody &
        JSXBase.HTMLAttributes<HTMLZPocketBodyElement>;
      "z-pocket-header": LocalJSX.ZPocketHeader &
        JSXBase.HTMLAttributes<HTMLZPocketHeaderElement>;
      "z-pocket-message": LocalJSX.ZPocketMessage &
        JSXBase.HTMLAttributes<HTMLZPocketMessageElement>;
      "z-popover": LocalJSX.ZPopover &
        JSXBase.HTMLAttributes<HTMLZPopoverElement>;
      "z-popover-deprecated": LocalJSX.ZPopoverDeprecated &
        JSXBase.HTMLAttributes<HTMLZPopoverDeprecatedElement>;
      "z-range-picker": LocalJSX.ZRangePicker &
        JSXBase.HTMLAttributes<HTMLZRangePickerElement>;
      "z-section-title": LocalJSX.ZSectionTitle &
        JSXBase.HTMLAttributes<HTMLZSectionTitleElement>;
      "z-select": LocalJSX.ZSelect & JSXBase.HTMLAttributes<HTMLZSelectElement>;
      "z-skip-to-content": LocalJSX.ZSkipToContent &
        JSXBase.HTMLAttributes<HTMLZSkipToContentElement>;
      "z-slideshow": LocalJSX.ZSlideshow &
        JSXBase.HTMLAttributes<HTMLZSlideshowElement>;
      "z-status-tag": LocalJSX.ZStatusTag &
        JSXBase.HTMLAttributes<HTMLZStatusTagElement>;
      "z-stepper": LocalJSX.ZStepper &
        JSXBase.HTMLAttributes<HTMLZStepperElement>;
      "z-stepper-item": LocalJSX.ZStepperItem &
        JSXBase.HTMLAttributes<HTMLZStepperItemElement>;
      "z-table": LocalJSX.ZTable & JSXBase.HTMLAttributes<HTMLZTableElement>;
      "z-table-body": LocalJSX.ZTableBody &
        JSXBase.HTMLAttributes<HTMLZTableBodyElement>;
      "z-table-cell": LocalJSX.ZTableCell &
        JSXBase.HTMLAttributes<HTMLZTableCellElement>;
      "z-table-empty-box": LocalJSX.ZTableEmptyBox &
        JSXBase.HTMLAttributes<HTMLZTableEmptyBoxElement>;
      "z-table-expanded-row": LocalJSX.ZTableExpandedRow &
        JSXBase.HTMLAttributes<HTMLZTableExpandedRowElement>;
      "z-table-footer": LocalJSX.ZTableFooter &
        JSXBase.HTMLAttributes<HTMLZTableFooterElement>;
      "z-table-head": LocalJSX.ZTableHead &
        JSXBase.HTMLAttributes<HTMLZTableHeadElement>;
      "z-table-header": LocalJSX.ZTableHeader &
        JSXBase.HTMLAttributes<HTMLZTableHeaderElement>;
      "z-table-header-row": LocalJSX.ZTableHeaderRow &
        JSXBase.HTMLAttributes<HTMLZTableHeaderRowElement>;
      "z-table-row": LocalJSX.ZTableRow &
        JSXBase.HTMLAttributes<HTMLZTableRowElement>;
      "z-table-sticky-footer": LocalJSX.ZTableStickyFooter &
        JSXBase.HTMLAttributes<HTMLZTableStickyFooterElement>;
      "z-tag": LocalJSX.ZTag & JSXBase.HTMLAttributes<HTMLZTagElement>;
      "z-toast-notification": LocalJSX.ZToastNotification &
        JSXBase.HTMLAttributes<HTMLZToastNotificationElement>;
      "z-toast-notification-list": LocalJSX.ZToastNotificationList &
        JSXBase.HTMLAttributes<HTMLZToastNotificationListElement>;
      "z-toggle-button": LocalJSX.ZToggleButton &
        JSXBase.HTMLAttributes<HTMLZToggleButtonElement>;
      "z-toggle-switch": LocalJSX.ZToggleSwitch &
        JSXBase.HTMLAttributes<HTMLZToggleSwitchElement>;
      "z-tooltip": LocalJSX.ZTooltip &
        JSXBase.HTMLAttributes<HTMLZTooltipElement>;
      "z-tooltip-deprecated": LocalJSX.ZTooltipDeprecated &
        JSXBase.HTMLAttributes<HTMLZTooltipDeprecatedElement>;
      "z-typography": LocalJSX.ZTypography &
        JSXBase.HTMLAttributes<HTMLZTypographyElement>;
      "z-user-dropdown": LocalJSX.ZUserDropdown &
        JSXBase.HTMLAttributes<HTMLZUserDropdownElement>;
      "z-visually-hidden": LocalJSX.ZVisuallyHidden &
        JSXBase.HTMLAttributes<HTMLZVisuallyHiddenElement>;
    }
  }
}
