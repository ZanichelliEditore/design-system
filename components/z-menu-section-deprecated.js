...
function defineCustomElement$1() {
    ...
    const components = ["z-menu-section-deprecated", "z-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "z-menu-section-deprecated":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZMenuSectionDeprecated$1);
            }
            break;
        case "z-icon":
            if (!customElements.get(tagName)) {
...
const ZMenuSectionDeprecated = ZMenuSectionDeprecated$1;
const defineCustomElement = defineCustomElement$1;

export { ZMenuSectionDeprecated, defineCustomElement };

//# sourceMappingURL=z-menu-section-deprecated.js.map