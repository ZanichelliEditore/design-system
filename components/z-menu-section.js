...
const ZMenuSection$1 = /*@__PURE__*/ proxyCustomElement(class ZMenuSection extends HTMLElement {
    ...
    static get style() { return ZMenuSectionStyle0; }
        ...
        "open": [32],
        "hasContent": [32]
    }, [[4, "canvasOpenStatusChanged", "canvasOpenStatusChanged"], [0, "keydown", "handleKeyDown"], [4, "click", "handleClick"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["z-menu-section", "z-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "z-menu-section":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZMenuSection$1);
            }
            break;
        case "z-icon":
            if (!customElements.get(tagName)) {
...
const ZMenuSection = ZMenuSection$1;
const defineCustomElement = defineCustomElement$1;

export { ZMenuSection, defineCustomElement };
