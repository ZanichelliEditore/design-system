...
import { f as flatpickr, s as setAriaOptions, v as validateDate, i as it, a as setFlatpickrPosition } from './utils2.js';
import { H as ZRangePickerMode, G as ZDatePickerPosition, I as InputType, f as InputStatus } from './index2.js';
...
const ZRangePicker$1 = /*@__PURE__*/ proxyCustomElement(class ZRangePicker extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return ZRangePickerStyle0; }
}, [0, "z-range-picker", {
        "rangePickerId": [1, "range-picker-id"],
        "firstAriaLabel": [1, "first-aria-label"],
        "firstLabel": [1, "first-label"],
        "secondAriaLabel": [1, "second-aria-label"],
        "secondLabel": [1, "second-label"],
        "mode": [1],
        "firstPickerReadOnly": [4, "first-picker-read-only"],
        "lastPickerReadOnly": [4, "last-picker-read-only"],
        "firstPickerPlaceholder": [1, "first-picker-placeholder"],
        "lastPickerPlaceholder": [1, "last-picker-placeholder"],
        "flatpickrPosition": [32],
        "activeInput": [32],
        "firstInputError": [32],
        "lastInputError": [32]
    }, [[18, "click", "handleClick"], [18, "keyup", "handleKeyDown"]], {
        "firstPickerReadOnly": ["setupFirstPickersReadOnly"],
        "lastPickerReadOnly": ["setupLastPickersReadOnly"],
        "mode": ["setupPickers"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["z-range-picker", "z-icon", "z-input", "z-input-message"];
    components.forEach(tagName => { switch (tagName) {
        case "z-range-picker":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZRangePicker$1);
            }
            break;
        case "z-icon":
            if (!customElements.get(tagName)) {
...
const ZRangePicker = ZRangePicker$1;
const defineCustomElement = defineCustomElement$1;

export { ZRangePicker, defineCustomElement };

//# sourceMappingURL=z-range-picker.js.map