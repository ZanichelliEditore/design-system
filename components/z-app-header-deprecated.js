...
const ZAppHeaderDeprecated$1 = /*@__PURE__*/ proxyCustomElement(class ZAppHeaderDeprecated extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return ZAppHeaderDeprecatedStyle0; }
}, [1, "z-app-header-deprecated", {
        "stuck": [516],
        "hero": [1],
        "overlay": [516],
        "flow": [513],
...
function defineCustomElement$1() {
    ...
    const components = ["z-app-header-deprecated", "z-button", "z-divider", "z-icon", "z-input", "z-input-message", "z-list", "z-list-element", "z-list-group", "z-offcanvas", "z-searchbar", "z-tag"];
    components.forEach(tagName => { switch (tagName) {
        case "z-app-header-deprecated":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZAppHeaderDeprecated$1);
            }
            break;
        case "z-button":
            if (!customElements.get(tagName)) {
...
const ZAppHeaderDeprecated = ZAppHeaderDeprecated$1;
const defineCustomElement = defineCustomElement$1;

export { ZAppHeaderDeprecated, defineCustomElement };

//# sourceMappingURL=z-app-header-deprecated.js.map