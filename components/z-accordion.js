...
import { e as ControlSize, Y as AccordionVariant } from './index2.js';
...
const ZAccordion$1 = /*@__PURE__*/ proxyCustomElement(class ZAccordion extends HTMLElement {
    ...
    static get style() { return ZAccordionStyle0; }
}, [1, "z-accordion", {
        "label": [1],
        "icon": [1],
        "size": [513],
        "isDisabled": [516, "is-disabled"],
        "open": [1540],
        "highlight": [516],
        "variant": [513],
        "shadow": [516]
...
function defineCustomElement$1() {
    ...
    const components = ["z-accordion", "z-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "z-accordion":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZAccordion$1);
            }
            break;
        case "z-icon":
            if (!customElements.get(tagName)) {
...
const ZAccordion = ZAccordion$1;
const defineCustomElement = defineCustomElement$1;

export { ZAccordion, defineCustomElement };
