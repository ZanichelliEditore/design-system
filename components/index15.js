...
const ZModal = /*@__PURE__*/ proxyCustomElement(class ZModal extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return ZModalStyle0; }
}, [1, "z-modal", {
        "modalid": [1],
        "modaltitle": [1],
        "modalsubtitle": [1],
...
function defineCustomElement() {
    ...
    const components = ["z-modal", "z-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "z-modal":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZModal);
            }
            break;
        case "z-icon":
            if (!customElements.get(tagName)) {
...
export { ZModal as Z, defineCustomElement as d };
