...
const ZLogoStyle0 = stylesCss;

const ZLogo$1 = /*@__PURE__*/ proxyCustomElement(class ZLogo extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "z-logo":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZLogo$1);
            }
            break;
    } });
}
...
export { ZLogo, defineCustomElement };
