...
const ZLink$1 = /*@__PURE__*/ proxyCustomElement(class ZLink extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return ZLinkStyle0; }
}, [1, "z-link", {
        "htmlid": [1],
        "href": [1],
        "target": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["z-link", "z-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "z-link":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZLink$1);
            }
            break;
        case "z-icon":
            if (!customElements.get(tagName)) {
...
export { ZLink, defineCustomElement };

//# sourceMappingURL=z-link.js.map