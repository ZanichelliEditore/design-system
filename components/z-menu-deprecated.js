...
const ZMenuDeprecated$1 = /*@__PURE__*/ proxyCustomElement(class ZMenuDeprecated extends HTMLElement {
    ...
    static get style() { return ZMenuDeprecatedStyle0; }
}, [1, "z-menu-deprecated", {
        "active": [516],
        "floating": [516],
        "open": [1540],
...
function defineCustomElement$1() {
    ...
    const components = ["z-menu-deprecated", "z-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "z-menu-deprecated":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZMenuDeprecated$1);
            }
            break;
        case "z-icon":
            if (!customElements.get(tagName)) {
...
const ZMenuDeprecated = ZMenuDeprecated$1;
const defineCustomElement = defineCustomElement$1;

export { ZMenuDeprecated, defineCustomElement };

//# sourceMappingURL=z-menu-deprecated.js.map