...
import { I as InputType, e as ControlSize, K as KeyboardKeyCode, l as ListDividerType } from './index2.js';
...
const ZCombobox$1 = /*@__PURE__*/ proxyCustomElement(class ZCombobox extends HTMLElement {
    ...
    static get style() { return ZComboboxStyle0; }
}, [1, "z-combobox", {
        "inputid": [1],
        "items": [1],
        "label": [1],
        ...
        "selectedCounter": [32],
        "renderItemsList": [32]
    }, [[0, "inputCheck", "inputCheckListener"]], {
        "items": ["watchItems"],
        "searchValue": ["watchSearchValue"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["z-combobox", "z-divider", "z-icon", "z-input", "z-input-message", "z-list-group", "z-myz-list-item"];
    components.forEach(tagName => { switch (tagName) {
        case "z-combobox":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZCombobox$1);
            }
            break;
        case "z-divider":
            if (!customElements.get(tagName)) {
...
const ZCombobox = ZCombobox$1;
const defineCustomElement = defineCustomElement$1;

export { ZCombobox, defineCustomElement };
