...
const ZNavigationTab$1 = /*@__PURE__*/ proxyCustomElement(class ZNavigationTab extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return ZNavigationTabStyle0; }
}, [0, "z-navigation-tab", {
...
function defineCustomElement$1() {
    ...
    const components = ["z-navigation-tab", "z-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "z-navigation-tab":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZNavigationTab$1);
            }
            break;
        case "z-icon":
            if (!customElements.get(tagName)) {
...
const ZNavigationTab = ZNavigationTab$1;
const defineCustomElement = defineCustomElement$1;

export { ZNavigationTab, defineCustomElement };

//# sourceMappingURL=z-navigation-tab.js.map