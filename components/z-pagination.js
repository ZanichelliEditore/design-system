...
import { I as InputType } from './index2.js';
...
const ZPagination$1 = /*@__PURE__*/ proxyCustomElement(class ZPagination extends HTMLElement {
    ...
    static get style() { return ZPaginationStyle0; }
}, [0, "z-pagination", {
        "label": [1],
        "navArrows": [4, "nav-arrows"],
        "totalPages": [2, "total-pages"],
        "skip": [2],
        "edges": [4],
        "split": [2],
        "visiblePages": [2, "visible-pages"],
        "currentPage": [1026, "current-page"],
        "goToPage": [4, "go-to-page"],
        "_visiblePages": [32],
        "isMobile": [32],
        "goToPageValue": [32]
    }, [[9, "resize", "onResize"]], {
...
function defineCustomElement$1() {
    ...
    const components = ["z-pagination", "z-button", "z-icon", "z-input", "z-input-message"];
    components.forEach(tagName => { switch (tagName) {
        case "z-pagination":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZPagination$1);
            }
            break;
        case "z-button":
            if (!customElements.get(tagName)) {
...
const ZPagination = ZPagination$1;
const defineCustomElement = defineCustomElement$1;

export { ZPagination, defineCustomElement };

//# sourceMappingURL=z-pagination.js.map