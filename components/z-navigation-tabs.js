...
const ZNavigationTabs$1 = /*@__PURE__*/ proxyCustomElement(class ZNavigationTabs extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '612788b96886b932a6cf18b16422612ce8a87a28', class: {
                "interactive-2": this.size === NavigationTabsSize.SMALL,
                "interactive-1": this.size !== NavigationTabsSize.SMALL,
            }, scrollable: this.canNavigate }, h("button", { key: '93968651f7f5199ada5345641b5d3abf796cdb81', class: "navigation-button", onClick: this.navigateBackwards.bind(this), tabIndex: -1, disabled: !this.canNavigatePrev, "aria-label": "Mostra elementi precedenti", hidden: !this.canNavigate }, h("z-icon", { key: 'dbc1661829b7bd5e52e00437e232d24be57d4f77', name: this.orientation === NavigationTabsOrientation.HORIZONTAL ? "chevron-left" : "chevron-up", width: 16, height: 16 })), h("nav", { key: '804a3005ca3967d6403ad977ec16a9766612cbc0', role: "tablist", "aria-label": this.ariaLabel, ref: (el) => (this.nav = el !== null && el !== void 0 ? el : this.nav), onScroll: this.checkScrollEnabled.bind(this), "aria-orientation": this.orientation }, h("slot", { key: 'f970838c5f1b4669f3ff409abaa2ee5a26ec0542' })), h("button", { key: '280ca6b35e79aa8f3bef4115071b53d7bf6c99c3', class: "navigation-button", onClick: this.navigateForward.bind(this), tabIndex: -1, disabled: !this.canNavigateNext, "aria-label": "Mostra elementi successivi", hidden: !this.canNavigate }, h("z-icon", { key: '6cd794d570d1d4b04910de7d94cf91e3f56cd09a', name: this.orientation === NavigationTabsOrientation.HORIZONTAL ? "chevron-right" : "chevron-down", width: 16, height: 16 }))));
    }
    ...
    static get style() { return ZNavigationTabsStyle0; }
}, [4, "z-navigation-tabs", {
        "ariaLabel": [1, "aria-label"],
        "orientation": [513],
        "size": [513],
        "selectedTab": [1026, "selected-tab"],
        "canNavigate": [32],
        "canNavigatePrev": [32],
        "canNavigateNext": [32]
    }, [[0, "click", "handleTabClick"], [0, "focusin", "onTabFocusIn"], [0, "keydown", "navigateThroughTabs"], [0, "focusout", "onTabFocusOut"]], {
        "canNavigate": ["checkScrollEnabled"],
        "selectedTab": ["onTabSelected"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["z-navigation-tabs", "z-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "z-navigation-tabs":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ZNavigationTabs$1);
            }
            break;
        case "z-icon":
            if (!customElements.get(tagName)) {
...
const ZNavigationTabs = ZNavigationTabs$1;
const defineCustomElement = defineCustomElement$1;

export { ZNavigationTabs, defineCustomElement };
