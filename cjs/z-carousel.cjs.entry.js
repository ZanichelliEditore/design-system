...
const ZCarousel = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "z-carousel-container" }, this.label && index.h("div", { class: "heading-4 z-carousel-title" }, this.label), index.h("div", { class: "z-carousel-wrapper" }, this.arrowsPosition === index$1.CarouselArrowsPosition.OVER && (index.h("z-button", { size: index$1.ButtonSizeEnum.small, "data-direction": "prev", icon: "chevron-left", onClick: this.onPrev.bind(this) })), index.h("ul", { class: "z-carousel-items-container" }, index.h("slot", null)), this.arrowsPosition === index$1.CarouselArrowsPosition.OVER && (index.h("z-button", { size: index$1.ButtonSizeEnum.small, "data-direction": "next", icon: "chevron-right", onClick: this.onNext.bind(this) })))), this.canShowFooter() && (index.h("div", { class: "z-carousel-footer" }, this.arrowsPosition === index$1.CarouselArrowsPosition.BOTTOM && (index.h("z-button", { size: index$1.ButtonSizeEnum.small, variant: index$1.ButtonVariantEnum.tertiary, icon: "arrow-left-filled", onClick: this.onPrev.bind(this) })), this.progressMode === index$1.CarouselProgressMode.DOTS &&
      this.single &&
      this.items && (index.h("div", { class: "dots-progress" }, this.items.map((_item, key) => (index.h("button", { type: "button", class: { current: this.current === key }, onClick: () => this.goTo(key) }, index.h("z-icon", { name: this.current === key
        ? "white-circle-filled"
        : "black-circle-filled" })))))), this.progressMode === index$1.CarouselProgressMode.NUMBERS &&
      this.single &&
      this.items && (index.h("div", { class: "numbers-progress" }, index.h("span", { class: "interactive-3 current" }, this.current + 1), index.h("span", { class: "interactive-3" }, "di"), index.h("span", { class: "interactive-3" }, this.items.length))), this.arrowsPosition === index$1.CarouselArrowsPosition.BOTTOM && (index.h("z-button", { size: index$1.ButtonSizeEnum.small, variant: index$1.ButtonVariantEnum.tertiary, icon: "arrow-right-filled", onClick: this.onNext.bind(this) }))))));
  }
