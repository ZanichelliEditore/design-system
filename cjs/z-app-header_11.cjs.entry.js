...
const ZSearchbar = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fb00861518eb5646a75f2fa810b907163d720531', onFocus: () => (this.showResults = true), onClick: (e) => this.handleOutsideClick(e), class: { "has-submit": this.showSearchButton, "has-results": this.autocomplete } }, index.h("div", { key: '10ed44f469ddd16737653dff61427ccde59df735', class: "input-container" }, this.renderInput(), this.renderResults()), this.renderButton()));
    }
    static get watchers() { return {
...
//# sourceMappingURL=z-app-header_11.cjs.entry.js.map