...
const ZTd = class {
    ...
    render() {
        return (index.h(index.Host, { key: '54c578b455a56b02dfa3d44ac06dcd93df0571ef', role: "cell", "menu-open": this.isMenuOpen }, index.h("slot", { key: 'c6613e265609bc28ef82ab34e7477ea7c25b78e2' }), this.showMenu && (index.h("div", { class: "cell--menu-container prevent-expand" }, index.h("z-button", { variant: index$1.ButtonVariant.TERTIARY, icon: "contextual-menu", size: index$1.ControlSize.X_SMALL, ref: (el) => (this.menuTrigger = el), onClick: this.onMenuButtonClick.bind(this) }), index.h("z-popover", { ref: (el) => (this.popoverEl = el), bindTo: this.menuTrigger, onOpenChange: (event) => (this.isMenuOpen = event.detail.open) }, index.h("slot", { name: "contextual-menu" }))))));
    }
...
//# sourceMappingURL=index-e61ccca6.js.map