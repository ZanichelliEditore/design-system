...
const ZAnchorNavigation = class {
  ...
  render() {
    return (index.h(index.Host, { collapsed: this.collapsed }, index.h("z-button", { variant: index$1.ButtonVariant.SECONDARY, icon: this.collapsed ? "chevron-up" : "chevron-down", onClick: this.toggleCollapsed.bind(this) }, "salta a"), index.h("nav", { ref: (el) => (this.nav = el) }, index.h("slot", null))));
  }
};
