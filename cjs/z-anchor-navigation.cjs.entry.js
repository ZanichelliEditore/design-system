...
const ZAnchorNavigation = class {
    ...
    render() {
        return (index.h(index.Host, { key: '40c490634b5e567815548db1d680503b34df39cf', collapsed: this.collapsed }, index.h("z-button", { key: '62c027ed41139cf8f8a26bfcd1f6e61d0a1a9978', class: "toggle", variant: index$1.ButtonVariant.SECONDARY, icon: this.collapsed ? "chevron-up" : "chevron-down", onClick: this.toggleCollapsed.bind(this) }, "salta a"), index.h("nav", { key: 'a47eecd0766ce06b867f303e405aea4cfde06031', ref: (el) => (this.nav = el) }, index.h("slot", { key: '2e2f920a69b34aaa75ce61ba85db318ddee37828' }))));
    }
};
