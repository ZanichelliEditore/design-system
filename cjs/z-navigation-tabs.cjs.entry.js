...
const ZNavigationTabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '612788b96886b932a6cf18b16422612ce8a87a28', class: {
                "interactive-2": this.size === index$1.NavigationTabsSize.SMALL,
                "interactive-1": this.size !== index$1.NavigationTabsSize.SMALL,
            }, scrollable: this.canNavigate }, index.h("button", { key: '93968651f7f5199ada5345641b5d3abf796cdb81', class: "navigation-button", onClick: this.navigateBackwards.bind(this), tabIndex: -1, disabled: !this.canNavigatePrev, "aria-label": "Mostra elementi precedenti", hidden: !this.canNavigate }, index.h("z-icon", { key: 'dbc1661829b7bd5e52e00437e232d24be57d4f77', name: this.orientation === index$1.NavigationTabsOrientation.HORIZONTAL ? "chevron-left" : "chevron-up", width: 16, height: 16 })), index.h("nav", { key: '804a3005ca3967d6403ad977ec16a9766612cbc0', role: "tablist", "aria-label": this.ariaLabel, ref: (el) => (this.nav = el !== null && el !== void 0 ? el : this.nav), onScroll: this.checkScrollEnabled.bind(this), "aria-orientation": this.orientation }, index.h("slot", { key: 'f970838c5f1b4669f3ff409abaa2ee5a26ec0542' })), index.h("button", { key: '280ca6b35e79aa8f3bef4115071b53d7bf6c99c3', class: "navigation-button", onClick: this.navigateForward.bind(this), tabIndex: -1, disabled: !this.canNavigateNext, "aria-label": "Mostra elementi successivi", hidden: !this.canNavigate }, index.h("z-icon", { key: '6cd794d570d1d4b04910de7d94cf91e3f56cd09a', name: this.orientation === index$1.NavigationTabsOrientation.HORIZONTAL ? "chevron-right" : "chevron-down", width: 16, height: 16 }))));
    }
