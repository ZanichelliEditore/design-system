...
const ZMyzTopbar = class {
  ...
  renderLoginButton() {
    ...
    return (index.h("z-button-deprecated", { htmlid: "login-button", variant: this.ismyz ? index$1.ButtonVariantEnum.secondary : index$1.ButtonVariantEnum.tertiary, icon: "login", issmall: true }, "entra"));
  }
