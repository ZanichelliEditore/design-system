...
const ZMyzCardFooter = class {
    ...
    render() {
        return (index.h("div", { key: 'e5711063557dce84367650a81a3313e4d4755ca7', class: Object.assign(Object.assign({}, this.retrieveClass()), { wrapper: true }) }, index.h("footer", { key: '81fe8ba76037d6aabf6a34123ef7e16b9fdcf6bf', class: this.retrieveClass(), onTransitionEnd: (e) => this.footerTransitionHandler(e) }, index.h("span", { key: 'fe8a8eb5e9668ef98052aa77ea006e36e1da4362', class: "toggle" }, index.h("slot", { key: '1b31d051074a5c49783adced5ab8a08ffce34c2c', name: "toggle" })), this.titolo && index.h("p", { key: 'fd5184ba3211dcaec0fbbada7e66c2424e8683a1', class: { "custom-content": this.customContent } }, this.titolo), index.h("div", { key: 'eb56f5377d285fa66090865f3750267827a55b30', class: { "content": true, "custom-content": this.customContent } }, index.h("div", { key: '73df88cb7871a4aeb47414cdfb2c248f4cae0454' }, index.h("p", { key: 'bcee7b1836e87540bb9ea7a0dae9b20717acb84b', class: "authors", ref: (el) => (this.ellipsisAuthors = el) }, index.h("span", { key: '1a2741b228850ea9b438e2d0d3bbe161f1c58223', title: this.getTitleAuthors() }, index.h("span", { key: '78e8afea170e944a119670a1f3ff35d9b1e68cca', "aria-description": "Autori", class: "bold" }, this.autori))), index.h("p", { key: '46339663289bca4d4c0d18f5a8a1e5c7f967a2c7', class: "year-isbn" }, index.h("span", { key: '885b4e716717a5e7faf0b2cdd0eb0a120c6b02a5', class: "isbn" }, index.h("span", { key: '8eb8fe819c2208bcd85a4ff75bcea45d126bbcfd' }, index.h("span", { key: 'adce63e9a8982d61692c899da383374914db342d', "aria-description": "ISBN edizione cartacea", class: "bold" }, this.isbn), " ", "(ed. cartacea)")))), index.h("div", { key: 'b36ed0288ce7e14a3c8770cd097f712440d10c5b', class: `slot-handler ${this.isOpen ? "visible" : "hidden"}` }, index.h("slot", { key: 'f7eca7603fd10d49a68f7c41505d50ee185e206f', name: "list" })))), this.customContent && index.h("slot", { key: '4f80af2d5fe5bba71f5d1704f4816aa395effe88', name: "content" })));
    }
