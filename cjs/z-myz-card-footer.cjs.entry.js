...
const ZMyzCardFooter = class {
    ...
    render() {
        return (index.h("div", { key: '5dd8a1450395437b275fb926b09da03549915574', class: Object.assign(Object.assign({}, this.retrieveClass()), { wrapper: true }) }, index.h("footer", { key: '7b7e36ef2959885e4a560982cb7e08ac04818780', class: this.retrieveClass(), onTransitionEnd: (e) => this.footerTransitionHandler(e) }, index.h("span", { key: '1c40adf2f5d502c07c9376b63a8698d4667db396', class: "toggle" }, index.h("slot", { key: 'bd6af616f75d683d7be56058acc8b73b3bf93df6', name: "toggle" })), this.titolo && index.h("p", { class: { "custom-content": this.customContent } }, this.titolo), index.h("div", { key: '65e8bf56114cffbd456848ee1f8d1114e6e5080a', class: { "content": true, "custom-content": this.customContent } }, index.h("div", { key: '66e9bc72b76b51fd62b480fdcd79fb1275fa6025' }, index.h("p", { key: '3ed9294e4344921197fab0e6514060c44fbb1e1b', class: "authors", ref: (el) => (this.ellipsisAuthors = el) }, index.h("span", { key: '59377aadd8b9390fe356ef2b43c19deba9215ef8', title: this.getTitleAuthors() }, index.h("span", { key: 'ee5c8a2ae408e4e5188dc446155c9aeb718166d4', "aria-description": "Autori", class: "bold" }, this.autori))), index.h("p", { key: 'e18fb80f72dcc4167f9f3a9b01125bee192d93c4', class: "year-isbn" }, index.h("span", { key: '2bd10075dbcad13130986d76b0a1876b83c38a3e', class: "isbn" }, index.h("span", { key: '0db0267195bbac8406e70f4476b5f47063fe94b5' }, index.h("span", { key: '2353a8330af27b7cb67b581867684fd8038aa482', "aria-description": "ISBN edizione cartacea", class: "bold" }, this.isbn), " ", "(ed. cartacea)")))), index.h("div", { key: 'bcd81eae284110276be84b0493386f50280714bb', class: `slot-handler ${this.isOpen ? "visible" : "hidden"}` }, index.h("slot", { key: '74920df025462ca9464bbe269036a5c72a1b239e', name: "list" })))), this.customContent && index.h("slot", { name: "content" })));
    }
