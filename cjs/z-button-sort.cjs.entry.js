...
const ZButtonSort = class {
    ...
    render() {
        return (index.h("button", { key: '444ce93c134cb613b64f1ebd82f8744b7dcd38f2', title: this.setButtonTitle(), id: this.buttonid, class: { selected: this.isselected }, onClick: () => this.emitButtonSortClick() }, index.h("span", { key: '586d7950170a1d79bf495b00f405fdfcd8f43a0d', ref: (el) => (this.ellipsis = el), class: "ellipsis" }, !this.sortasc && this.desclabel ? this.desclabel : this.label), index.h("span", { key: 'eada0327e1a5117958be3147dc1c134338759d92', class: "counter" }, this.counter && ` (${this.counter})`), index.h("span", { key: '03bf71c7f7670ba162ca24c2d455d7454677793c', class: "sort" }, this.sortasc ? this.sortlabelasc : this.sortlabeldesc), index.h("z-icon", { key: 'd2ec9963ebe5b404a78af6fe3f0d228583dce23b', name: "caret-up-down", width: 16, height: 16 })));
    }
};
