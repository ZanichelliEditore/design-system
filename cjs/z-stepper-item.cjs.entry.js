...
const ZStepperItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c5ca192ca8a2dbf5a7df76d24059e2f312e2d6de', role: "listitem" }, index.h("button", Object.assign({ key: 'df91258ecfeef2cc2d42b7cdeb35fe4d74fa53d9', class: "stepper-item", disabled: this.disabled }, this.getAttributes()), index.h("div", { key: '45a0b2b14d11094e753e89747c89ad6554b6f086', class: "indicator" }, this.checked ? index.h("z-icon", { name: "checkmark" }) : this.index), index.h("span", { key: 'fbb1e1340c9d200312814aac29bf76077b956ea8' }, index.h("slot", { key: '79791a5e64454e4b543b49e97f9af3592a18c4cf' })))));
    }
};
