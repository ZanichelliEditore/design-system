...
const ZStepperItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0994d3d3a8e89f1a93f17cb71baff1c1581bf7e4', role: "listitem" }, index.h("button", Object.assign({ key: '14becf7e97de2bd909f61cc3aa09b64b45f7ab30', class: "stepper-item", disabled: this.disabled }, this.getAttributes()), index.h("div", { key: '69f3cd00d2eeaafa65037d939218b2665d34b62b', class: "indicator" }, this.checked ? index.h("z-icon", { name: "checkmark" }) : this.index), index.h("span", { key: '8d2ed47daa09ae26562bac42d262ba7c4c5320a4' }, index.h("slot", { key: '48004d92935fa78bd48df08a9eb3db11662a171b' })))));
    }
};
