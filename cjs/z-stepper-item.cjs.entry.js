...
const ZStepperItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd760ab7aef2991d5ffc8754e4e03263c4c476a6d', role: "listitem" }, index.h("button", Object.assign({ key: '7fca3fa04459cdea8813db6382726cc601e4e3f8', class: "stepper-item", disabled: this.disabled }, this.getAttributes()), index.h("div", { key: 'c727b40105af8807c1b7fddf19243147bc2acdab', class: "indicator" }, this.checked ? index.h("z-icon", { name: "checkmark" }) : this.index), index.h("span", { key: 'f8d063aeeac60eb9adeaf65774b60ff07bb1c9ba' }, index.h("slot", { key: 'b0bd5470c318acc8037abb11b974a4cc1f057fd8' })))));
    }
};
