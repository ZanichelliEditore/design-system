...
const ZNavigationTabLink = class {
    ...
    render() {
        return (index.h(index.Host, { key: '77c729dd9c1bfd412d958eb477f2e227ba7fc7a7', role: "tab", id: this.tabId, "aria-selected": this.selected ? "true" : "false", "aria-controls": this.ariaControls }, index.h("a", { key: '3b70074a8637c2df922e6c5dcfc38f45c14ae770', tabIndex: this.selected ? 0 : -1, onFocus: this.scrollToTab.bind(this), href: this.disabled ? null : this.href, title: this.htmlTitle, target: this.target }, this.icon && this.renderIcon(), this.orientation === "horizontal" && this.label)));
    }
...
exports.z_navigation_tab_link = ZNavigationTabLink;

//# sourceMappingURL=z-navigation-tab-link.cjs.entry.js.map