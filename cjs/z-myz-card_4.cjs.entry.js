...
const ZMyzCardComponent = class {
    ...
    render() {
        return (index.h("div", { key: '2ea30f2293b9dd4cc187d2cc97449caf4851b424', class: this.retrieveClass(), tabindex: "0" }, index.h("slot", { key: 'ee17e5ceb45cba4f565e6efe41cf524f2cf91ed7' })));
    }
};
...
const ZMyzCardBody = class {
    ...
    render() {
        return (index.h("div", { key: '445a0d9463e21e7e51df000bbd32b892d16db6f7' }, index.h("slot", { key: 'aff7823ed27e2055d2803a1a55a0be35cfbcebf5', name: "alert" }), index.h("slot", { key: '0f435dc867e63caadc313043006a97156ebe2dc3', name: "cover" })));
    }
};
...
const ZMyzCardCover = class {
    ...
    render() {
        return (index.h("img", { key: '3b84be44f2691dea2e073c4f941672de4febfb8c', class: this.faded && "faded", onError: this.hadleOnImageError.bind(this), alt: this.titolo, src: this.img }));
    }
};
...
const ZMyzCardHeader = class {
    ...
    render() {
        return (index.h("header", { key: '42e4bbade9cd208a99dcee56b87ee0fcff8202b2', class: this.retrieveClass() }, index.h("slot", { key: '939ec6cec0e6b04daba246efa4cbd841c8f72199', name: "aria-heading" }), index.h("span", { key: 'd71fe4dcb951f026dccdb791f67c56aa74508487', class: "card-title", ref: (el) => (this.ellipsis = el), title: this.getTitle() }, this.titolo), index.h("slot", { key: 'dd4ad05319e7c87f1ad55a6fb1ff02e2e529757d', name: "icon" })));
    }
};
