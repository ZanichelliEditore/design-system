...
const ZCombobox = class {
    ...
    render() {
        return (index.h("div", { key: '4d1d99f8d0f180054a363b17d478098380677de2', "data-action": `combo-${this.inputid}`, class: { open: this.isopen, fixed: this.isfixed, disabled: this.disabled }, id: this.inputid }, this.renderHeader(), !this.disabled && this.renderContent()));
    }
