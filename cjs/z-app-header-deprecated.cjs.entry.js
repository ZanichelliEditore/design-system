...
const ZAppHeaderDeprecated = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a0e0fe7e06eac6328fe819c95e40b549be76efdb', "menu-length": this.menuLength }, this.hasHero && (index.h("div", { key: 'f05ae37dd21db654e107d8c8c7b16afe1634a062', class: "hero-container" }, index.h("slot", { key: '2d1cd14c6ae3c346ef2c3339c3368eecb2f5ace2', name: "hero" }, this.hero && (index.h("img", { key: '3cd447465d2fea783a84ece16c20a01c8c64087b', alt: "", src: this.hero }))))), index.h("div", { key: '095041a82c5b894e683eb010fb1665bc3e9808ca', class: "heading-panel", ref: (el) => (this.container = el) }, index.h("div", { key: 'c62badbae3fb60d2af0dc05b85f7dd1754298eff', class: "heading-container" }, index.h("div", { key: 'a78bf688652b80e35a89cb23dd010e90d9e84d09', class: "heading-subtitle" }, index.h("slot", { key: '8e9ac3667e178e6d44ca9811b99be0e9c0f9467e', name: "top-subtitle" })), index.h("div", { key: 'ef04ba5c9c7504e38ae1082db57e590a8b489296', class: "heading-title" }, this.menuLength > 0 && (index.h("button", { key: '6b47bef41f5c52346649aa0fdce31885631ff266', class: "drawer-trigger", "aria-label": "Apri menu", onClick: this.openDrawer }, index.h("z-icon", { key: '8d2fb8ee514986190eeaeaffe127b195741f2e15', name: "burger-menu" }))), index.h("slot", { key: '50e39ea522561a8e5e8ce1e5edf90a292003dac1', name: "title" }), this.renderSearchLinkButton()), index.h("div", { key: '7c20788bc0a3ffe2108716644bfcfd90e68a4fcb', class: "heading-subtitle" }, index.h("slot", { key: 'b97ba96e2d2d1723079007336304faacb9f1e3f4', name: "subtitle" }))), (this.canShowMenu || this.canShowSearchbar) && (index.h("div", { key: 'd2c80e708c8d306089362deee79c870df3533672', class: "menu-container" }, this.canShowMenu && (index.h("slot", { key: '48e564c8879affc0d139ce3a18182d0ff4822efe', name: "menu", onSlotchange: this.collectMenuElements })), this.canShowSearchbar && this.renderSeachbar(this.currentViewport !== "desktop")))), index.h("z-offcanvas", { key: '061ccba1ec1b09800121ab6af51c5dd3f039d3d0', variant: index$1.OffCanvasVariant.OVERLAY, transitiondirection: index$1.TransitionDirection.RIGHT, open: this.drawerOpen, onCanvasOpenStatusChanged: (ev) => (this.drawerOpen = ev.detail) }, index.h("button", { key: 'f65855e3863088f5f9c60a8df424dc4b3636d51d', class: "drawer-close", "aria-label": "Chiudi menu", onClick: this.closeDrawer, slot: "canvasContent", "aria-hidden": `${!this.drawerOpen}`, disabled: !this.drawerOpen }, index.h("z-icon", { key: '503fd5b98a1f39bba2e1b5e7ad4078defe2b4813', name: "close" })), index.h("div", { key: 'f60ff11c45faa831bd9fb9de70fecb655621fc43', class: "drawer-content", slot: "canvasContent", "aria-hidden": `${!this.drawerOpen}` }, index.h("slot", { key: '5022e0eb82b49a812422dc87efc106a0b34f2d8c', name: "menu", onSlotchange: this.collectMenuElements }))), this._stuck && (index.h("div", { key: 'c7476e1b005c85e62ea0b1bd859229a9fe46aa34', class: "heading-stuck" }, index.h("div", { key: '8b399a8ac01c3a4c4fadb7c462d93125d39110e2', class: "heading-stuck-content" }, this.menuLength > 0 && (index.h("button", { key: '6f8eaf8b1cacf80630e1ee8f3b5027939d0469b4', class: "drawer-trigger", "aria-label": "Apri menu", onClick: this.openDrawer }, index.h("z-icon", { key: '255dd9fec44a6fea5f0fd8158e2c921d6e50c7f2', name: "burger-menu" }))), index.h("div", { key: '0d5c56f43942a7a456651903bd88128403177180', class: "heading-title" }, index.h("slot", { key: '75977d8c47b692f4b5c6cc98b9d4fffd219fa360', name: "stucked-title" }, this.title)), this.renderSearchLinkButton(), this.canShowSearchbar && this.currentViewport === "desktop" && this.renderSeachbar(false))))));
    }
...
exports.z_app_header_deprecated = ZAppHeaderDeprecated;

//# sourceMappingURL=z-app-header-deprecated.cjs.entry.js.map