...
const ZMyzCardInfo = class {
    ...
    render() {
        return (index.h("div", { key: '1f42c0e5dee2d7dad7f4cfe4f57546091566e6a0' }, this.renderCloseIcon(), index.h("div", { key: '15bde9788efb9a4b9140ba75d0619aed9d9debfa', class: "content-wrapper", ref: (el) => (this.contentWrapper = el) }, this.renderGeneralSection(), this.renderTooltip(), this.renderOnlineLicenseSection(), this.renderOfflineLicenseSection()), index.h("div", { key: '813495ab63d355830e85557f10ae18ee3900c517', class: "cta-wrapper" }, index.h("slot", { key: '760ca67e6143c5d96bf31121b786e03f7606b4f3' }))));
    }
};
