...
const index = require('./index-29f95963.js');
const utils = require('./utils-36c21c9b.js');
...
const ZFooter = class {
    ...
    renderFooterSection(id, group) {
        return (index.h("nav", null, index.h("div", { class: "header" }, index.h("h2", null, group.title), this.isMobile && (index.h("button", { onClick: () => this.handleOnHeaderClick(id) }, index.h("z-icon", { name: this.isOpen[id] ? "chevron-up" : "chevron-down", width: 16, height: 16 })))), index.h("div", { class: "content" }, index.h("ul", { class: this.isOpen[id] ? "show" : "" }, group.items.map((item) => (index.h("li", null, index.h("a", { href: item.link, target: item.target ? item.target : "_blank" }, item.label))))))));
    }
    renderFooterTop() {
...
const ZInput = class {
    ...
    renderInputText(type = utils.InputTypeEnum.text) {
        ...
        return (index.h("div", { class: "textWrapper" }, this.renderLabel(), index.h("div", null, index.h("input", Object.assign({}, attr, { type: type === utils.InputTypeEnum.password && !this.passwordHidden
    ...
    renderCheckbox() {
        return (index.h("div", { class: "checkboxWrapper" }, index.h("input", { id: this.htmlid, type: "checkbox", name: this.name, checked: this.checked, value: this.value, disabled: this.disabled, readonly: this.readonly, required: this.required, onChange: () => this.handleCheckboxChange() }), index.h("label", { htmlFor: this.htmlid, class: `checkboxLabel ${this.labelafter ? "after" : "before"}` }, index.h("z-icon", { name: this.checked ? "checkbox-checked" : "checkbox", "aria-hidden": true }), this.label && index.h("span", { innerHTML: this.label }))));
    }
    /* END checkbox */
    /* START radio */
    handleRadioChange() {
    ...
    renderRadio() {
        return (index.h("div", { class: "radioWrapper" }, index.h("input", { id: this.htmlid, type: "radio", name: this.name, checked: this.checked, value: this.value, disabled: this.disabled, readonly: this.readonly, onChange: () => this.handleRadioChange() }), index.h("label", { htmlFor: this.htmlid, class: `radioLabel ${this.labelafter ? "after" : "before"}` }, index.h("z-icon", { name: this.checked ? "radio-button-checked" : "radio-button", "aria-hidden": true }), this.label && index.h("span", { innerHTML: this.label }))));
    }
    /* END radio */
    /* START select */
    renderSelect() {
...
const ZMenuDropdown = class {
    ...
    render() {
        return (index.h("a", { class: this.retriveMenuClass(), role: "button", tabindex: "0", onFocus: () => {
            ...
            }, onKeyUp: (e) => utils.handleKeyboardSubmit(e, this.handleToggle) }, index.h("div", { class: "container", onClick: () => this.handleToggle() }, index.h("z-icon", { name: "user-avatar", width: 14, height: 14 }), index.h("span", { class: "user" }, this.nomeutente), this.renderButtonMenu()), this.renderMenuOpen()));
    }
};
