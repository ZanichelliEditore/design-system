...
const ZAccordion = class {
    ...
    render() {
        return (index.h("details", { key: '9b6381d6a29fe8ea16ecdcb38d1784c1cc3bcc80', ref: (elm) => (this.detailsElm = elm), onToggle: this.onDetailsToggle.bind(this), open: this.open }, index.h("summary", { key: 'bf02abfd586afbafabddf1d3e5d7de934722dea6', tabIndex: this.isDisabled ? -1 : null, part: "summary" }, this.icon && (index.h("z-icon", { class: "z-accordion-label-icon", name: this.icon })), index.h("span", { key: '2fa466698c2f605dbe4eaac5cd48cd9af69448cc', class: "z-accordion-label" }, this.label), index.h("span", { key: '3cf6a1812413aa84f7ce106d5b81587d5e211cb2', class: "z-accordion-tags" }, index.h("slot", { key: '0a7109139d474427bf396960af79eae2e827c985', name: "tag" })), index.h("z-icon", { key: 'e2853db6bbd4947486fe3d95a5bc8d003c74299f', class: "z-accordion-chevron", name: this.open ? "chevron-up" : "chevron-down" })), !this.isDisabled && (index.h("div", { class: "z-accordion-content", part: "content" }, index.h("slot", null)))));
    }
