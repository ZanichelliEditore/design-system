...
const ZAccordion = class {
    ...
    render() {
        return (index.h("details", { key: '56a50ae163d1cb527d90732d637d0a657641cff7', ref: (elm) => (this.detailsElm = elm), onToggle: this.onDetailsToggle.bind(this), open: this.open }, index.h("summary", { key: '22095c950d00c43d6ddfc3eaea13c804e24fbb37', tabIndex: this.isDisabled ? -1 : null, part: "summary" }, this.icon && (index.h("z-icon", { key: '40f7b6d5dec14284aba76ca8884740b81f4d43a0', class: "z-accordion-label-icon", name: this.icon })), index.h("span", { key: '781a5720488ab4972e685d3ac4efafaf25cb1a20', class: "z-accordion-label" }, this.label), index.h("span", { key: '83fbad7e915391654344591231db512b13ccd1bb', class: "z-accordion-tags" }, index.h("slot", { key: 'd02d6e89bf46e606fdf229906036fbf3ebdbff05', name: "tag" })), index.h("z-icon", { key: 'd239c54b1187939517baf24809cab9c5168afa2a', class: "z-accordion-chevron", name: this.open ? "chevron-up" : "chevron-down" })), !this.isDisabled && (index.h("div", { key: '750de9f238fad34d4d380f585cc948067f229f8a', class: "z-accordion-content", part: "content" }, index.h("slot", { key: '41568aa9d4e561b1f7f43fbf2bf9cb7ab0c1a713' })))));
    }
