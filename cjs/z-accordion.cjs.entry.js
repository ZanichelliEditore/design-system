...
const ZAccordion = class {
    ...
    render() {
        return (index.h("details", { key: 'a1a71f7848714200cb7257e52f5fc33eb5c138a8', ref: (elm) => (this.detailsElm = elm), onToggle: this.onDetailsToggle.bind(this), open: this.open }, index.h("summary", { key: '6d54c14ad248b2b10a7483b4c4bbb7d551f0cc1d', tabIndex: this.isDisabled ? -1 : null, part: "summary" }, this.icon && (index.h("z-icon", { class: "z-accordion-label-icon", name: this.icon })), index.h("span", { key: 'e5c9bb595f5ff65ede8d0094172e8779b85023db', class: "z-accordion-label" }, this.label), index.h("span", { key: 'b48e9f6e1dca9c00c9f85a8a6960a774a07f1287', class: "z-accordion-tags" }, index.h("slot", { key: '9c9300a51a7b484c9e34dd48ad88f0e81909f13a', name: "tag" })), index.h("z-icon", { key: '1394de17280c4a42735ab0f839a3ad967d0f27e2', class: "z-accordion-chevron", name: this.open ? "chevron-up" : "chevron-down" })), !this.isDisabled && (index.h("div", { class: "z-accordion-content", part: "content" }, index.h("slot", null)))));
    }
