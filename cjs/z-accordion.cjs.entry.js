...
const ZAccordion = class {
    ...
    render() {
        return (index.h("details", { key: 'df8ab3183d7dee036891420e1ca4b58ea8186972', ref: (elm) => (this.detailsElm = elm), onToggle: this.onDetailsToggle.bind(this), open: this.open }, index.h("summary", { key: 'c4160d5af242307bc85cd4fbe055b6646aa065b8', tabIndex: this.isDisabled ? -1 : null, part: "summary" }, this.icon && (index.h("z-icon", { class: "z-accordion-label-icon", name: this.icon })), index.h("span", { key: '1802dd7e1b6384c69527e0d4cf65881f4810f88c', class: "z-accordion-label" }, this.label), index.h("span", { key: '38244c63af937be53bb3fb2e54f225239ce2b9f9', class: "z-accordion-tags" }, index.h("slot", { key: '2cacb7ab9947c006b50de586065b2a77868dbb11', name: "tag" })), index.h("z-icon", { key: 'd9936dc9e899a176a3e929758f36cdd5f278b50e', class: "z-accordion-chevron", name: this.open ? "chevron-up" : "chevron-down" })), !this.isDisabled && (index.h("div", { class: "z-accordion-content", part: "content" }, index.h("slot", null)))));
    }
