...
const ZModalLogin = class {
  ...
  emitLoginSubmit() {
    ...
    if (!username || !password) {
      this.status = index$1.InputStatus.ERROR;
      return;
    }
