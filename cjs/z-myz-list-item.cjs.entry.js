...
const ZMyzListItem = class {
    ...
    render() {
        ...
        return (index.h("li", { key: '94c2984279c7bc295ba60c54e205310b5d584f24', role: "button", id: this.listitemid, "data-action": this.action, onClick: (e) => this.emitZListItemClick(e, this.listitemid), onKeyPress: (ev) => utils.handleKeyboardSubmit(ev, this.emitZListItemClick, this.listitemid) }, index.h("span", { key: '766ae559f05ac6565f45930eea86f15cd9950324', class: this.underlined && "border" }, this.icon && index.h("z-icon", { key: '82154a54b424ae62ac1701aed06872443c879795', name: this.icon }), this.link ? (index.h("a", { href: this.link ? this.link : null, target: this.linktarget, id: linkId, onClick: (e) => this.emitZListItemLinkClick(e, linkId), onKeyPress: (ev) => utils.handleKeyboardSubmit(ev, this.emitZListItemLinkClick, linkId), role: this.link ? "link" : "button", tabindex: "0" }, this.text)) : (index.h("span", { innerHTML: this.text })), index.h("slot", { key: '66674a723e927ea0be315fafd84c9d07883a4561' }))));
    }
};
