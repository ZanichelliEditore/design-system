...
const index$1 = require('./index-b696b873.js');
...
function handleKeyboardSubmit(ev, callback, ...args) {
  if (ev.keyCode === index$1.keybordKeyCodeEnum.ENTER ||
    ev.keyCode === index$1.keybordKeyCodeEnum.SPACE) {
    ev.preventDefault();
    callback(...args);
  }
}
...
const ZCombobox = class {
  ...
  renderHeader() {
    return (index.h("div", { class: "header", onClick: () => this.closeComboBox(), onKeyDown: (ev) => {
        if (ev.keyCode === index$1.keybordKeyCodeEnum.SPACE)
          ev.preventDefault();
      }, onKeyUp: (ev) => handleKeyboardSubmit(ev, this.closeComboBox), role: "button", tabindex: 0 }, index.h("h2", null, this.label, index.h("span", null, this.selectedCounter > 0 && ` (${this.selectedCounter})`)), index.h("z-icon", { name: "caret-down", width: 18, height: 18 })));
  }
  renderContent() {
    if (!this.isopen)
      return;
  ...
  renderCloseButton() {
    return (index.h("div", null, index.h("a", { onClick: () => this.closeFilterItems(), onKeyUp: (e) => handleKeyboardSubmit(e, this.closeFilterItems), role: "button", tabindex: 0 }, this.closesearchtext)));
  }
  renderSearchInput() {
    if (!this.isopen)
      return;
...
const ZMenuDropdown = class {
  ...
  render() {
    return (index.h("a", { class: this.retriveMenuClass(), role: "button", tabindex: "0", onFocus: () => {
      ...
      }, onKeyUp: (e) => handleKeyboardSubmit(e, this.handleToggle) }, index.h("div", { class: "container", onClick: () => this.handleToggle() }, index.h("span", { class: "user-wrapper" }, index.h("z-icon", { name: "user-avatar", width: 14, height: 14 }), index.h("span", { class: "user" }, this.nomeutente)), this.renderButtonMenu()), this.renderMenuOpen()));
  }
};
