...
const ZToggleSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cd90ad41b289f192e485c0cce90ae2a8057ddd7d' }, index.h("input", { key: '5cc5e59f8cc0cc0548b072e41149cf7dc31bbcd8', id: this.htmlid, type: "checkbox", checked: this.checked, disabled: this.disabled, onChange: this.handleClick.bind(this) }), index.h("label", { key: '9774cc39f7ebe6bd02c5ce0e05d1b53075f4e426', htmlFor: this.htmlid, class: {
                [this.labelPosition]: true,
                disabled: this.disabled,
            } }, index.h("span", { key: '074941585b8a5862f04bd2d404ab74c86bcaa250' }, index.h("slot", { key: '7fe6486df9479e76a7783646aed3e620f7f1d0f2' })), index.h("span", { key: 'd4bf4b3febdab1bf8e88c12e1c7aa421b020997c', class: {
                container: true,
                disabled: this.disabled,
                checked: this.checked,
            } }, index.h("span", { key: 'c46c06ff10a35060945b9298a551cf66508a5450', class: "circle" }, this.checked && (index.h("z-icon", { key: '7ed667dc510d42e3e001ad8cb82b5c5f9d012583', width: 12, height: 12, name: "checkmark" })))))));
    }
};
