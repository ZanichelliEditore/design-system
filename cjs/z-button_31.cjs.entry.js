...
class ZInput {
    ...
    renderMessage() {
        if (!this.hasmessage)
            return;
        return (index.h("span", { class: `statusMsg msg_${this.status}` }, this.status && this.message ? (index.h("z-icon", { name: this.statusIcons[this.status], width: 14, height: 14 })) : null, index.h("span", { innerHTML: this.message })));
    }
