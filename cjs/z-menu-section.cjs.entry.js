...
const ZMenuSection = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'beadad10be10337d069e96c4144372b3ae9188d7', role: "menu", open: this.open }, index.h("button", { key: 'd76a6e7da3bb60238571b5a4e9c76b2923b07a97', class: "label", "aria-pressed": this.open ? "true" : "false", onClick: this.toggle.bind(this) }, index.h("slot", { key: 'ba6a653482a7e3f5de77877e7e69225c236b85f8', onSlotchange: this.onLabelSlotChange.bind(this) }), this.hasContent && index.h("z-icon", { name: this.open ? "chevron-up" : "chevron-down" })), this.open && (index.h("div", { class: "items" }, index.h("slot", { name: "item", onSlotchange: this.checkContent.bind(this) })))));
    }
