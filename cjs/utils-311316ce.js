...
function setFlatpickrPosition(element, mode) {
    ...
    const flatpickrHeight = mode === index.ZDatePickerMode.DATE_TIME
        ? index.ZDatePickerModeValue.DATE_TIME
        : mode === index.ZDatePickerMode.MONTHS
            ? index.ZDatePickerModeValue.MONTHS
            : index.ZDatePickerModeValue.DATE;
    ...
    if (!overflowTop && overflowBottom) {
        return index.ZDatePickerPosition.TOP;
    }
    return index.ZDatePickerPosition.BOTTOM;
}
...
//# sourceMappingURL=utils-311316ce.js.map