...
const ZInfoReveal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9760fea9358ffa3422f6dad090a03c30cd8b51f2', open: this.open }, index.h("button", { key: '52c39a04ac63089ecb493927b49dea106a94ee93', class: "z-info-reveal-trigger", type: "button", onClick: this.togglePanel.bind(this), "aria-label": !this.label ? this.ariaLabel : undefined, "aria-expanded": this.open ? "true" : "false", "aria-controls": "z-info-reveal-panel" }, this.icon && index.h("z-icon", { name: this.icon }), this.label && index.h("span", { class: "z-info-reveal-label" }, this.label)), index.h("div", { key: '839afc7d65706951dcf0b5a56aaa69c6c56cc720', class: "z-info-reveal-panel", id: "z-info-reveal-panel", ref: (el) => (this.panel = el), hidden: !this.open }, index.h("slot", { key: '598c69722edab2f836962b3807e50a4a8a296aee' }), index.h("button", { key: '53c5f103f7bcca4bf1d6ccb8d4454459b1a82afd', class: "z-info-reveal-close", type: "button", onClick: this.closePanel.bind(this), "aria-label": "Chiudi pannello informazioni" }, index.h("z-icon", { key: '506717510c3ab82f30efbfe70753af7bc277a29f', name: "multiply" })))));
    }
