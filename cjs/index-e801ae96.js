    ...
    return module[exportName];
        ...
        if (!hmrVersionId || !BUILD.hotModuleReplacement) {
          ...
          switch(bundleId) {
                ...
                case 'z-app-header-deprecated.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './z-app-header-deprecated.cjs.entry.js')); }).then(processMod, consoleError);
                ...
                case 'z-menu-deprecated.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './z-menu-deprecated.cjs.entry.js')); }).then(processMod, consoleError);
                case 'z-menu-section.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './z-menu-section.cjs.entry.js')); }).then(processMod, consoleError);
                case 'z-menu-section-deprecated.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './z-menu-section-deprecated.cjs.entry.js')); }).then(processMod, consoleError);
...
//# sourceMappingURL=index-e801ae96.js.map