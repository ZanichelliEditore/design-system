...
const ZDatePicker = class {
  ...
  setAriaOptions() {
    ...
    if (this.mode === index$1.ZDatePickerMode.dateTime) {
  ...
  renderZInput() {
    return (index.h("z-input", { class: index$2.classnames(this.datepickerid), type: "text", icon: "event", hasmessage: false, tabindex: "0" }));
  }
  render() {
