...
const ZDatePicker = class {
  ...
  setFlatpickrPosition() {
    ...
    const flatpickrHeight = this.mode === index$1.ZDatePickerMode.dateTime
      ? index$1.ZDatePickerModeValues.DATETIME
      : this.mode === index$1.ZDatePickerMode.months
        ? index$1.ZDatePickerModeValues.MONTHS
        : index$1.ZDatePickerModeValues.DATE;
    ...
    if (!overflowTop && overflowBottom) {
      this.flatpickrPosition = index$1.ZDatePickerPosition.top;
    }
    else {
      this.flatpickrPosition = index$1.ZDatePickerPosition.bottom;
    }
  ...
  renderZInput() {
    return (index.h("z-input", { class: index$2.classnames(this.datepickerid), type: "text", name: "datepicker", icon: "event", hasmessage: false }));
  }
  render() {
    return (index.h("div", { class: index$2.classnames("flatpickr-toggle-container", this.hasChildren && this.datepickerid, this.flatpickrPosition, this.mode), onClick: () => this.setFlatpickrPosition() }, this.hasChildren ? this.renderSlottedContent() : this.renderZInput()));
  }
