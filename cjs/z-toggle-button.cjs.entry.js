...
const ZToggleButton = class {
    ...
    render() {
        return (index.h("button", { key: '45734652da19db32f9ca48cc87ae096a961b8fdb', tabindex: this.avoidclick ? "-1" : "0", class: {
                "isopen": this.opened,
                "avoid-clicks": this.avoidclick,
            }, disabled: this.isdisabled, "aria-expanded": this.opened ? "true" : "false", "aria-label": this.ariaLabel, onClick: () => this.emitToggleClick() }, index.h("z-icon", { key: '0630ac16f3c2fe347cf9c81cdbf07a06bc526778', name: this.opened ? "chevron-down" : "chevron-up", width: 16, height: 16 }), this.label));
    }
};
...
//# sourceMappingURL=z-toggle-button.cjs.entry.js.map