...
const ZBookCard = class {
  ...
  renderCover() {
    return (index.h("div", { class: "cover" }, this.ribbon && this.variant !== index$1.BookCardVariant.COMPACT && (index.h("div", { class: "ribbon" }, index.h("span", null, this.ribbon))), index.h("div", { class: "img-wrapper" }, index.h("img", { src: this.cover, onError: () => {
