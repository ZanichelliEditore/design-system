...
const ZMessagesPocket = class {
    ...
    render() {
        return (index.h("z-pocket", { key: '2f8a4cab129678f4a14c8fe5605c20098d29427a', pocketid: this.pocketid, status: this.status, class: this.status }, this.renderHeader(), this.renderBody()));
    }
};
