...
const ZChip = class {
    ...
    render() {
        return (index.h("div", { key: '6f854f9af61641c48e7870b320f330e08fa10115', class: {
                "z-chip-container": true,
                "z-chip-interactive": !!this.interactiveIcon,
                [this.type]: true,
            }, "aria-disabled": this.disabled }, this.icon && index.h("z-icon", { name: this.icon }), index.h("slot", { key: '17dd6eacc4edf0df59bd68f4c453126e954c5e86' }), this.interactiveIcon && (index.h("button", { type: "button", onClick: () => this.interactiveIconClick.emit(), "aria-label": this.ariaLabel, disabled: this.disabled }, index.h("z-icon", { class: "interactive-icon", name: this.interactiveIcon })))));
    }
