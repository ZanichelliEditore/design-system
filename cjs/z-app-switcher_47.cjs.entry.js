...
const utils = require('./utils-be91fdf2.js');
...
const ZAppSwitcher = class {
  ...
  renderDots(num = 9) {
    const result = [];
    for (let index$1 = 0; index$1 < num; index$1++) {
      result.push(index.h("span", { class: this.theme }));
    }
    return result;
  }
  render() {
    return (index.h("button", { title: "app-switcher", onClick: () => this.emitAppButtonClick() }, this.renderDots()));
  }
};
