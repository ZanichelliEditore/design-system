...
const index = require('./index-0e75c8cc.js');
...
function setFlatpickrPosition(element, mode) {
  ...
  const flatpickrHeight = mode === index.ZDatePickerMode.dateTime
    ? index.ZDatePickerModeValues.DATETIME
    : mode === index.ZDatePickerMode.months
      ? index.ZDatePickerModeValues.MONTHS
      : index.ZDatePickerModeValues.DATE;
...
function setAriaOptions(element, mode) {
  ...
  Array.from(calendar).forEach((element) => {
    ...
    if (mode === index.ZDatePickerMode.dateTime) {
