...
const ZBreadcrumb = class {
    ...
    render() {
        return (index.h(index.Host, { key: '103caf1740a6663402282211d961204bce9b8a70', style: { "--line-clamp-popover": `${this.overflowMenuItemRows}` } }, index.h("nav", { key: '6fea4845c60c77671d59abc70d9b4d10ce33c0f7', ref: (val) => (this.wrapElement = val), "aria-label": "Breadcrumb", class: {
            ...
            } }, index.h("ol", { key: '608d68e56a5810e77358afc316d5d4d721155628' }, this.viewPortWidth === index$1.Device.MOBILE ? this.renderMobileItems() : this.renderItems()))));
    }
