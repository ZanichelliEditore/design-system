...
const ZMyzCardDictionary = class {
    ...
    render() {
        return (index.h("div", { key: '07f2907ee9ae953ad0365dd0c8e2618524f89653' }, index.h("z-myz-card", { key: 'c21605f97d0cd1c9298643c2ad59ed4414a8ad16' }, index.h("z-myz-card-header", { key: '8798167fee3c810b002525720556c26bee3254de', titolo: this.name }), index.h("div", { key: '3d932ff6a732c3cbcf77fcd448e90e8265b02225', class: `content ${this.flipped ? "flipped" : ""}` }, index.h("div", { key: '83585f7409cb3daee9d7985d7e9c519b6c41e133', class: "front" }, index.h("z-myz-card-body", { key: '486d61f67e0affb3e4e7efdf0ab3feb2b26b4b0f' }, index.h("z-myz-card-cover", { key: '61c665f57fb7e969d8191b77d62c794474b08e62', slot: "cover", titolo: this.name, img: this.cover, faded: this.disabled })), index.h("z-button", { key: '7cf6f97b79d569143724561d59e8c77fba8e054e', class: { "hide-info": this.hideinfobtn }, variant: index$1.ButtonVariant.SECONDARY, icon: "informationsource", size: index$1.ButtonSize.X_SMALL, onClick: () => this.flipCard(true), disabled: this.flipped }, this.flipbuttonlabel)), index.h("div", { key: '562430df60bfa01db09cbad1d263586c6224af9c', class: "back" }, index.h("slot", { key: '537e1be569a72865724cfa85b7734dc0294bc115', name: "info" }))), index.h("slot", { key: '8b38959c1ddbeacd0bbca92fd14611355a24d74d' }))));
    }
};
