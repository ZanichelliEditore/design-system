...
const ZModal = class {
    ...
    render() {
        return (index.h("dialog", { key: '15eba99f071f5b0b57743e44b916c4ea6970f07a', class: {
                "modal-dialog": !this.scrollInside,
            }, "aria-labelledby": "modal-title", "aria-describedby": "modal-content", role: this.alertdialog ? "alertdialog" : undefined, ref: (el) => (this.dialog = el), onClose: () => this.emitModalClose(), onCancel: (e) => this.handleEscape(e) }, index.h("div", { key: '82ac5037fd70c3661dce7bd34300dd249aa1e052', class: {
                "modal-container": true,
                "modal-container-scroll-inside": this.scrollInside,
                "modal-container-scroll-outside": !this.scrollInside,
            }, id: this.modalid }, index.h("header", { key: '4885ed46b798305fc01456487c500aa89fbced3e', onClick: this.emitModalHeaderActive.bind(this) }, index.h("div", { key: '87d47369f0bb766cead5aee4889b0f7fbf96ded3' }, this.modaltitle && index.h("h1", { key: '79974d32cd15dc7c423f7cdd570f7eeb88c66b3f', id: "modal-title" }, this.modaltitle), this.closeButtonSlot()), this.modalsubtitle && (index.h("div", { key: 'da3e80cba34e51cf4c635839e7e989872144625f', class: "subtitle", id: "modal-subtitle" }, this.modalsubtitle))), index.h("div", { key: 'a4fea6c1784848e10390553f879873a7140d87d3', class: {
                "modal-content-scroll-inside": this.scrollInside,
                "modal-content-scroll-outside": !this.scrollInside,
            }, id: "modal-content" }, index.h("slot", { key: '2ff2465682aeb86fac11b7dd3edd788946295bc7', name: "modalContent" }))), index.h("div", { key: '1ad45c5b879fd7ae2d3d3560e7ad4199e8c0268d', class: {
