...
const ZDragdropArea = class {
    ...
    render() {
        return (index.h("div", { key: '1b7b83c36eaed52bc0a7c1bd935aeb457199bd68', tabIndex: 0, ref: (val) => (this.dragDropContainer = val), class: "dragdrop", onDragOver: (e) => {
                e.preventDefault();
            ...
            } }, this.renderOnDragOverMessage(), index.h("slot", { key: '45848602ab9f4c3318f506386d174cf8ec2fc84b' })));
    }
};
...
const ZModal = class {
    ...
    render() {
        return (index.h("dialog", { key: 'a1e93e72fa4aa80d94192e1fb18bca7a50ad0aa3', class: {
                "modal-dialog": !this.scrollInside,
            }, "aria-labelledby": "modal-title", "aria-describedby": "modal-content", role: this.alertdialog ? "alertdialog" : undefined, ref: (el) => (this.dialog = el), onClose: () => this.emitModalClose(), onCancel: (e) => this.handleEscape(e) }, index.h("div", { key: '5346f87a3812911b434a2b9b95691e86ecaeb853', class: {
                "modal-container": true,
                "modal-container-scroll-inside": this.scrollInside,
                "modal-container-scroll-outside": !this.scrollInside,
            }, id: this.modalid }, index.h("header", { key: 'ae7f3aa101e7a55276c4a07a58fd126da494ba83', onClick: this.emitModalHeaderActive.bind(this) }, index.h("div", { key: '6938cbb56171186773c6b2d14323bde7d2f40761' }, this.modaltitle && index.h("h1", { key: '0cc3ee46b3598ec91465c1f8668b399c0c32034f', id: "modal-title" }, this.modaltitle), this.closeButtonSlot()), this.modalsubtitle && (index.h("div", { key: '453e07da973d95eed5e66c4768c86cfe47cadbf3', class: "subtitle", id: "modal-subtitle" }, this.modalsubtitle))), index.h("div", { key: 'bb5a5facd7b854e172a4f0502f97a6fffc03552a', class: {
                "modal-content-scroll-inside": this.scrollInside,
                "modal-content-scroll-outside": !this.scrollInside,
            }, id: "modal-content" }, index.h("slot", { key: '3c2b58be34c464e06065258e710853e716d415df', name: "modalContent" }))), index.h("div", { key: '2b0e3e016ba08aeb65307ead19d9ca2ca408a85d', class: {
