...
const ZModal = class {
    ...
    render() {
        return (index.h("dialog", { key: 'e2e7b6cf379e4d8a0636b926901047a752184ac8', class: {
            ...
            }, id: this.modalid }, index.h("header", { key: '268f689959051dc304efd99dd64a4eb5ac47aa17', onClick: this.emitModalHeaderActive.bind(this) }, index.h("div", { key: '5651d45bddad36999eddf25863a7d398cc87cf91' }, this.modaltitle && index.h("h1", { id: "modal-title" }, this.modaltitle), this.closeButtonSlot()), this.modalsubtitle && index.h("h2", { id: "modal-subtitle" }, this.modalsubtitle)), index.h("div", { key: '93eae28fa449cc1830d533e93b46e580d4be4540', class: {
                "modal-content-scroll-inside": this.scrollInside,
                "modal-content-scroll-outside": !this.scrollInside,
            }, id: "modal-content" }, index.h("slot", { key: 'a38384cf4d2c4eadda052099f3d47f2457585555', name: "modalContent" }))), index.h("div", { key: '10f7f01194bd21059d9afb15c421eb9354b77302', class: {
