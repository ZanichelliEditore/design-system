...
const ZTableCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a55491d43ef04929fdd38073b589d12d5d373ca4' }, this.showButton && (index.h("div", { class: {
                ...
                "visible": this.isMenuOpened,
            } }, index.h("slot", { name: "contextual-menu" }))))), index.h("slot", { key: 'd8d5dab5bac78f43151d50d22df6cfbefdc81694' })));
    }
...
//# sourceMappingURL=index-a30259f3.js.map