...
const ZPocket = class {
    ...
    render() {
        return (index.h("div", { key: '326350f5b42a676f92c1246a676f074c12b5e2c8' }, index.h("div", { key: 'ff53a47e16b8a2809e96d49b129c6187e0e3364a', "data-action": "pocketBackground", "data-pocket": this.pocketid, class: `background ${this.status}`, onClick: (e) => this.handleBackgroundClick(e) }), index.h("div", { key: '28606d7b860f7283919f00010bf5f1c83ca75aa7', id: this.pocketid, class: "content-wrapper" }, index.h("div", { key: 'b54698aaa349bb75df7c6344b3cfff3122e530c5' }, index.h("slot", { key: '0e5ac1491d2c5128ed4c93b116d91a62e2afde41' })))));
    }
...
const ZPocketBody = class {
    ...
    render() {
        return (index.h("main", { key: 'a21e5307e4af8970761af2f04d1344997e171b48', class: this.status }, index.h("slot", { key: 'c6b38fb56dbca9e8cdb03acfb601f32822312fee' })));
    }
};
...
const ZPocketHeader = class {
    ...
    render() {
        return (index.h("header", { key: '90a6554d0c79aebcb62332c7ee23018103fa1916', role: "button", tabindex: 0, onClick: () => this.emitPocketHeaderClick(), onKeyPress: (ev) => utils.handleKeyboardSubmit(ev, this.emitPocketHeaderClick), ref: (el) => (this.swipeWrap = el) }, index.h("slot", { key: '4a3e7b093ba47de8fdbe0e96fff4f5880220bec4' })));
    }
};
