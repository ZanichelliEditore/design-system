...
const ZMyzCardIcon = class {
    ...
    render() {
        return (index.h("button", { key: '204f6d7ba43b9300ce8f4fbbd7d27849e7db1c8a', disabled: this.isdisabled, "aria-label": this.ariaLabel }, index.h("span", { key: '660c3c2bd313decba37ea630f83ce74c0b2f4153' }, index.h("z-icon", { key: '22fdf366571f73909d2411a0b745184a6d39b098', name: this.icon, width: 16, height: 16 }))));
    }
};
