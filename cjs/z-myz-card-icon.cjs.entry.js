...
const ZMyzCardIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'ad617a342a7d7ae30067dc750b17453d66db9ffa', disabled: this.isdisabled, "aria-label": this.ariaLabel }, index.h("span", { key: '67079cabf8a0b3213ca75a04e7570d984fe9286f' }, index.h("z-icon", { key: '1e0a2ebcac6652f6c720da6c74a2d8f718ec825f', name: this.icon, width: 16, height: 16 }))));
    }
};
