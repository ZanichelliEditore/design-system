...
const ZOtp = class {
    ...
    render() {
        return (index.h("div", { key: 'ed4894a5e991ebb5e870ab0a1f54c75217721c5c', class: "otp-container" }, index.h("div", { key: '1bef4aae264fb80813a5b7b71412eb638c17736d', class: "digits-container" }, this.otp.map((_val, i) => (index.h("input", { class: this.status == index$1.InputStatus.ERROR ? "error" : null, onKeyDown: (e) => {
                if (e.keyCode > 47) {
                    this.otpRef[i].value = "";
                }
            }, onKeyUp: (e) => {
            ...
            }, type: "text", minlength: "1", maxlength: "1", autoComplete: "off", ref: (el) => (this.otpRef[i] = el) })))), index.h("z-input-message", { key: '6b40b61f792ad0f1789a44d27b51657e2f446a8b', message: this.message, status: this.status })));
    }
};
