...
const ZNavigationTab = class {
  ...
  render() {
    return index.h("button", { disabled: this.disabled, role: "tab" }, index.h("slot", { name: "icon" }), index.h("slot", { name: "label" }));
  }
