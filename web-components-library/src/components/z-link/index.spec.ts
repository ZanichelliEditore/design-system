...
describe("Suite test ZLink", () => {
  it("Test render ZLink vuoto", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link>
        <mock:shadow-root>
          <a class="false" role="button" target="_self"></a>
        </mock:shadow-root>
      </z-link>
    `);
  });
  ...
  it("Test render ZLink con link", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link url="http://www.google.com/">
        <mock:shadow-root>
          <a href="http://www.google.com/" class="false" role="link" target="_self"></a>
        </mock:shadow-root>
      </z-link>
    `);
  });
  ...
  it("Test render ZLink con label", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link label="label">
        <mock:shadow-root>
          <a class="false" role="button" target="_self">label</a>
        </mock:shadow-root>
      </z-link>
    `);
  });
  ...
  it("Test render ZLink con icon", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link icon="icon">
        <mock:shadow-root>
          <a class="false" role="button" target="_self">
  ...
  it("Test render ZLink disabled", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link isdisabled>
        <mock:shadow-root>
          <a class="disabled false" role="button" target="_self"></a>
        </mock:shadow-root>
      </z-link>
    `);
  });
  ...
  it("Test render ZLink white", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link iswhite>
        <mock:shadow-root>
          <a class="white false" role="button" target="_self"></a>
        </mock:shadow-root>
      </z-link>
    `);
  });
  ...
  it("Test render ZLink target", async () => {
    ...
    expect(page.root).toEqualHtml(`
      <z-link target="_blank">
        <mock:shadow-root>
          <a class="false" role="button" target="_blank"></a>
        </mock:shadow-root>
      </z-link>
    `);
  });
