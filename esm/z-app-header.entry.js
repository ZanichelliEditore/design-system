import { r as registerInstance, h, H as Host, g as getElement } from './index-0148109c.js';
...
const ZAppHeader = class {
  ...
  render() {
    return h(Host, null, h("div", { class: "heading-panel", ref: (el) => this.container = el }, h("div", { class: "hero-container" }, h("slot", { name: "hero" }, this.hero && h("img", { alt: "", src: this.hero }))), h("div", { class: "heading-container" }, h("div", { class: "heading-title" }, h("button", { class: "drawer-trigger", onClick: this.openDrawer }, h("z-icon", { name: "burger-menu" })), h("slot", { name: "title" })), h("div", { class: "heading-subtitle" }, h("slot", { name: "subtitle" }))), h("div", { class: "menu-container" }, (!this.drawerOpen) && h("slot", { name: "menu", onSlotchange: () => this.collectMenuElements() }))), h("div", { class: "drawer-container", "data-open": this.drawerOpen }, h("div", { class: "drawer-overlay", onClick: this.closeDrawer }), h("div", { class: "drawer-panel" }, h("button", { class: "drawer-close", onClick: this.closeDrawer }, h("z-icon", { name: "close" })), h("div", { class: "drawer-content" }, this.drawerOpen && h("slot", { name: "menu", onSlotchange: () => this.collectMenuElements() })))), this.stucked && h("div", { class: "heading-stucked" }, h("button", { class: "drawer-trigger", onClick: this.openDrawer }, h("z-icon", { name: "burger-menu" })), h("div", { class: "heading-title" }, this.title)));
  }
  openDrawer() {
