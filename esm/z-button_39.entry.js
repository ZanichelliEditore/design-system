import { r as registerInstance, h, g as getElement, c as createEvent } from './index-06b54d7b.js';
import { B as ButtonTypeEnum, a as ButtonVariantEnum, L as LicenseTypeEnum, I as InputTypeEnum, k as keybordKeyCodeEnum, b as InputStatusEnum, T as TooltipPosition } from './index-162715ba.js';
import { h as handleKeyboardSubmit, r as randomId, g as getElementTree, a as getClickedElement } from './utils-f6d06c0e.js';
...
ZCardAlert.style = stylesCss$x;

const stylesCss$w = ":host{height:340px;width:auto}:host>div{height:340px;width:auto;display:flex;align-items:center;justify-content:center;position:relative}";
...
ZCardBody.style = stylesCss$w;

const stylesCss$v = "img{display:block;max-height:340px;margin:auto auto}img.faded{opacity:0.3}";
...
ZFooterSection.style = stylesCss$l;

const stylesCss$k = ":host{font-family:var(--dashboard-font);font-weight:var(--font-rg)}:host>a>img{width:calc(var(--space-unit) * 3)}@media only screen and (min-width: 1152px){:host>a>img{width:16px}}";
...
const stylesCss$i = ":host{line-height:0;vertical-align:middle}";
...
ZIcon.style = stylesCss$i;

const stylesCss$h = ":host>div{display:flex;flex-flow:row wrap;justify-content:flex-start;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:12px}:host>div>div{width:300px;margin:5px}:host>div>div>label{margin:0 10px}";
...
ZInput.style = stylesCss$f;

const stylesCss$e = ":host>label{display:block;color:var(--text-grey-800);font-family:var(--dashboard-font);font-weight:var(--font-sb);font-size:12px;line-height:16px;text-transform:uppercase;text-align:left;margin:var(--space-unit) 0}:host>label.disabled{color:var(--text-grey-700)}";
...
ZInputMessage.style = stylesCss$d;
...
ZLink.style = stylesCss$c;

const stylesCss$b = "ul{margin:0;padding:0}";
...
ZListItem.style = stylesCss$a;

const stylesCss$9 = ":host{font-family:var(--dashboard-font);font-weight:var(--font-rg)}:host>div{display:flex;flex-direction:row;justify-content:flex-start}polygon{fill:var(--myz-red)}path{fill:var(--bg-white)}";
...
ZMenuDropdown.style = stylesCss$8;
...
ZPaginationPage.style = stylesCss$6;
