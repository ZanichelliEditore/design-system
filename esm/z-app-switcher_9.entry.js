...
import { T as ThemeVariant, a as DividerOrientation, b as DividerSize, L as LabelPositions, I as InputTypeEnum, Z as ZDatePickerMode, c as ZDatePickerPosition } from './index-c1ce8cab.js';
import { m as mobileBreakpoint } from './breakpoints-c386984e.js';
import { i as icons } from './icons-92a7dcde.js';
import { r as randomId, b as boolean } from './utils-99c70c57.js';
import { f as flatpickr, i as it, s as setAriaOptions, a as setFlatpickrPosition } from './utils-ae424976.js';
...
const ZRangePicker = class {
  ...
  render() {
    ...
    return (h("div", { class: {
      ...
      } }, h("div", { class: `${this.rangePickerId}-container` }, h("input", { class: "hidden-input", "data-input": true }), h("z-input", Object.assign({}, zInputProps, { class: `start-input ${this.rangePickerId}`, ariaLabel: this.firstAriaLabel, label: this.firstLabel, "data-toggle": true }))), h("div", { class: `${this.rangePickerId}-container-2` }, h("input", { class: "hidden-input", "data-input": true }), h("z-input", Object.assign({}, zInputProps, { class: `end-input ${this.rangePickerId}-2`, ariaLabel: this.secondAriaLabel, label: this.secondLabel, "data-toggle": true })))));
  }
