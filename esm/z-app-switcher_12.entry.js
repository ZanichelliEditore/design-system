...
const ZButton = class {
  ...
  render() {
    ...
    return (h("button", Object.assign({ name: this.name, type: this.type, disabled: this.disabled }, this.getAttributes()), this.icon && h("z-icon", { name: this.icon, width: 16, height: 16 }), h("slot", null)));
  }
...
export { ZAppSwitcher as z_app_switcher, ZAppTopbar as z_app_topbar, ZButton as z_button, ZButtonDeprecated as z_button_deprecated, ZCard as z_card, ZCarousel as z_carousel, ZDivider as z_divider, ZGhostLoading as z_ghost_loading, ZIcon as z_icon, ZLink as z_link, ZLogo as z_logo, ZOffcanvas as z_offcanvas };
