...
var stylesCss$5 = ":host{height:340px;width:auto}:host>div{height:340px;width:auto;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;position:relative}";
/**
...
var stylesCss$6 = "img{display:block;max-height:340px;margin:auto auto}img.faded{opacity:0.3}";
...
var stylesCss$f = ":host{line-height:0;vertical-align:middle}";
...
var stylesCss$g = ":host>div{display:-ms-flexbox;display:flex;-ms-flex-flow:row wrap;flex-flow:row wrap;-ms-flex-pack:start;justify-content:flex-start;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:12px}:host>div>div{width:300px;margin:5px}:host>div>div>label{margin:0 10px}";
...
var stylesCss$j = ":host>label{display:block;color:var(--text-grey-800);font-family:var(--dashboard-font);font-weight:var(--font-sb);font-size:12px;line-height:16px;text-transform:uppercase;text-align:left;margin:var(--basex1) 0}:host>label.disabled{color:var(--text-grey-700)}";
...
ZLink.style = stylesCss$l;
var stylesCss$m = "ul{margin:0;padding:0}";
...
ZListItem.style = stylesCss$n;
var stylesCss$o = ":host{font-family:var(--dashboard-font);font-weight:var(--font-rg)}:host>div{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start}polygon{fill:var(--myz-red)}path{fill:var(--bg-white)}";
...
ZMenuDropdown.style = stylesCss$p;
...
ZPaginationBar.style = stylesCss$q;
...
ZPanelElem.style = stylesCss$s;
var stylesCss$t = ":host{-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;width:100%;max-width:100%;margin:0;padding:0;font-family:var(--dashboard-font);font-weight:var(--font-rg);list-style:none}@media only screen and (min-width: 768px){:host{padding:0 var(--basex2)}}";
/**
 * @slot - z-stepper-item
 */
