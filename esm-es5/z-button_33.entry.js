...
var ZButtonFilter = /** @class */ (function () {
    ...
    ZButtonFilter.prototype.renderFixedPillow = function (filtername) {
        return (h("button", { class: "container" }, this.hasicon && h("z-icon", { class: "close-icon-container", name: "close", height: 12, width: 12 }), h("span", { class: "text-container" }, filtername)));
    };
    ZButtonFilter.prototype.renderDynamicPillow = function (filtername) {
        return (h("button", { class: "container isactive" }, this.hasicon && h("z-icon", { class: "close-icon-container", name: "close", height: 12, width: 12, onClick: this.handleRemovingFilterClick }), h("span", { class: "text-container" }, filtername)));
    };
...
var ZButtonSort = /** @class */ (function () {
    ...
    ZButtonSort.prototype.render = function () {
        var _this = this;
        return (h("button", { id: this.buttonid, class: this.isselected && "selected", onClick: function () { return _this.emitButtonSortClick(); } }, h("label", null, this.sortasc ? this.label : this.desclabel, this.counter && " (" + this.counter + ")"), h("span", null, this.sortasc ? this.sortlabelasc : this.sortlabeldesc), h("z-icon", { name: "drop-up-down", width: 16, height: 16 })));
    };
    return ZButtonSort;
}());
...
var ZCombobox = /** @class */ (function () {
    ...
    ZCombobox.prototype.renderHeader = function () {
        ...
        return (h("div", { class: "header", onClick: function () { return _this.closeComboBox(); }, onKeyDown: function (ev) {
                if (ev.keyCode === keybordKeyCodeEnum.SPACE)
                    ev.preventDefault();
            }, onKeyUp: function (ev) { return handleKeyboardSubmit(ev, _this.closeComboBox); }, role: "button", tabindex: 0 }, h("h2", null, this.label, h("span", null, this.selectedCounter > 0 && " (" + this.selectedCounter + ")")), h("z-icon", { name: "drop-down", width: 18, height: 18 })));
    };
    ...
    ZCombobox.prototype.renderNoSearchResults = function () {
        return (h("ul", null, h("z-list-item", { id: "no-results", text: this.noresultslabel, listitemid: "no-results", icon: "circle-cross-stroke" })));
    };
...
var ZFooter = /** @class */ (function () {
    ...
    ZFooter.prototype.renderFooterSection = function (id, group) {
        var _this = this;
        return (h("nav", null, h("div", { class: "header" }, h("h2", null, group.title), this.isMobile && (h("z-icon", { name: this.isOpen[id] ? "chevron-up" : "chevron-down", width: 16, height: 16, onClick: function () { return _this.handleOnHeaderClick(id); } }))), h("div", { class: "content" }, h("ul", { class: this.isOpen[id] ? "show" : "" }, group.items.map(function (item) { return (h("li", null, h("a", { href: item.link, target: item.target ? item.target : "_blank" }, item.label))); })))));
    };
...
var ZHeader = /** @class */ (function () {
    ...
    ZHeader.prototype.renderTopHeader = function () {
        if (!this.ismyz)
            return;
        return (h("div", { class: "top-header" }, h("div", { class: "editors" }, h("slot", { name: "editors" }))));
    };
    ...
    ZHeader.prototype.renderMobileLoginDiv = function (userData) {
        var _this = this;
        return (h("div", { id: "mobile-login", class: "mobile-login" }, h("span", null, h("a", { class: "menu-item", id: "user-data", onClick: function () { return _this.handleToggleMobileMenuItem("user-data"); }, role: "button" }, h("span", null, h("z-icon", { name: "user", height: 16, width: 16 }), userData.name), h("i", null)), this.renderUserData(userData))));
673 10.4040072,1.404 8.964,1.404 C7.5239928,1.404 6.23100573,1.73099673 5.085,2.385 C3.93899427,3.03900327 3.04500321,3.94199424 2.403,5.094 C1.76099679,6.24600576 1.44,7.54799274 1.44,9 Z M3.924,8.964 C3.924,7.90799472 4.13099793,7.00200378 4.545,6.246 C4.95900207,5.48999622 5.54699619,4.91400198 6.309,4.518 C7.07100381,4.12199802 7.95599496,3.924 8.964,3.924 C9.97200504,3.924 10.8629961,4.12199802 11.637,4.518 C12.4110039,4.91400198 13.0109979,5.48999622 13.437,6.246 C13.8630021,7.00200378 14.076,7.90799472 14.076,8.964 C14.076,10.6560085 13.6200046,11.9309957 12.708,12.789 C11.7959954,13.6470043 10.5480079,14.076 8.964,14.076 C7.37999208,14.076 6.14400444,13.6500043 5.256,12.798 C4.36799556,11.9459957 3.924,10.6680085 3.924,8.964 Z",
};
...
var ZInfoBox = /** @class */ (function () {
    ...
    ZInfoBox.prototype.render = function () {
        var _this = this;
        return (h("div", { id: this.boxid }, h("slot", { name: "content" }), this.isclosable && h("z-icon", { name: "close", "data-action": "infoBoxClose", onClick: function () { return _this.emitInfoBoxClose(); } })));
    };
    return ZInfoBox;
}());
...
var ZInput = /** @class */ (function () {
    ...
    ZInput.prototype.renderResetIcon = function () {
        ...
        if (!this.value || this.disabled || this.readonly)
            return;
        return (h("z-icon", { name: "close", onClick: function (e) { return _this.emitInputChange("", e.keyCode); } }));
    };
    ...
    ZInput.prototype.renderCheckbox = function () {
        var _this = this;
        return (h("div", { class: "checkboxWrapper" }, h("input", { id: this.htmlid, type: "checkbox", name: this.name, checked: this.checked, value: this.value, disabled: this.disabled, readonly: this.readonly, required: this.required, onChange: function () { return _this.handleCheckboxChange(); } }), h("label", { htmlFor: this.htmlid, class: "checkboxLabel " + (this.labelafter ? "after" : "before") }, h("z-icon", { name: this.checked ? "checkbox-selected" : "checkbox-unchecked", "aria-hidden": true }), this.label && h("span", { innerHTML: this.label }))));
    };
    /* END checkbox */
    /* START radio */
    ...
    ZInput.prototype.renderSelectedItem = function () {
        return (h("li", { class: "selected" }, this.selectedItem ? (h("span", null, this.selectedItem.name)) : (h("span", { class: "placeholder" }, this.placeholder)), h("z-icon", { name: "drop-down" })));
    };
...
var ZMenuDropdown = /** @class */ (function () {
    ...
    ZMenuDropdown.prototype.renderButtonMenu = function () {
        return (h("span", { class: "arrow" }, h("z-icon", { name: "drop-down", width: 14, height: 14 })));
    };
    ...
    ZMenuDropdown.prototype.render = function () {
        ...
        return (h("a", { class: this.retriveMenuClass(), role: "button", tabindex: "0", onFocus: function () {
            ...
            }, onKeyUp: function (e) { return handleKeyboardSubmit(e, _this.handleToggle); } }, h("div", { class: "container", onClick: function () { return _this.handleToggle(); } }, h("z-icon", { name: "user", width: 14, height: 14 }), h("span", { class: "user" }, this.nomeutente), this.renderButtonMenu()), this.renderMenuOpen()));
    };
