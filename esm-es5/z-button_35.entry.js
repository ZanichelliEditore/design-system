...
import { r as registerInstance, h, g as getElement, c as createEvent } from './index-fd6d5448.js';
...
var ZCardFooter = /** @class */ (function () {
    ...
    ZCardFooter.prototype.render = function () {
        return (h("div", { class: this.faded && "faded" }, h("footer", { class: this.retrieveClass() }, h("span", { class: "toggle" }, h("slot", { name: "toggle" })), h("h2", null, this.titolo), h("div", null, h("p", { class: "authors" }, this.autorilabel, ": ", h("b", null, this.autori)), h("p", { class: "year_isbn" }, h("span", { class: "isbn" }, "ISBN (ed. cartacea): ", h("b", null, this.isbn)))), this.isOpen && h("slot", { name: "list" }))));
    };
    return ZCardFooter;
}());
...
var ZCardHeader = /** @class */ (function () {
    ...
    ZCardHeader.prototype.render = function () {
        return (h("header", { class: this.retrieveClass() }, h("h2", null, this.titolo), h("slot", { name: "icon" })));
    };
    return ZCardHeader;
}());
...
var stylesCss$g = ":host{line-height:0;vertical-align:middle}";
...
ZIcon.style = stylesCss$g;
var stylesCss$h = ":host>div{display:-ms-flexbox;display:flex;-ms-flex-flow:row wrap;flex-flow:row wrap;-ms-flex-pack:start;justify-content:flex-start;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:12px}:host>div>div{width:300px;margin:5px}:host>div>div>label{margin:0 10px}";
...
var ZInput = /** @class */ (function () {
    ...
    ZInput.prototype.inputCheckListener = function (e) {
        var data = e.detail;
        switch (this.type) {
    ...
    /** get the input value */
    ZInput.prototype.getValue = function () {
    ...
    /** set the input value */
    ZInput.prototype.setValue = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    /** get checked status */
    ZInput.prototype.isChecked = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (this.type) {
    ...
    ZInput.prototype.emitInputChange = function (value, keycode) {
        var _this = this;
        if (!this.isTyping) {
    ...
    ZInput.prototype.emitStartTyping = function () {
        this.isTyping = true;
        this.startTyping.emit();
    };
    ZInput.prototype.emitStopTyping = function (value, validity) {
        this.isTyping = false;
    ...
    ZInput.prototype.emitInputCheck = function (checked) {
    ...
    ZInput.prototype.getValidity = function (type) {
        var input = this.hostElement.shadowRoot.querySelector(type);
        return input.validity;
    };
    /* START text/password/email/number */
    ZInput.prototype.getTextAttributes = function () {
        var _this = this;
        return {
            id: this.htmlid,
            name: this.name,
    ...
    ZInput.prototype.renderInputText = function (type) {
    ...
    ZInput.prototype.renderResetIcon = function () {
        var _this = this;
    ...
    ZInput.prototype.renderShowHidePassword = function () {
        var _this = this;
    ...
    ZInput.prototype.renderMessage = function () {
        if (!this.hasmessage)
            return;
    ...
    /* END textarea */
    /* START checkbox */
    ZInput.prototype.handleCheckboxChange = function () {
        this.checked = !this.checked;
        this.emitInputCheck(this.checked);
    };
    ZInput.prototype.renderCheckbox = function () {
        var _this = this;
    ...
    /* END checkbox */
    /* START radio */
    ZInput.prototype.handleRadioChange = function () {
        this.checked = true;
        this.emitInputCheck(this.checked);
    };
    ZInput.prototype.renderRadio = function () {
        var _this = this;
    ...
    /* END radio */
    /* START select */
    ZInput.prototype.renderSelect = function () {
        var _this = this;
    ...
    Object.defineProperty(ZInput.prototype, "hostElement", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
...
ZInput.style = stylesCss$j;
var stylesCss$k = ":host>label{display:block;color:var(--text-grey-800);font-family:var(--dashboard-font);font-weight:var(--font-sb);font-size:12px;line-height:16px;text-transform:uppercase;text-align:left;margin:var(--basex1) 0}:host>label.disabled{color:var(--text-grey-700)}";
...
ZInputMessage.style = stylesCss$l;
...
ZLink.style = stylesCss$m;
var stylesCss$n = "ul{margin:0;padding:0}";
...
ZListItem.style = stylesCss$o;
var stylesCss$p = ":host{font-family:var(--dashboard-font);font-weight:var(--font-rg)}:host>div{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start}polygon{fill:var(--myz-red)}path{fill:var(--bg-white)}";
...
ZMenuDropdown.style = stylesCss$q;
...
var ZSelect = /** @class */ (function () {
    ...
    /** get the input value */
    ZSelect.prototype.getValue = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    /** set the input value */
    ZSelect.prototype.setValue = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            var values;
            return __generator(this, function (_a) {
                values = [];
    ...
    ZSelect.prototype.emitOptionSelect = function () {
        this.optionSelect.emit({
            id: this.htmlid,
            selected: this.getSelectedValues()
        });
    };
    ZSelect.prototype.componentWillLoad = function () {
        this.watchItems();
    };
    ZSelect.prototype.componentWillRender = function () {
        this.filterItems(this.searchString);
    };
    ZSelect.prototype.getInitialItemsArray = function () {
        return typeof this.items === "string" ? JSON.parse(this.items) : this.items;
    };
    ZSelect.prototype.mapSelectedItemsToItemsArray = function () {
        var _this = this;
    ...
    ZSelect.prototype.getSelectedValues = function () {
        if (this.multiple) {
    ...
    ZSelect.prototype.filterItems = function (searchString) {
    ...
    ZSelect.prototype.handleInputChange = function (e) {
        this.searchString = e.detail.value;
        if (!this.isOpen)
            this.toggleSelectUl();
    };
    ZSelect.prototype.selectItem = function (item, selected) {
        var _this = this;
    ...
    ZSelect.prototype.arrowsSelectNav = function (e, key) {
    ...
    ZSelect.prototype.focusSelectItem = function (index) {
        var focusElem = this.hostElement.shadowRoot.getElementById(this.htmlid + "_" + index);
        if (focusElem)
            focusElem.focus();
    };
    ZSelect.prototype.toggleSelectUl = function (selfFocusOnClose) {
    ...
    ZSelect.prototype.handleInputClick = function (e) {
    ...
    ZSelect.prototype.handleSelectFocus = function (e) {
        var _this = this;
    ...
    ZSelect.prototype.scrollToLetter = function (letter) {
    ...
    ZSelect.prototype.renderChips = function () {
        var _this = this;
        if (!this.multiple || !this.selectedItems.length)
            return;
    ...
    ZSelect.prototype.renderSelectUl = function () {
    ...
    ZSelect.prototype.renderSelectUlItems = function () {
        var _this = this;
    ...
    ZSelect.prototype.renderNoSearchResults = function () {
        return (h("li", { class: "noResults" }, h("z-icon", { name: "circle-cross-stroke" }), this.noresultslabel));
    };
    ZSelect.prototype.renderMessage = function () {
        if (!this.hasmessage)
            return;
        return h("z-input-message", { message: this.message, status: this.status });
    };
    ZSelect.prototype.render = function () {
    ...
    Object.defineProperty(ZSelect.prototype, "hostElement", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(ZSelect, "watchers", {
        get: function () {
            return {
                "items": ["watchItems"]
            };
...
ZSelect.style = stylesCss$u;
var stylesCss$v = ":host{-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;width:100%;max-width:100%;margin:0;padding:0;font-family:var(--dashboard-font);font-weight:var(--font-rg);list-style:none}@media only screen and (min-width: 768px){:host{padding:0 var(--basex2)}}";
/**
 * @slot - z-stepper-item
 */
