...
var ZButton = /** @class */ (function () {
    ...
    Object.defineProperty(ZButton.prototype, "hostElement", {
...
var stylesCss$1 = "button.container{min-height:32px;line-height:32px;border:var(--border-size-small) solid var(--bg-grey-200);border-radius:16px;box-shadow:0px 2px 5px 0px var(--bg-neutral-300);-webkit-box-shadow:0px 2px 5px 0px var(--bg-neutral-300);-moz-box-shadow:0px 2px 5px 0px var(--bg-neutral-300);text-align:center;padding:0 var(--basex2);cursor:pointer;letter-spacing:0.17px;font-family:var(--dashboard-font);font-size:12px;font-weight:var(--font-sb);opacity:1;-webkit-transition:all 200ms linear;transition:all 200ms linear}button.container.small{min-height:24px;line-height:24px}button.container:focus{outline:0}button.container::-moz-focus-inner{border:0}.text-container{margin-left:4px}button.container,button.container:focus,button.container:hover{background-color:var(--bg-white);color:var(--text-grey-700);fill:var(--text-grey-700)}button.container.isactive{background-color:var(--bg-white);color:var(--myz-blue);fill:var(--myz-blue)}button.container.isactive:hover{color:var(--myz-blue-dark);fill:var(--myz-blue-dark)}button.container.isactive:focus{background-color:var(--myz-blue-dark);border-color:var(--myz-blue-dark);-webkit-box-shadow:0px 0px 4px 0px var(--text-grey-800);box-shadow:0px 0px 4px 0px var(--text-grey-800);color:var(--bg-white);fill:var(--bg-white)}";
var ZButtonFilter = /** @class */ (function () {
    function ZButtonFilter(hostRef) {
        registerInstance(this, hostRef);
...
var ZButtonSort = /** @class */ (function () {
    ...
    ZButtonSort.prototype.emitButtonSortClick = function () {
        if (!this.isselected) {
    ...
    ZButtonSort.prototype.render = function () {
        var _this = this;
        return (h("button", { id: this.buttonid, class: this.isselected && "selected", onClick: function () { return _this.emitButtonSortClick(); } }, h("label", null, this.sortasc ? this.label : this.desclabel, this.counter && " (" + this.counter + ")"), h("span", null, this.sortasc ? this.sortlabelasc : this.sortlabeldesc), h("z-icon", { name: "caret-up-down", width: 16, height: 16 })));
    };
    return ZButtonSort;
}());
ZButtonSort.style = stylesCss$2;
var stylesCss$3 = ":host{font-family:var(--dashboard-font);font-weight:var(--font-rg);display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:nowrap;flex-wrap:nowrap;-ms-flex-pack:center;justify-content:center;-ms-flex-line-pack:center;align-content:center}:host>div{position:fixed;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-pack:center;justify-content:center;top:30vh;max-width:297px;height:-webkit-fit-content;height:-moz-fit-content;height:fit-content;min-height:232px;z-index:1000;margin:auto;overflow:auto;overflow:-moz-scrollbars-none;-ms-overflow-style:none;background:var(--myz-blue-lighter);border-radius:var(--half-x1);-webkit-box-shadow:0px -2px 4px 0px rgba(66, 69, 72, 0.4);box-shadow:0px -2px 4px 0px rgba(66, 69, 72, 0.4)}@media only screen and (min-width: 768px){:host>div{position:initial;-ms-flex-wrap:nowrap;flex-wrap:nowrap;-ms-flex-pack:justify;justify-content:space-between;-ms-flex-align:center;align-items:center;-ms-flex-line-pack:stretch;align-content:stretch;position:fixed;top:auto;bottom:0;margin:0 auto;left:0;right:0;height:auto;min-height:138px;max-width:100%;border-radius:0px}}@media only screen and (min-width: 1152px){:host>div{min-height:122px}}";
var ZCandybar = /** @class */ (function () {
    function ZCandybar(hostRef) {
        registerInstance(this, hostRef);
    }
    ZCandybar.prototype.render = function () {
        return (h("div", null, h("slot", { name: "content" })));
    };
    return ZCandybar;
}());
ZCandybar.style = stylesCss$3;
var stylesCss$4 = "div{background-color:var(--bg-white);display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;overflow:hidden;width:auto;-webkit-box-sizing:border-box;box-sizing:border-box;width:256px;height:522px;border:var(--border-base) solid var(--bg-grey-200);border-radius:var(--radius-base)}div.real,div.trial{border-color:var(--accent)}div.faded{border:none}div.highlighted{-webkit-box-shadow:var(--shadow-4);box-shadow:var(--shadow-4);outline:none}div.pressed{-webkit-box-shadow:var(--shadow-8);box-shadow:var(--shadow-8);outline:none}div:focus{-webkit-box-shadow:0px 0px 2px 2px var(--accent-dark);box-shadow:0px 0px 2px 2px var(--accent-dark);outline:none}";
var ZCardComponent = /** @class */ (function () {
    function ZCardComponent(hostRef) {
        registerInstance(this, hostRef);
        /** pressed status */
    ...
    ZCardComponent.prototype.retrieveClass = function () {
        var elemClasses = "";
...
var ZCardAlert = /** @class */ (function () {
    ...
    ZCardAlert.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "relativeContainer " + this.retrieveClass() }, h("z-icon", { name: this.iconname, width: 18, height: 18, class: this.retrieveClass() }), h("span", { class: "contentText" }, this.contenttext), this.actiontext && !!this.actiontext.trim().length && (h("span", { role: "button", tabindex: "0", class: "contentAction", onClick: function (e) {
                _this.handleActionButtonClick(e);
            }, onKeyPress: function (e) {
                _this.handleSpaceKeyPress(e);
            } }, this.actiontext))));
    };
    return ZCardAlert;
}());
ZCardAlert.style = stylesCss$5;
var stylesCss$6 = ":host{height:340px;width:auto}:host>div{height:340px;width:auto;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;position:relative}";
var ZCardBody = /** @class */ (function () {
    function ZCardBody(hostRef) {
        registerInstance(this, hostRef);
    }
    ZCardBody.prototype.render = function () {
        return (h("div", null, h("slot", { name: "alert" }), h("slot", { name: "cover" })));
    };
    return ZCardBody;
}());
ZCardBody.style = stylesCss$6;
var stylesCss$7 = "img{display:block;max-height:340px;margin:auto auto}img.faded{opacity:0.3}";
var ZCardCover = /** @class */ (function () {
    function ZCardCover(hostRef) {
        registerInstance(this, hostRef);
    }
    ZCardCover.prototype.hadleOnImageError = function () {
        this.img = this.defaultimg;
    };
    ZCardCover.prototype.render = function () {
        return (h("img", { class: this.faded && "faded", onError: this.hadleOnImageError.bind(this), alt: this.titolo, src: this.img }));
    };
    return ZCardCover;
}());
ZCardCover.style = stylesCss$7;
var stylesCss$8 = "footer{font-family:var(--dashboard-font);font-weight:var(--font-rg);color:var(--text-grey-800);background-color:var(--bg-white);margin:0px;padding:0px;position:relative;z-index:5;height:48px;width:auto;top:0px;-webkit-transition:height 500ms ease-in-out, top 500ms ease-in-out;transition:height 500ms ease-in-out, top 500ms ease-in-out;border-radius:0px 0px var(--radius-base) var(--radius-base);border-top:var(--border-base) solid var(--bg-grey-200)}footer.real,footer.trial{border-top:var(--border-base) solid var(--accent)}footer .bold{font-family:var(--dashboard-font);font-weight:var(--font-sb)}footer>h2{font-family:var(--dashboard-font);font-weight:var(--font-rg);font-size:16px;line-height:22px;height:40px;margin:0px;padding:var(--basex2) var(--basex2) var(--basex1) var(--basex2);overflow:hidden;background-color:var(--bg-white);-webkit-transition:all 200ms linear;transition:all 200ms linear}footer.isopen>h2{font-size:14px;font-weight:var(--font-sb);-webkit-transition:all 200ms linear;transition:all 200ms linear;background-color:var(--bg-neutral-200)}footer.isopen.real>h2,footer.isopen.trial>h2{background-color:var(--accent)}footer>div:not(.slot-handler){padding:var(--basex1) var(--basex2);height:40px;overflow:hidden}footer .visible{display:block}footer .hidden{display:none}footer>div>p{font-size:14px;height:20px;line-height:20px;margin:0px;padding:0px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}footer>div>p.year_isbn{padding-top:var(--basex1);display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:justify;justify-content:space-between}footer>div>p.year_isbn>span.isbn{text-overflow:ellipsis;overflow:hidden}footer.isopen>div:not(.slot-handler){height:68px}footer.isopen>div>p.authors{height:40px;white-space:initial;text-overflow:initial}footer.isopen{height:300px;top:-200px;-webkit-transition:height 500ms ease-in-out, top 500ms ease-in-out;transition:height 500ms ease-in-out, top 500ms ease-in-out}.toggle{position:absolute;top:-24px;left:16px;z-index:10}.faded{opacity:0.3;pointer-events:none}";
var ZCardFooter = /** @class */ (function () {
    function ZCardFooter(hostRef) {
        registerInstance(this, hostRef);
        this.isOpen = false;
        this.allowTooltipAuthors = false;
    }
    ZCardFooter.prototype.handleToggle = function () {
        this.isOpen = !this.isOpen;
    };
    ZCardFooter.prototype.getTitleAuthors = function () {
        return this.allowTooltipAuthors ? this.autori : "";
    };
    ZCardFooter.prototype.elementsEllipsis = function () {
        this.allowTooltipAuthors = this.elementAuthorsHasEllipsis() ? true : false;
    };
    ZCardFooter.prototype.elementAuthorsHasEllipsis = function () {
        return this.ellipsisAuthors.offsetWidth < this.ellipsisAuthors.scrollWidth;
    };
    ZCardFooter.prototype.retrieveClass = function () {
        return {
            isopen: this.isOpen,
...
var ZCombobox = /** @class */ (function () {
    ...
    ZCombobox.prototype.watchItems = function () {
        this.itemsList =
            typeof this.items === "string" ? JSON.parse(this.items) : this.items;
        this.selectedCounter = this.itemsList.filter(function (item) { return item.checked; }).length;
        if (this.searchValue) {
    ...
    ZCombobox.prototype.inputCheckListener = function (e) {
        var id = e.detail.id.replace("combo-checkbox-" + this.inputid + "-", "");
        if (id === "check-all" &&
            (!this.maxcheckableitems ||
                this.maxcheckableitems >= this.itemsList.length)) {
            return this.checkAll(e.detail.checked);
        }
        this.itemsList = this.itemsList.map(function (item) {
            if (item.id === id)
    ...
    ZCombobox.prototype.emitComboboxChange = function () {
        this.comboboxChange.emit({ id: this.inputid, items: this.itemsList });
    };
    ZCombobox.prototype.componentWillLoad = function () {
        this.watchItems();
    };
    ZCombobox.prototype.componentWillRender = function () {
        this.selectedCounter = this.itemsList.filter(function (item) { return item.checked; }).length;
        if (this.searchValue) {
            this.filterItems(this.searchValue);
        }
    };
    ZCombobox.prototype.resetRenderItemsList = function () {
        var renderItemsList = [];
    ...
    ZCombobox.prototype.filterItems = function (value) {
        if (!value)
            return this.closeFilterItems();
        this.searchValue = value;
        this.resetRenderItemsList();
        this.renderItemsList = this.renderItemsList.filter(function (item) {
            var start = item.name.toUpperCase().indexOf(value.toUpperCase());
            var end = start + value.length;
            var newName = item.name.substring(0, start) +
    ...
    ZCombobox.prototype.checkAll = function (checked) {
        if (checked === void 0) { checked = true; }
        this.itemsList = this.itemsList.map(function (item) { return (Object.assign(Object.assign({}, item), { checked: checked })); });
        this.resetRenderItemsList();
        this.emitComboboxChange();
    };
    ZCombobox.prototype.closeFilterItems = function () {
        this.searchValue = "";
        this.resetRenderItemsList();
    };
    ZCombobox.prototype.closeComboBox = function () {
        this.isopen = !this.isopen;
    };
    ZCombobox.prototype.renderHeader = function () {
        var _this = this;
        return (h("div", { class: "header", onClick: function () { return _this.closeComboBox(); }, onKeyDown: function (ev) {
                if (ev.keyCode === keybordKeyCodeEnum.SPACE)
                    ev.preventDefault();
            }, onKeyUp: function (ev) { return handleKeyboardSubmit(ev, _this.closeComboBox); }, role: "button", tabindex: 0 }, h("h2", null, this.label, h("span", null, this.selectedCounter > 0 && " (" + this.selectedCounter + ")")), h("z-icon", { name: "caret-down", width: 18, height: 18 })));
    };
    ZCombobox.prototype.renderContent = function () {
        if (!this.isopen)
            return;
    ...
    ZCombobox.prototype.renderItems = function () {
        if (!this.isopen)
            return;
    ...
    ZCombobox.prototype.renderList = function (items) {
        var _this = this;
        if (!items)
            return;
        if (!items.length && this.searchValue)
            return this.renderNoSearchResults();
        return (h("ul", null, items.map(function (item, i) {
            return (h("z-list-item", { id: item.id, listitemid: item.id, action: "combo-li-" + _this.inputid, underlined: i === items.length - 1 ? false : true }, h("z-input", { type: InputTypeEnum.checkbox, checked: item.checked, htmlid: "combo-checkbox-" + _this.inputid + "-" + item.id, label: item.name, disabled: !item.checked &&
                    _this.maxcheckableitems &&
                    _this.maxcheckableitems === _this.selectedCounter })));
        })));
    };
    ZCombobox.prototype.renderNoSearchResults = function () {
        return (h("ul", null, h("z-list-item", { id: "no-results", text: this.noresultslabel, listitemid: "no-results", icon: "multiply-circle" })));
    };
    ZCombobox.prototype.renderCloseButton = function () {
        var _this = this;
        return (h("div", null, h("a", { onClick: function () { return _this.closeFilterItems(); }, onKeyUp: function (e) { return handleKeyboardSubmit(e, _this.closeFilterItems); }, role: "button", tabindex: 0 }, this.closesearchtext)));
    };
    ZCombobox.prototype.renderSearchInput = function () {
        var _this = this;
        if (!this.isopen)
            return;
        return (h("z-input", { htmlid: this.inputid + "_search", label: this.searchlabel, placeholder: this.searchplaceholder, htmltitle: this.searchtitle, type: this.inputType, value: this.searchValue, hasmessage: false, onInputChange: function (e) {
                if (e.detail.keycode === 27)
                    return _this.closeFilterItems();
                _this.filterItems(e.detail.value);
            } }));
    };
    ZCombobox.prototype.renderCheckAll = function () {
        if (this.searchValue)
            return;
        var allChecked = this.selectedCounter === this.itemsList.length;
    ...
    ZCombobox.prototype.render = function () {
    ...
    Object.defineProperty(ZCombobox, "watchers", {
        get: function () {
            return {
                "items": ["watchItems"]
            };
...
ZCombobox.style = stylesCss$d;
var stylesCss$e = ":host{font-family:var(--dashboard-font);font-weight:var(--font-rg)}z-candybar.hidden{display:none}.content{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-wrap:nowrap;flex-wrap:nowrap;-ms-flex-pack:justify;justify-content:space-between;-ms-flex-align:stretch;align-items:stretch;-ms-flex-line-pack:justify;align-content:space-between;color:var(--text-grey-800);border-radius:var(--half-x1);font-size:16px;letter-spacing:0px;line-height:24px;padding:var(--basex3) var(--basex2)}.content>div>h2{margin:0;padding:0;color:var(--text-grey-800);border-radius:0px;font-size:18px;font-weight:var(--font-sb);letter-spacing:0px}.content>div>div{padding:var(--basex3) 0;font-size:14px;letter-spacing:0.16px;line-height:20px}.content>div>div>p{margin:0}.content>div>div>p>a{cursor:pointer;font-weight:var(--font-sb);color:var(--text-grey-800);text-decoration:underline;height:14px;display:-ms-inline-flexbox;display:inline-flex}.content>div>div>p>a:visited{color:var(--text-grey-800);cursor:pointer;z-index:1000}.content>z-button{margin:0;width:100%}@media only screen and (min-width: 768px){.content{width:100%;-ms-flex-direction:row;flex-direction:row;-ms-flex-align:center;align-items:center;font-size:16px;letter-spacing:0px;line-height:24px;padding:var(--basex4) var(--basex3)}.content>div{width:560px}.content>div>h2{height:var(--half-x7)}.content>div>div{padding:0}.content>z-button{margin:0;width:initial}}@media only screen and (min-width: 1152px){.content>div{width:935px}}@media only screen and (min-width: 1366px){.content{padding-left:var(--basex4);padding-right:var(--basex4)}}";
var ZCookiebar = /** @class */ (function () {
    function ZCookiebar(hostRef) {
        registerInstance(this, hostRef);
        this.accept = createEvent(this, "accept", 7);
    }
    ZCookiebar.prototype.emitAccept = function (ev) {
        this.accept.emit({ ev: ev });
    };
    ZCookiebar.prototype.handleOkButtonClick = function (ev) {
        this.emitAccept(ev);
        if (typeof this.callback === "function") {
            this.callback();
        }
    };
    ZCookiebar.prototype.handleOkButtonKeyUp = function (ev) {
        this.emitAccept(ev);
        if (ev.code === "Enter") {
    ...
    ZCookiebar.prototype.renderContentSlot = function () {
        var _this = this;
        return (h("div", { class: "content", slot: "content" }, h("div", null, h("h2", null, "Su questo sito usiamo i cookie."), h("div", null, h("p", null, "Se continui a navigare ci permetti di farlo secondo le regole spiegate nella nostra informativa sulla privacy relativa ai \u00A0", h("a", { href: this.cookiepolicyurl, target: "_blank" }, "cookie"), "."))), h("z-button", { variant: ButtonVariantEnum.primary, onClick: function (ev) { return _this.handleOkButtonClick(ev); }, onKeyUp: function (ev) { return _this.handleOkButtonKeyUp(ev); } }, "ACCETTA")));
    };
    ZCookiebar.prototype.render = function () {
        return h("z-candybar", { class: "" + (this.hide ? "hidden" : "") }, this.renderContentSlot());
    };
    return ZCookiebar;
}());
ZCookiebar.style = stylesCss$e;
var mobileBreakpoint = 767;
var stylesCss$f = ":host{width:100%}footer{width:auto;height:auto;-webkit-box-sizing:border-box;box-sizing:border-box;font-family:var(--dashboard-font);font-size:13px;padding:var(--basex1) 0 var(--basex1) 0;background-color:var(--bg-grey-900);color:var(--text-grey-050)}footer *{-webkit-box-sizing:border-box;box-sizing:border-box}footer>section{display:grid}footer>section.top>nav{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;justify-items:flex-start;overflow:hidden;margin:var(--half-x1) 0 var(--half-x1) 0;padding:0;border-bottom:none}footer>section.top>nav>.header{position:relative;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-pack:start;justify-content:flex-start;-ms-flex-align:stretch;align-items:stretch;-ms-flex-line-pack:start;align-content:flex-start;margin-left:var(--basex4);margin-right:var(--basex4);padding-bottom:var(--basex1);height:var(--basex4);border-bottom:1px solid var(--bg-grey-050);line-height:1}footer>section.top>nav>.header>h2{font-size:var(--basex2);margin:var(--basex1) 0 var(--basex1) 0}footer>section.top>nav>.header{fill:var(--text-white)}footer>section.top>nav>.header>button{position:absolute;top:var(--basex1);right:0;margin:0;padding:0;background:transparent;border:0;-webkit-appearance:none;-moz-appearance:none;appearance:none;cursor:pointer}footer>section.top>nav>.header>z-icon{display:block}footer>section.top>nav>.content{padding-left:var(--basex4);padding-right:var(--basex4);background-color:var(--text-grey-800);background-color:var(--text-grey-800)}footer>section.top>nav>.content>ul{display:none;height:0;-webkit-transition:0.3s ease;transition:0.3s ease;padding:var(--half-x1) 0 var(--basex2) 0}footer>section.top>nav>.content>ul>li{width:100%;margin:0;padding:var(--basex1) 0 var(--basex1) 0;border-bottom:1px solid var(--bg-grey-050)}footer>section.top>nav>.content>ul.show{display:block;height:auto;-webkit-transition:0.3s ease;transition:0.3s ease}footer>section.top>nav>.content>ul>li{list-style:none}footer>section.top>nav>.content>ul>li>a{font-size:14px;font-weight:300;color:var(--text-grey-050);text-decoration:none;padding:0}footer>section.top>nav>div>ul>li>a{letter-spacing:0.2px;padding:10px 0;text-decoration:underline;font-weight:300;font-size:14px;line-height:2}footer>section.bottom{display:grid;grid-template-columns:1fr;width:auto;height:auto;margin:0;padding:0;white-space:pre-line;font-size:12px}footer>section.bottom>div.item{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-align:start;align-items:flex-start;grid-column:span 1;height:auto;width:auto;padding:var(--basex2) 0;margin:0 var(--basex3)}footer>section.bottom>div.item:nth-child(1){-ms-flex-order:2;order:2}footer>section.bottom>div.item:nth-child(2){-ms-flex-order:1;order:1;border-bottom:1px solid var(--bg-grey-050)}footer>section.bottom>div.item>ul.social{display:-ms-flexbox;display:flex;width:auto;padding:0;margin-bottom:0px}footer>section.bottom>div.item>ul.social>li{list-style:none;margin-right:14px}footer>section.bottom>div.item>ul.social img{width:var(--basex3)}footer>section.bottom>div.bottom-links{display:none}footer>section.bottom>div.item>p{margin:var(--basex1) 0;padding:var(--basex1) 0}footer>section.bottom>div.item>p:first-child{margin-top:0}footer>section.bottom>div.item>p:last-child{margin-bottom:0}footer>section.bottom>div.logo>p>span{display:block}@media only screen and (min-width: 768px){footer{padding:0}footer>section.top{padding:var(--basex2) var(--basex4);background-color:var(--text-grey-800)}footer>section.top>nav{display:grid;grid-template-columns:repeat(4, 1fr);grid-template-rows:1fr;grid-column-gap:var(--grid-tablet-margin);padding:var(--basex2) 0 var(--basex1) 0;border-bottom:1px solid var(--bg-white);margin:0}footer>section.top>nav:last-child{border-bottom:none}footer>section.top>nav>.header{border-bottom:none;padding:0;margin:0}footer>section.top>nav>.header>h2{border:none}footer>section.top>nav>.content{grid-column:span 3;width:100%;padding:0;margin:0}footer>section.top>nav>.content>ul{display:grid;grid-template-columns:repeat(3, 1fr);grid-column-gap:var(--grid-tablet-margin);height:auto;-ms-flex-align:stretch;align-items:stretch;-ms-flex-line-pack:stretch;align-content:stretch;border-bottom:none;margin:0}footer>section.top>nav>.content>ul>li{margin:0;padding:var(--half-x1) 0px;border:none}footer>section.top>nav>.content>ul>li>a{font-size:12px;line-height:1;border-bottom:1px solid var(--bg-white)}footer>section.bottom{grid-template-columns:repeat(4, 1fr);grid-column-gap:var(--grid-tablet-margin);background-color:var(--bg-grey-900);padding:0 var(--basex4)}footer>section.bottom>div.item{margin:0}footer>section.bottom>div.item:nth-child(1){-ms-flex-order:1;order:1}footer>section.bottom>div.item:nth-child(2){-ms-flex-order:2;order:2;border-bottom:none}footer>section.bottom>div.item>p{padding-top:0}footer>section.bottom>div.item>ul.social img{width:var(--basex3);height:var(--basex3);border:none}footer>section.bottom>div.logo>z-logo{width:auto;height:39px}footer>section.bottom>div.bottom-links{display:block;grid-column:span 2;-ms-flex-order:3;order:3}footer>section.bottom>div.bottom-links>ul{display:grid;grid-template-columns:repeat(2, 1fr);grid-column-gap:var(--grid-tablet-margin);height:54px;margin:0;padding:0;font-size:12px}footer>section.bottom>div.bottom-links>ul>li{margin-bottom:var(--basex1);list-style:none}footer>section.bottom>div.bottom-links>ul>li>a{color:var(--text-white)}}@media only screen and (min-width: 1152px){footer>section.top{grid-template-columns:repeat(6, 1fr);grid-column-gap:var(--grid-desktop-margin);width:100%;padding:var(--basex3) var(--basex4)}footer>section.top>nav{display:grid;grid-template-columns:1fr;grid-template-rows:40px 4fr;padding:0;border-bottom:none}footer>section.top>nav>div>h2{width:auto;font-size:16px;line-height:1;font-weight:600;color:var(--text-grey-050);padding:0 0 var(--basex1);margin:0}footer>section.top>nav>.header{position:relative;display:-ms-inline-flexbox;display:inline-flex}footer>section.top>nav>.header::after{content:'';display:block;position:absolute;top:100%;left:0;width:120px;border-bottom:1px solid var(--bg-grey-050)}footer>section.top>nav>.content{grid-column:auto}footer>section.top>nav>.content>ul{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-pack:start;justify-content:flex-start}footer>section.bottom{padding:var(--basex2) var(--basex4)}footer>section.bottom>div.item:nth-child(1)>p:nth-of-type(2){font-size:10px}footer>section.bottom>div.item>p{padding-bottom:0;margin-bottom:var(--basex2)}footer>section.bottom>div.item>ul.social{margin-top:0}footer>section.bottom>div.item>ul.social>li{margin-right:var(--half-x3)}footer>section.bottom>div.item>ul.social img{width:var(--basex2);height:var(--basex2)}footer>section.bottom>div.bottom-links{padding:var(--basex2) 0 0 0}footer>section.bottom>div.bottom-links>ul{grid-template-columns:repeat(3, 1fr);grid-column-gap:var(--grid-desktop-margin);margin:0}footer>section.bottom>div.bottom-links>ul>li{margin-bottom:var(--basex2)}}";
var ZFooter = /** @class */ (function () {
    function ZFooter(hostRef) {
        registerInstance(this, hostRef);
        this.isOpen = [];
    }
    ZFooter.prototype.componentWillLoad = function () {
        this.jsonData = JSON.parse(this.data);
        this.isOpen = Array(this.jsonData.zanichelliLinks.length).fill(false);
    };
    ZFooter.prototype.componentDidLoad = function () {
        window.addEventListener("resize", this.resize.bind(this));
        this.resize();
    };
    ZFooter.prototype.resize = function () {
        this.isMobile = window.innerWidth <= mobileBreakpoint;
    };
    ZFooter.prototype.handleOnHeaderClick = function (id) {
        // stencil non si accorge delle modifiche su isOpen quindi copio l'array prima
        var open = this.isOpen.slice(0);
        open[id] = !open[id];
        this.isOpen = __spreadArrays(open);
    };
    ZFooter.prototype.renderFooterSection = function (id, group) {
        var _this = this;
        return (h("nav", null, h("div", { class: "header" }, h("h2", null, group.title), this.isMobile && (h("button", { onClick: function () { return _this.handleOnHeaderClick(id); } }, h("z-icon", { name: this.isOpen[id] ? "chevron-up" : "chevron-down", width: 16, height: 16 })))), h("div", { class: "content" }, h("ul", { class: this.isOpen[id] ? "show" : "" }, group.items.map(function (item) { return (h("li", null, h("a", { href: item.link, target: item.target ? item.target : "_blank" }, item.label))); })))));
    };
    ZFooter.prototype.renderFooterTop = function () {
        var _this = this;
        var zanichelliLinks = this.jsonData.zanichelliLinks;
        var bottomLinks = this.jsonData.bottomLinks;
        var zanichelliLinksToRender = zanichelliLinks.slice();
        if (this.isMobile) {
        ...
        return (h("section", { class: "top" }, zanichelliLinksToRender.map(function (item, id) { return _this.renderFooterSection(id, item); })));
    };
    ZFooter.prototype.renderZLogo = function () {
        var myzLink = this.jsonData.myzLink;
        return (h("z-logo", { link: myzLink.link, width: 144, height: 38, imagealt: myzLink.label, targetblank: true }));
    };
    ZFooter.prototype.renderAddress = function () {
        var zanichelliAddress = this.jsonData.zanichelliAddress;
        return h("p", null, zanichelliAddress);
    };
    ZFooter.prototype.renderSocial = function () {
        var social = this.jsonData.social;
        return (h("ul", { class: "social" }, social.map(function (item) { return (h("li", null, h("a", { href: item.link, target: "_blank" }, h("img", { src: item.icon, alt: item.description })))); })));
    };
    ZFooter.prototype.renderCopyright = function () {
        if (!!this.copyrightuser) {
            return (h("p", null, "Copyright \u2013 2018-", new Date().getFullYear(), " ", this.copyrightuser, h("span", null, " All rights reserved ")));
        }
        else
            return;
    };
    ZFooter.prototype.renderCertification = function () {
        var certification = this.jsonData.certification;
        return h("p", null, certification);
    };
    ZFooter.prototype.renderBottomLinks = function () {
        var bottomLinks = this.jsonData.bottomLinks;
        if (!this.isMobile) {
            return (h("div", { class: "item bottom-links" }, h("ul", null, bottomLinks.map(function (item) { return (h("li", null, h("a", { href: item.link, target: item.target ? item.target : "_blank" }, item.label))); }))));
        }
    };
    ZFooter.prototype.renderFooterBottom = function () {
    ...
    ZFooter.prototype.render = function () {
        if (this.jsonData) {
...
var ZHeader = /** @class */ (function () {
    ...
    ZHeader.prototype.activeIntLinkChange = function (newValue) {
        this.activeMenuItem = this.currentMenuItem = this.intMenuData.find(function (item) { return item.id === newValue; });
    };
    ZHeader.prototype.handleResize = function () {
        this.isMobile = window.innerWidth <= mobileBreakpoint;
    };
    ZHeader.prototype.handleZListItemLinkClick = function () {
        this.isMenuMobileOpen = false;
    };
    ZHeader.prototype.handleZListItemClick = function () {
        this.isMenuMobileOpen = false;
    };
    ZHeader.prototype.componentWillLoad = function () {
        var _this = this;
        if (this.intlinkdata) {
            this.intMenuData =
        ...
        this.activeMenuItem = this.currentMenuItem = this.intMenuData.find(function (item) { return item.id === _this.activeintlinkid; });
        if (this.extlinkdata) {
            this.extMenuData =
    ...
    ZHeader.prototype.renderLogoDiv = function () {
        return (h("div", { class: "logo" }, h("z-logo", { link: this.logolink ? this.logolink : null, targetblank: true, width: 144, height: 36, imagealt: this.imagealt })));
    };
    ZHeader.prototype.renderIntMenu = function (menuItems) {
        var _this = this;
        if (!this.isLogged || !this.ismyz)
            return;
        return (h("div", { id: "link-int", class: "link-int" }, menuItems.map(function (item) { return _this.renderIntMenuItem(item); })));
    };
    ZHeader.prototype.renderIntMenuItem = function (menuItem) {
        var _this = this;
        var id = menuItem.id, label = menuItem.label, link = menuItem.link;
        return (h("span", null, h("a", { href: link ? link : null, id: id, class: "menu-item", onClick: function () {
                _this.activeMenuItem = _this.currentMenuItem = menuItem;
                _this.activeintlinkid = menuItem.id;
                if (menuItem.subMenu)
                    _this.handleToggleMobileMenuItem(menuItem.id);
    ...
    ZHeader.prototype.handleToggleMobileMenuItem = function (elementId) {
        if (!this.isMobile)
            return;
    ...
    ZHeader.prototype.renderMenuItemsData = function (menuItem) {
        if (!menuItem.subMenu)
            return null;
        var listItems = menuItem.subMenu.map(function (item) {
            return {
                id: item.id,
                text: item.label,
                link: item.link,
    ...
    ZHeader.prototype.renderMobileSubMenu = function (menuItems, id) {
        return (h("span", { class: "mobile-dropdown", id: id ? "mobile-dropdown-" + id : "" }, h("z-list", { list: menuItems })));
    };
    ZHeader.prototype.renderSubMenu = function (menuItem) {
        var _this = this;
        ...
        return (h("div", { id: "dropdown-menu", class: "dropdown-menu" }, h("ul", { class: "dropdown-links" }, menuItem.subMenu.map(function (item) { return (h("li", null, h("a", { id: item.id, class: item.id === _this.activesublinkid ? "active" : "", href: item.link ? item.link : null, role: item.link ? "link" : "button", tabindex: _this.getIntMenuItemTabindex(menuItem) }, item.label))); }))));
    };
    ZHeader.prototype.renderExtMenu = function (menuItems) {
        var _this = this;
        if (!this.isLogged)
            return h("div", null);
    ...
    ZHeader.prototype.renderLoginButton = function () {
    ...
    ZHeader.prototype.renderMobileLoginDiv = function (userData) {
        var _this = this;
        return (h("div", { id: "mobile-login", class: "mobile-login" }, h("span", null, h("a", { class: "menu-item", id: "user-data", onClick: function () { return _this.handleToggleMobileMenuItem("user-data"); }, role: "button" }, h("span", null, h("z-icon", { name: "user-avatar", height: 16, width: 16 }), userData.name), h("i", null)), this.renderUserData(userData))));
    };
    ZHeader.prototype.renderUserData = function (userData) {
        if (this.isMobile && !userData)
            return null;
        var listItems = userData.userlinks.map(function (item) {
            return {
                text: item.label,
                link: item.link,
                icon: item.icon,
    ...
    Object.defineProperty(ZHeader.prototype, "element", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(ZHeader, "watchers", {
        get: function () {
            return {
...
var stylesCss$h = ":host{line-height:0;vertical-align:middle}";
var ZIcon = /** @class */ (function () {
    function ZIcon(hostRef) {
        registerInstance(this, hostRef);
    ...
    ZIcon.prototype.selectPathOrPolygon = function (iconName) {
    ...
    ZIcon.prototype.render = function () {
...
ZIcon.style = stylesCss$h;
var stylesCss$i = ":host>div{display:-ms-flexbox;display:flex;-ms-flex-flow:row wrap;flex-flow:row wrap;-ms-flex-pack:start;justify-content:flex-start;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:12px}:host>div>div{width:300px;margin:5px}:host>div>div>label{margin:0 10px}";
var ZIconPackage = /** @class */ (function () {
    function ZIconPackage(hostRef) {
        registerInstance(this, hostRef);
    }
    ZIconPackage.prototype.render = function () {
        var iconsNames = Object.keys(icons);
        return (h("div", null, iconsNames.map(function (icon) {
            return (h("div", null, h("z-icon", { name: icon }), h("label", null, icon)));
        })));
    };
    return ZIconPackage;
}());
ZIconPackage.style = stylesCss$i;
var stylesCss$j = ":host{font-family:var(--dashboard-font);font-weight:var(--font-rg)}:host>div{background:var(--accent-lighter);padding:var(--basex2);border-radius:var(--radius-base);display:-ms-flexbox;display:flex;width:inherit}:host>div>slot{color:var(--text-grey-800);font-size:14px}:host>div>z-icon{fill:var(--myz-blue);cursor:pointer;margin-left:var(--basex2)}";
var ZInfoBox = /** @class */ (function () {
    function ZInfoBox(hostRef) {
        registerInstance(this, hostRef);
        this.infoBoxClose = createEvent(this, "infoBoxClose", 7);
        /** render close icon flag */
        this.isclosable = true;
    }
    ZInfoBox.prototype.emitInfoBoxClose = function () {
        this.infoBoxClose.emit({ boxid: this.boxid });
    };
    ZInfoBox.prototype.render = function () {
        var _this = this;
        return (h("div", { id: this.boxid }, h("slot", { name: "content" }), this.isclosable && h("z-icon", { name: "multiply", "data-action": "infoBoxClose", onClick: function () { return _this.emitInfoBoxClose(); } })));
    };
    return ZInfoBox;
}());
ZInfoBox.style = stylesCss$j;
var stylesCss$k = ":host{display:inline-block;width:inherit}:host input::-ms-clear,:host input::-ms-reveal{display:none}:host input,:host textarea,:host ul[role=\"listbox\"]{background:var(--bg-white);border-radius:0px;border:var(--border-size-small) solid var(--bg-grey-200);border-color:var(--bg-grey-200);-webkit-box-sizing:border-box;box-sizing:border-box;color:var(--text-grey-800);fill:var(--text-grey-800);font-family:var(--dashboard-font);font-weight:var(--font-rg);font-size:16px;outline:none}:host .filled{border-color:var(--text-grey-800) !important}:host input:focus,:host ul[role=\"listbox\"].closed:focus,:host li[role=\"option\"]:focus,:host .focus{border-color:transparent;-webkit-box-shadow:0 0 2px 2px var(--accent-dark);box-shadow:0 0 2px 2px var(--accent-dark);outline:none}:host input:hover,:host textarea:hover,:host ul[role=\"listbox\"].closed:hover,:host .hover{background:var(--bg-grey-050) !important;border-color:var(--text-grey-800) !important}:host input[readonly],:host .readonly,:host input[readonly].filled,:host .readonly.filled,:host ul[role=\"listbox\"].closed.readonly{border-color:var(--text-grey-200) !important;color:var(--text-grey-800) !important;pointer-events:none}:host input[readonly]:hover,:host textarea[readonly]:hover,:host .readonly.hover,:host ul[role=\"listbox\"].closed[readonly]:hover{background:var(--bg-white)}:host input:disabled,:host .disabled,:host .filled:disabled,:host input:disabled:hover,:host textarea:disabled:hover,:host .disabled.hover,:host ul[role=\"listbox\"].closed.disabled,:host ul[role=\"listbox\"].closed.disabled:hover{background:var(--bg-white) !important;border-color:var(--bg-grey-200) !important;-webkit-box-shadow:none !important;box-shadow:none !important;color:var(--text-grey-700) !important;fill:var(--bg-grey-200) !important;pointer-events:none}:host .input_success,:host .input_success:hover,:host .input_success.hover{background:var(--status-success-green-lighter) !important;border-color:var(--status-success-green) !important}:host .input_error,:host .input_error:hover,:host .input_error.hover{background:var(--status-error-red-lighter) !important;border-color:var(--status-error-red) !important}:host .input_warning,:host .input_warning:hover,:host .input_warning.hover{background:var(--status-warning-yellow-lighter) !important;border-color:var(--status-warning-yellow) !important}:host .input_selecting,:host .input_selecting:hover,:host input[readonly].input_selecting,:host input[readonly].input_selecting:hover{border-color:var(--myz-blue) !important;-webkit-box-shadow:0 0 0 0 transparent !important;box-shadow:0 0 0 0 transparent !important;color:var(--myz-blue) !important}:host input:focus.istyping,:host .focus.istyping{border-color:var(--myz-blue) !important;-webkit-box-shadow:var(--shadow-0);box-shadow:var(--shadow-0);color:var(--myz-blue)}:host input::-webkit-input-placeholder,:host textarea::-webkit-input-placeholder{color:var(--text-grey-700)}:host input::-moz-placeholder,:host textarea::-moz-placeholder{color:var(--text-grey-700)}:host input:-ms-input-placeholder,:host textarea:-ms-input-placeholder{color:var(--text-grey-700)}:host input::-ms-input-placeholder,:host textarea::-ms-input-placeholder{color:var(--text-grey-700)}:host input::placeholder,:host textarea::placeholder{color:var(--text-grey-700)}::-webkit-input-placeholder,::-webkit-textarea-placeholder{color:var(--text-grey-700)}:-ms-input-placeholder,:-ms-textarea-placeholder{color:var(--text-grey-700)}::-moz-placeholder{color:var(--text-grey-700)}:-moz-placeholder{color:var(--text-grey-700)}:host>div.textWrapper>div{fill:var(--text-grey-800)}:host>div.textWrapper>div>input{height:44px;width:100%;margin:0;padding:0 var(--half-x9) 0 var(--half-x3);-webkit-box-sizing:border-box;box-sizing:border-box}:host>div.textWrapper>div>input.hasIcon,:host>div.textWrapper>div>input.hasClearIcon{padding-right:var(--basex4)}:host>div.textWrapper>div>input.hasIcon.hasClearIcon{padding-right:var(--basex7)}:host>div.textWrapper>div{position:relative;z-index:1}:host>div.textWrapper>div>span.iconsWrapper{position:absolute;bottom:var(--half-x3);right:var(--half-x3);z-index:2;height:18px;display:-ms-flexbox;display:flex}:host>div.textWrapper>div>span.iconsWrapper>z-icon{display:block;height:18px;width:18px;margin-left:var(--half-x1)}:host>div.textWrapper>div>span.iconsWrapper>z-icon.resetIcon{cursor:pointer}:host>div.textWrapper>div>div.textareaWrapper{background:var(--bg-white);border:var(--border-size-small) solid var(--bg-grey-200);padding:var(--half-x3)}:host>div.textWrapper>div>div.textareaWrapper>textarea{min-height:132px;width:100%;margin:0;padding:0;resize:none;scrollbar-width:thin;scrollbar-color:var(--myz-blue) var(--bg-grey-200);border-color:transparent}:host>div.textWrapper>div>div.textareaWrapper>textarea:hover{border-color:transparent !important}:host>div.textWrapper>div>div.textareaWrapper>textarea.filled,:host>div.textWrapper>div>div.textareaWrapper>textarea.input_success,:host>div.textWrapper>div>div.textareaWrapper>textarea.input_warning,:host>div.textWrapper>div>div.textareaWrapper>textarea.input_error{border:none}:host>div.textWrapper>div>div.textareaWrapper.input_success.disabled,:host>div.textWrapper>div>div.textareaWrapper.input_warning.disabled,:host>div.textWrapper>div>div.textareaWrapper.input_error.disabled{background:var(--bg-white) !important;border-color:var(--bg-grey-200) !important}:host>div.textWrapper>div>div.textareaWrapper>textarea.istyping{color:var(--myz-blue)}::-webkit-scrollbar{background:linear-gradient(\n    90deg,\n    var(--bg-white) 2px,\n    var(--bg-grey-200) 4px,\n    var(--bg-white) 8px\n  );border-radius:var(--radius-base);width:10px;margin-right:20px;padding-right:20px}::-webkit-scrollbar-thumb{background-color:var(--myz-blue);border-radius:var(--radius-base);width:10px;margin-right:20px;padding:20px}:host>.checkboxWrapper{display:inline-block;font-family:var(--dashboard-font);font-weight:var(--font-rg);font-size:inherit;position:relative}:host>.checkboxWrapper>input[type=\"checkbox\"]{opacity:0;position:absolute;z-index:0}:host label{display:block}:host label.disabledLabel{color:var(--text-grey-700)}:host>.checkboxWrapper>label.checkboxLabel{display:-ms-inline-flexbox;display:inline-flex;line-height:16px;color:inherit;font-family:inherit;font-weight:inherit;font-size:inherit;text-transform:inherit;margin:0}:host>.checkboxWrapper>label.checkboxLabel.after{-ms-flex-direction:row;flex-direction:row}:host>.checkboxWrapper>label.checkboxLabel.before{-ms-flex-direction:row-reverse;flex-direction:row-reverse}:host>.checkboxWrapper>label.checkboxLabel.after>span{margin-left:var(--basex1)}:host>.checkboxWrapper>label.checkboxLabel.before>span{margin-right:var(--basex1)}:host>.checkboxWrapper>label.checkboxLabel>z-icon{fill:var(--myz-blue);height:18px;width:18px}:host>.checkboxWrapper>input[type=\"checkbox\"]:focus+label.checkboxLabel>z-icon{-webkit-box-shadow:0 0 2px 2px var(--accent-dark);box-shadow:0 0 2px 2px var(--accent-dark);border-radius:2px}:host>.checkboxWrapper>input[type=\"checkbox\"]:disabled+label.checkboxLabel>z-icon{fill:var(--bg-grey-700);cursor:default}:host>.checkboxWrapper>input[type=\"checkbox\"][readonly]+label.checkboxLabel>z-icon{fill:var(--bg-grey-800);pointer-events:none;cursor:default}:host>.radioWrapper{display:inline-block;font-family:var(--dashboard-font);font-weight:var(--font-rg);font-size:inherit;position:relative}:host>.radioWrapper>input[type=\"radio\"]{opacity:0;position:absolute;z-index:0}:host label{display:block}:host label.disabledLabel{color:var(--text-grey-700)}:host>.radioWrapper>label.radioLabel{display:-ms-inline-flexbox;display:inline-flex;line-height:16px;color:inherit;font-family:inherit;font-weight:inherit;font-size:inherit;text-transform:inherit;margin:0}:host>.radioWrapper>label.radioLabel.after{-ms-flex-direction:row;flex-direction:row}:host>.radioWrapper>label.radioLabel.before{-ms-flex-direction:row-reverse;flex-direction:row-reverse}:host>.radioWrapper>label.radioLabel.after>span{margin-left:var(--basex1)}:host>.radioWrapper>label.radioLabel.before>span{margin-right:var(--basex1)}:host>.radioWrapper>label.radioLabel>z-icon{fill:var(--myz-blue);height:18px;width:18px}:host>.radioWrapper>input[type=\"radio\"]:focus+label.radioLabel>z-icon{-webkit-box-shadow:0 0 2px 2px var(--accent-dark);box-shadow:0 0 2px 2px var(--accent-dark);border-radius:50%}:host>.radioWrapper>input[type=\"radio\"]:disabled+label.radioLabel>z-icon{fill:var(--bg-grey-700);cursor:default}:host>.radioWrapper>input[type=\"radio\"][readonly]+label.radioLabel>z-icon{fill:var(--bg-grey-800);pointer-events:none;cursor:default}";
var ZInput = /** @class */ (function () {
    ...
    class_1.prototype.inputCheckListener = function (e) {
        var data = e.detail;
        switch (this.type) {
            ...
            return __generator(this, function (_a) {
                switch (this.type) {
                    case InputTypeEnum.select:
                        return [2 /*return*/, this.selectElem.getValue()];
                    default:
    ...
    /** get checked status */
    class_1.prototype.isChecked = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (this.type) {
                    case InputTypeEnum.checkbox:
                    case InputTypeEnum.radio:
                        return [2 /*return*/, this.checked];
                    default:
    ...
    class_1.prototype.emitInputChange = function (value, keycode) {
        var _this = this;
        if (!this.isTyping) {
        ...
        this.value = value;
        this.inputChange.emit({ value: value, keycode: keycode, validity: validity });
        clearTimeout(this.timer);
        this.timer = setTimeout(function () {
            _this.emitStopTyping(_this.value, validity);
        }, this.typingtimeout);
    };
    class_1.prototype.emitStartTyping = function () {
        this.isTyping = true;
        this.startTyping.emit();
    };
    class_1.prototype.emitStopTyping = function (value, validity) {
        this.isTyping = false;
    ...
    class_1.prototype.emitInputCheck = function (checked) {
    ...
    class_1.prototype.getValidity = function (type) {
        var input = this.hostElement.shadowRoot.querySelector(type);
        return input.validity;
    };
    /* START text/password/email/number */
    class_1.prototype.getTextAttributes = function () {
        var _this = this;
        return {
            id: this.htmlid,
            name: this.name,
            ...
            onInput: function (e) { return _this.emitInputChange(e.target.value, e.keyCode); }
        };
    };
    class_1.prototype.renderInputText = function (type) {
        if (type === void 0) { type = InputTypeEnum.text; }
        var attr = this.getTextAttributes();
        ...
        return (h("div", { class: "textWrapper" }, this.renderLabel(), h("div", null, h("input", Object.assign({}, attr, { type: type === InputTypeEnum.password && !this.passwordHidden
                ? InputTypeEnum.text
                : type, "aria-labelledby": this.htmlid + "_label" })), this.renderIcons()), this.renderMessage()));
    };
    ...
    class_1.prototype.renderIcons = function () {
        return (h("span", { class: "iconsWrapper " + (this.disabled ? "disabled" : "") }, this.renderResetIcon(), this.renderIcon()));
    };
    ...
    class_1.prototype.renderResetIcon = function () {
        var _this = this;
        if (!this.hasclearicon || !this.value || this.disabled || this.readonly)
            return;
        return (h("z-icon", { class: "resetIcon", name: "multiply", onClick: function (e) { return _this.emitInputChange("", e.keyCode); } }));
    };
    class_1.prototype.renderShowHidePassword = function () {
        var _this = this;
        return (h("z-icon", { class: "inputIcon", name: this.passwordHidden ? "view" : "view-off", onClick: function () { return (_this.passwordHidden = !_this.passwordHidden); } }));
    };
    class_1.prototype.renderMessage = function () {
        if (!this.hasmessage)
            return;
    ...
    class_1.prototype.renderTextarea = function () {
        return (h("div", { class: "textWrapper" }, this.renderLabel(), h("div", null, this.renderTextareaBody()), this.renderMessage()));
    };
    class_1.prototype.renderTextareaBody = function () {
        var attributes = this.getTextAttributes();
        return (h("div", { class: "\n            textareaWrapper\n            " + attributes.class + "\n            " + (attributes.disabled && " disabled") + "\n            " + (attributes.readonly && " readonly") + "\n            " + (this.isTyping && " istyping") + "\n            " + this.textareaWrapperFocus + "\n            " + this.textareaWrapperHover + "\n          " }, h("textarea", Object.assign({}, attributes, this.getTextareaExtraAttributes()))));
    };
    class_1.prototype.getTextareaExtraAttributes = function () {
        var _this = this;
        return {
            onFocus: function () { return (_this.textareaWrapperFocus = "focus"); },
            onBlur: function () { return (_this.textareaWrapperFocus = ""); },
            onMouseOver: function () { return (_this.textareaWrapperHover = "hover"); },
            onMouseOut: function () { return (_this.textareaWrapperHover = ""); }
        };
    };
    /* END textarea */
    /* START checkbox */
    class_1.prototype.handleCheckboxChange = function () {
        this.checked = !this.checked;
        this.emitInputCheck(this.checked);
    };
    class_1.prototype.renderCheckbox = function () {
        var _this = this;
        return (h("div", { class: "checkboxWrapper" }, h("input", { id: this.htmlid, type: "checkbox", name: this.name, checked: this.checked, value: this.value, disabled: this.disabled, readonly: this.readonly, required: this.required, onChange: function () { return _this.handleCheckboxChange(); } }), h("label", { htmlFor: this.htmlid, class: "checkboxLabel " + (this.labelafter ? "after" : "before") }, h("z-icon", { name: this.checked ? "checkbox-checked" : "checkbox", "aria-hidden": true }), this.label && h("span", { innerHTML: this.label }))));
    };
    /* END checkbox */
    /* START radio */
    class_1.prototype.handleRadioChange = function () {
        this.checked = true;
        this.emitInputCheck(this.checked);
    };
    class_1.prototype.renderRadio = function () {
        var _this = this;
        return (h("div", { class: "radioWrapper" }, h("input", { id: this.htmlid, type: "radio", name: this.name, checked: this.checked, value: this.value, disabled: this.disabled, readonly: this.readonly, onChange: function () { return _this.handleRadioChange(); } }), h("label", { htmlFor: this.htmlid, class: "radioLabel " + (this.labelafter ? "after" : "before") }, h("z-icon", { name: this.checked ? "radio-button-checked" : "radio-button", "aria-hidden": true }), this.label && h("span", { innerHTML: this.label }))));
    };
    /* END radio */
    /* START select */
    class_1.prototype.renderSelect = function () {
        var _this = this;
        return (h("z-select", { htmlid: this.htmlid, items: this.items, name: this.name, label: this.label, disabled: this.disabled, readonly: this.readonly, placeholder: this.placeholder, htmltitle: this.htmltitle, status: this.status, hasmessage: this.hasmessage, message: this.message, autocomplete: this.autocomplete, multiple: this.multiple, ref: function (el) { return (_this.selectElem = el); } }));
    };
    /* END select */
...
ZInput.style = stylesCss$k;
var stylesCss$l = ":host>label{display:block;color:var(--text-grey-800);font-family:var(--dashboard-font);font-weight:var(--font-sb);font-size:12px;line-height:16px;text-transform:uppercase;text-align:left;margin:var(--basex1) 0}:host>label.disabled{color:var(--text-grey-700)}";
var ZInputLabel = /** @class */ (function () {
    function ZInputLabel(hostRef) {
        registerInstance(this, hostRef);
        /** the label is disabled */
        this.disabled = false;
    }
    ZInputLabel.prototype.render = function () {
        return h("label", { class: this.disabled ? "disabled" : "" }, this.value);
    };
    return ZInputLabel;
}());
ZInputLabel.style = stylesCss$l;
var stylesCss$m = ":host span.statusMsg{font-family:var(--dashboard-font);font-weight:var(--font-rg);font-size:14px;line-height:16px;min-height:16px;color:var(--text-grey-700);fill:var(--text-grey-700);margin-top:var(--basex1);display:-ms-flexbox;display:flex}:host span.statusMsg.msg_success{color:var(--status-success-green);fill:var(--status-success-green)}:host span.statusMsg.msg_error{color:var(--status-error-red);fill:var(--status-error-red)}:host span.statusMsg.msg_warning{color:var(--status-warning-yellow-dark);fill:var(--status-warning-yellow-dark)}:host span.statusMsg>z-icon{margin-right:var(--basex1);margin-top:1px}";
var ZInputMessage = /** @class */ (function () {
    function ZInputMessage(hostRef) {
        registerInstance(this, hostRef);
        this.statusIcons = {
...
var ZLink = /** @class */ (function () {
    ...
    ZLink.prototype.emitZLinkClick = function (e, linkId) {
        this.emitZLinkInteraction(e, linkId);
    };
    ZLink.prototype.emitZLinkInteraction = function (e, linkId) {
        this.zLinkClick.emit({ e: e, linkId: linkId });
    };
    ZLink.prototype.render = function () {
        var _this = this;
        return (h("a", { id: this.htmlid, href: this.href ? this.href : null, class: (this.isdisabled && "disabled") + "\n          " + (this.isactive && "active") + "\n          " + (this.iswhite && "white"), target: this.target, role: this.href ? "link" : "button", tabindex: this.htmltabindex, onClick: function (e) { return _this.emitZLinkClick(e, _this.htmlid); } }, this.icon && h("z-icon", { name: this.icon, width: 12, height: 12 }), h("slot", null)));
    };
    return ZLink;
}());
ZLink.style = stylesCss$n;
var stylesCss$o = "ul{margin:0;padding:0}";
var ZList = /** @class */ (function () {
    function ZList(hostRef) {
        registerInstance(this, hostRef);
    }
    ZList.prototype.componentDidLoad = function () {
        if (this.inputrawdata) {
            this.parseinputrawdata(this.inputrawdata);
        }
    };
    ZList.prototype.parseinputrawdata = function (inputrawdata) {
        this.list = __spreadArrays(JSON.parse(inputrawdata));
    };
    ZList.prototype.oninputrawdataChange = function (newValue) {
        this.parseinputrawdata(newValue);
    };
    ZList.prototype.render = function () {
        var lastElem = this.list ? this.list.length - 1 : -1;
        return (h("ul", null, this.list &&
            this.list.map(function (bean, i) { return (h("z-list-item", { listitemid: bean.listitemid, text: bean.text, link: bean.link, linktarget: bean.linktarget, icon: bean.icon, underlined: lastElem != i })); })));
    };
    Object.defineProperty(ZList, "watchers", {
        get: function () {
            return {
...
var ZListItem = /** @class */ (function () {
    ...
    ZListItem.prototype.emitZListItemLinkClick = function (e, linkId) {
        this.zListItemLinkClick.emit({ e: e, linkId: linkId });
    };
    ZListItem.prototype.emitZListItemClick = function (e, listitemid) {
        this.zListItemClick.emit({ e: e, listitemid: listitemid });
    };
    ZListItem.prototype.render = function () {
        var _this = this;
        var linkId = this.listitemid ? "link_" + this.listitemid : "";
        return (h("li", { role: "button", id: this.listitemid, "data-action": this.action, onClick: function (e) { return _this.emitZListItemClick(e, _this.listitemid); }, onKeyPress: function (ev) { return handleKeyboardSubmit(ev, _this.emitZListItemClick, _this.listitemid); } }, h("span", { class: this.underlined && "border" }, this.icon && h("z-icon", { name: this.icon }), this.link ? (h("a", { href: this.link ? this.link : null, target: this.linktarget, id: linkId, onClick: function (e) { return _this.emitZListItemLinkClick(e, linkId); }, onKeyPress: function (ev) { return handleKeyboardSubmit(ev, _this.emitZListItemLinkClick, linkId); }, role: this.link ? "link" : "button", tabindex: "0" }, this.text)) : (h("span", { innerHTML: this.text })), h("slot", null))));
    };
    return ZListItem;
}());
ZListItem.style = stylesCss$p;
var stylesCss$q = ":host{font-family:var(--dashboard-font);font-weight:var(--font-rg)}:host>div{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:start;justify-content:flex-start}polygon{fill:var(--myz-red)}path{fill:var(--bg-white)}";
var ZLogo = /** @class */ (function () {
    function ZLogo(hostRef) {
        registerInstance(this, hostRef);
        /** image width */
        this.width = 163;
        /** image height */
    ...
    ZLogo.prototype.renderSvg = function () {
...
var ZMenuDropdown = /** @class */ (function () {
    ...
    ZMenuDropdown.prototype.render = function () {
        var _this = this;
        return (h("a", { class: this.retriveMenuClass(), role: "button", tabindex: "0", onFocus: function () {
                document.addEventListener("click", _this.handleFocus);
                document.addEventListener("keyup", _this.handleFocus);
            }, onKeyUp: function (e) { return handleKeyboardSubmit(e, _this.handleToggle); } }, h("div", { class: "container", onClick: function () { return _this.handleToggle(); } }, h("z-icon", { name: "user-avatar", width: 14, height: 14 }), h("span", { class: "user" }, this.nomeutente), this.renderButtonMenu()), this.renderMenuOpen()));
    };
    return ZMenuDropdown;
}());
ZMenuDropdown.style = stylesCss$r;
...
var ZPaginationBar = /** @class */ (function () {
    ...
    ZPaginationBar.prototype.componentDidLoad = function () {
        this.scrollPage = this.scrollPage.bind(this);
        var mc = new hammer(this.bar);
        // listen to events...
        mc.on("swiperight", this.scrollPage);
        mc.on("swipeleft", this.scrollPage);
    };
    ZPaginationBar.prototype.componentWillRender = function () {
        this.initPagination();
    };
    ZPaginationBar.prototype.componentWillUpdate = function () {
        this.initPagination();
    };
    ZPaginationBar.prototype.initPagination = function () {
        this.loadPages();
        if (this.historyraw) {
            this.parsehistoryraw(this.historyraw);
        }
    };
    ZPaginationBar.prototype.parsehistoryraw = function (historyraw) {
        this.listhistoryrow = __spreadArrays(JSON.parse(historyraw));
    };
    ZPaginationBar.prototype.scrollPage = function (ev) {
        var vel = Math.round(Math.abs(ev.velocity)) * this.velocityConstantMultiplier;
        var deltaPage = Math.max(1, vel);
        switch (ev.type) {
            case "swiperight":
                if (!this.canNavigateLeft())
                    break;
                var newstartPage1 = this.startpage - deltaPage;
                if (newstartPage1 > 1)
            ...
            case "swipeleft":
                if (!this.canNavigateRight())
                    break;
                var newstartPage2 = this.startpage + deltaPage;
    ...
    ZPaginationBar.prototype.emitGoToPage = function (page) {
        this.currentpage = page;
        this.goToPage.emit({ page: page });
        this.addPageToHistory.emit({ page: page });
    };
    ZPaginationBar.prototype.emitChangeStartPage = function (startpage) {
        this.startpage = startpage;
        this.changeStartPage.emit({ startpage: startpage });
    };
    ZPaginationBar.prototype.emitAddPageToHistory = function (page) {
        this.listhistoryrow.push(page);
        this.changeStartPage.emit({ page: page });
    };
    ZPaginationBar.prototype.loadPages = function () {
        this.currentPages.splice(0);
        var lastPage = this.pageWindow();
        var i;
        for (i = 0; i < lastPage; i++) {
            this.currentPages.push(i + this.startpage);
        }
    };
    ZPaginationBar.prototype.pageWindow = function () {
        return Math.min(this.pages, this.visiblepages); //How many pages are there to show?
    };
    ZPaginationBar.prototype.canNavigateLeft = function () {
        return this.startpage > 1;
    };
    ZPaginationBar.prototype.canNavigateRight = function () {
        return this.startpage + this.visiblepages - 1 < this.pages;
    };
    ZPaginationBar.prototype.navigateLeft = function () {
        if (this.canNavigateLeft()) {
            this.startpage--;
    ...
    ZPaginationBar.prototype.navigateRight = function () {
        if (this.canNavigateRight()) {
            this.startpage++;
            this.emitChangeStartPage(this.startpage);
            this.loadPages();
...
var ZPanelElem = /** @class */ (function () {
    ...
    ZPanelElem.prototype.renderIcon = function () {
        if (this.isdisabled) {
    ...
    ZPanelElem.prototype.render = function () {
        var elemId = this.elemid ? this.elemid : "";
...
ZPanelElem.style = stylesCss$u;
var stylesCss$v = ":host{display:inline-block;width:inherit}:host ul[role=\"listbox\"]{background:var(--bg-white);border-radius:0px;border:var(--border-size-small) solid var(--bg-grey-200);border-color:var(--bg-grey-200);-webkit-box-sizing:border-box;box-sizing:border-box;color:var(--text-grey-800);fill:var(--text-grey-800);font-family:var(--dashboard-font);font-weight:var(--font-rg);font-size:16px;outline:none}:host .filled{border-color:var(--text-grey-800) !important}:host li[role=\"option\"]:focus{border-color:transparent;-webkit-box-shadow:0 0 2px 2px var(--accent-dark);box-shadow:0 0 2px 2px var(--accent-dark);outline:none}:host>div.selectWrapper>z-input{width:100%}:host>div.selectWrapper>div{position:relative}:host>div.selectWrapper>div.closed{height:0px;overflow:hidden}:host>div.selectWrapper>div>div.ulScrollWrapper{background:var(--bg-white);position:absolute;padding:var(--half-x1) var(--basex1);border:var(--border-size-small) solid var(--bg-grey-200);border-top:none;width:100%;-webkit-box-sizing:border-box;box-sizing:border-box}:host>div.selectWrapper>div.closed>div.ulScrollWrapper{z-index:10}:host>div.selectWrapper>div.open>div.ulScrollWrapper{z-index:20}:host>div.selectWrapper>div>div.ulScrollWrapper>ul{list-style:none;margin:0;padding:0;border:0px;max-height:240px;overflow:auto;scrollbar-width:thin;scrollbar-color:var(--myz-blue) var(--bg-grey-200);position:relative}:host>div.selectWrapper>div>div.ulScrollWrapper>ul::-webkit-scrollbar{background:linear-gradient(\n    90deg,\n    var(--bg-white) 2px,\n    var(--bg-grey-200) 4px,\n    var(--bg-white) 8px\n  );border-radius:var(--radius-base);width:10px}:host>div.selectWrapper>div>div.ulScrollWrapper>ul::-webkit-scrollbar-thumb{background-color:var(--myz-blue);border-radius:var(--radius-base);width:10px}:host>div.selectWrapper>div>div.ulScrollWrapper>ul>li{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-webkit-box-sizing:border-box;box-sizing:border-box;min-height:44px;padding:var(--half-x3);text-align:left;cursor:pointer;border-bottom:var(--border-size-small) solid var(--bg-grey-200)}:host>div.selectWrapper>div>div.ulScrollWrapper>ul>li:hover{color:var(--myz-blue-dark);background:var(--bg-grey-050)}:host>div.selectWrapper>div>div.ulScrollWrapper>ul>li:focus{margin:2px}:host>div.selectWrapper>div>div.ulScrollWrapper>ul>li[aria-selected=\"\"]{font-weight:var(--font-sb)}:host>div.selectWrapper>div>div.ulScrollWrapper>ul>li.disabled{color:var(--text-grey-700);cursor:default;pointer-events:none}:host>div.selectWrapper>div>div.ulScrollWrapper>ul>li.noResults{color:var(--myz-blue);fill:var(--myz-blue)}:host>div.selectWrapper>div>div.ulScrollWrapper>ul>li.noResults>z-icon{margin-right:var(--basex1)}:host>div.selectWrapper>div.chipsWrapper{padding-bottom:var(--basex1)}:host>div.selectWrapper>div.chipsWrapper>z-button-filter{display:inline-block;margin:4px}";
var ZSelect = /** @class */ (function () {
    ...
    class_2.prototype.watchItems = function () {
        this.itemsList = this.getInitialItemsArray();
        typeof this.items === "string" ? JSON.parse(this.items) : this.items;
        this.selectedItems = this.itemsList.filter(function (item) { return item.selected; });
    };
    /** get the input selected options */
    class_2.prototype.getSelectedItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.selectedItems];
            });
        });
    };
    /** get the input value */
    class_2.prototype.getValue = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getSelectedValues()];
            });
        });
    };
    /** set the input value */
    class_2.prototype.setValue = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.selectedItems = this.itemsList.filter(function (item) { return values.includes(item.id); });
                return [2 /*return*/];
            });
        });
    };
    class_2.prototype.emitOptionSelect = function () {
    ...
    class_2.prototype.getInitialItemsArray = function () {
        return typeof this.items === "string" ? JSON.parse(this.items) : this.items;
    };
    class_2.prototype.mapSelectedItemsToItemsArray = function () {
        var _this = this;
        var initialItemsList = this.getInitialItemsArray();
        return initialItemsList.map(function (item) {
            var found = _this.selectedItems.find(function (selected) { return selected.id === item.id; });
            item.selected = !!found;
            return item;
        });
    };
    class_2.prototype.getSelectedValues = function () {
        if (this.multiple) {
            return this.selectedItems.map(function (item) { return item.id; });
        }
    ...
    class_2.prototype.filterItems = function (searchString) {
        var prevList = this.mapSelectedItemsToItemsArray();
    ...
    class_2.prototype.handleInputChange = function (e) {
        this.searchString = e.detail.value;
        if (!this.isOpen)
            this.toggleSelectUl();
    };
    class_2.prototype.selectItem = function (item, selected) {
        var _this = this;
        if (item && item.disabled)
            return;
        this.itemsList = this.mapSelectedItemsToItemsArray();
        this.itemsList = this.itemsList.map(function (i) {
            if (!_this.multiple)
                i.selected = false;
    ...
    class_2.prototype.arrowsSelectNav = function (e, key) {
        var arrows = [keybordKeyCodeEnum.ARROW_DOWN, keybordKeyCodeEnum.ARROW_UP];
    ...
    class_2.prototype.focusSelectItem = function (index) {
        var focusElem = this.hostElement.shadowRoot.getElementById(this.htmlid + "_" + index);
        if (focusElem)
            focusElem.focus();
    };
    class_2.prototype.toggleSelectUl = function (selfFocusOnClose) {
        if (selfFocusOnClose === void 0) { selfFocusOnClose = false; }
    ...
    class_2.prototype.handleInputClick = function (e) {
        var cp = e.composedPath();
        var clearIcon = cp.find(function (item) { return item.classList && item.classList.contains("resetIcon"); });
        if (clearIcon) {
            e.stopPropagation();
            return;
        }
    ...
    class_2.prototype.handleSelectFocus = function (e) {
        var _this = this;
        ...
        var tree = getElementTree(getClickedElement());
        var parent = tree.find(function (elem) {
            return ((elem.nodeName.toLowerCase() === "z-input" &&
                elem.id === _this.htmlid + "_input") ||
                (_this.multiple &&
                    elem.nodeName.toLowerCase() === "ul" &&
                    elem.id === _this.htmlid));
        });
        if (!parent) {
            this.toggleSelectUl(e instanceof MouseEvent ? true : false);
        }
    };
    class_2.prototype.scrollToLetter = function (letter) {
        var foundItem = this.itemsList.find(function (item) { return item.name.charAt(0) === letter; });
        if (foundItem)
    ...
    class_2.prototype.renderInput = function () {
        var _this = this;
        return (h("z-input", { id: this.htmlid + "_input", htmlid: this.htmlid + "_input", placeholder: this.placeholder, value: !this.isOpen && !this.multiple && this.selectedItems.length
                ...
                : null, icon: this.isOpen ? "caret-up" : "caret-down", hasclearicon: this.autocomplete, hasmessage: false, disabled: this.disabled, readonly: this.readonly || (!this.autocomplete && this.isOpen), status: this.isOpen ? InputStatusEnum.selecting : this.status, onClick: function (e) {
                _this.handleInputClick(e);
            }, onKeyUp: function (e) {
                if (e.keyCode !== 13)
                    e.preventDefault();
                handleKeyboardSubmit(e, _this.toggleSelectUl);
            }, onKeyDown: function (e) { return _this.arrowsSelectNav(e, _this.selectedItems.length
                ? _this.itemsList.indexOf(_this.selectedItems[0])
                : -1); }, onInputChange: function (e) {
                _this.handleInputChange(e);
            }, onKeyPress: function (e) {
                if (!_this.autocomplete) {
                    e.preventDefault();
                    _this.scrollToLetter(String.fromCharCode(e.keyCode));
                }
            } }));
    };
    class_2.prototype.renderChips = function () {
        var _this = this;
        if (!this.multiple || !this.selectedItems.length)
            return;
        return (h("div", { class: "chipsWrapper " + (this.isOpen ? "open" : "") }, this.selectedItems.map(function (item) { return (h("z-button-filter", { filterid: item.id, filtername: item.name.replace(/<[^>]+>/g, ""), issmall: true, onRemovefilter: function () { return _this.selectItem(item, false); } })); })));
    };
    class_2.prototype.renderSelectUl = function () {
        return (h("div", { class: this.isOpen ? "open" : "closed" }, h("div", { class: "ulScrollWrapper" }, h("ul", { role: "listbox", tabindex: this.disabled || this.readonly || !this.isOpen ? -1 : 0, id: this.htmlid, "aria-activedescendant": !this.multiple && this.selectedItems.length
    ...
    class_2.prototype.renderSelectUlItems = function () {
        var _this = this;
        if (!this.itemsList.length)
            return this.renderNoSearchResults();
        return this.itemsList.map(function (item, key) {
            return (h("li", { role: "option", tabindex: item.disabled || !_this.isOpen ? -1 : 0, "aria-selected": !!item.selected, class: item.disabled && "disabled", id: _this.htmlid + "_" + key, onClick: function () { return _this.selectItem(item, true); }, onKeyUp: function (e) { return handleKeyboardSubmit(e, _this.selectItem, item, true); }, onKeyDown: function (e) { return _this.arrowsSelectNav(e, key); } }, h("span", { innerHTML: item.name })));
        });
    };
    class_2.prototype.renderNoSearchResults = function () {
        return (h("li", { class: "noResults" }, h("z-icon", { name: "circle-cross-stroke" }), this.noresultslabel));
    };
    class_2.prototype.renderMessage = function () {
        if (!this.hasmessage)
            return;
        return h("z-input-message", { message: this.message, status: this.status });
    };
...
ZSelect.style = stylesCss$v;
var stylesCss$w = ":host{-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;width:100%;max-width:100%;margin:0;padding:0;font-family:var(--dashboard-font);font-weight:var(--font-rg);list-style:none}@media only screen and (min-width: 768px){:host{padding:0 var(--basex2)}}";
var ZStepper = /** @class */ (function () {
    function ZStepper(hostRef) {
        registerInstance(this, hostRef);
    }
    ZStepper.prototype.render = function () {
        return (h("slot", null));
    };
    return ZStepper;
}());
ZStepper.style = stylesCss$w;
var stylesCss$x = ":host{position:relative;width:calc(var(--basex4) + var(--basex1));font-family:var(--dashboard-font);font-weight:var(--font-rg)}:host(:not(:last-child)){-ms-flex:1;flex:1}:host(:not(:last-child))::after{position:absolute;top:var(--basex4);left:var(--basex3);right:var(--basex2);z-index:1;content:'';display:block;width:auto;margin:0 calc(-1 * var(--basex2)) 0 var(--basex2);border-bottom:solid 2px var(--bg-grey-700)}.stepper-item{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-align:center;align-items:center;width:calc(var(--basex4) + var(--basex1));padding:0;color:inherit;font-family:inherit;font-size:18px;text-decoration:none;line-height:28px;background:transparent;border:0;outline:0;-webkit-appearance:none;-moz-appearance:none;appearance:none}.stepper-item span{display:none;width:calc(100% + var(--basex4));text-align:center}:host(:not([disabled])) .stepper-item{cursor:pointer}:host([disabled]) .stepper-item{pointer-events:none}.indicator{content:counter(stepper);-webkit-box-sizing:border-box;box-sizing:border-box;display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;width:var(--basex4);height:var(--basex4);margin:var(--basex2);font-size:14px;font-weight:var(--font-sb);line-height:1;color:var(--myz-blue);background:var(--bg-white);border:2px solid var(--myz-blue);border-radius:50%}:host([pressed]:not([disabled])) .indicator{color:var(--text-white);background:var(--myz-blue-dark);border-color:var(--myz-blue-dark)}:host(:not([disabled]):focus-within) .indicator{-webkit-box-shadow:0px 0px 2px 2px var(--accent-dark);box-shadow:0px 0px 2px 2px var(--accent-dark)}:host([disabled]) .indicator{color:var(--text-grey-700);background:var(--bg-grey-200);border-color:currentColor}@media only screen and (min-width: 768px){:host{width:calc(var(--basex4) + var(--basex6))}:host(:not(:last-child))::after{top:var(--basex5);left:calc(var(--basex4) + var(--basex4))}.stepper-item{width:calc(var(--basex6) + var(--basex4))}.stepper-item span{display:block}.indicator{width:var(--basex6);height:var(--basex6);font-size:16px}}";
var ZStepperItem = /** @class */ (function () {
    function ZStepperItem(hostRef) {
        registerInstance(this, hostRef);
    }
    ZStepperItem.prototype.render = function () {
        if (this.href) {
...
var ZTooltip = /** @class */ (function () {
    ...
    ZTooltip.prototype.render = function () {
        return h("div", { class: this.getArrowClass() }, this.content);
    };
    return ZTooltip;
}());
ZTooltip.style = stylesCss$z;
export { ZButton as z_button, ZButtonFilter as z_button_filter, ZButtonSort as z_button_sort, ZCandybar as z_candybar, ZCardComponent as z_card, ZCardAlert as z_card_alert, ZCardBody as z_card_body, ZCardCover as z_card_cover, ZCardFooter as z_card_footer, ZCardHeader as z_card_header, ZCardIcon as z_card_icon, ZCardList as z_card_list, ZChip as z_chip, ZCombobox as z_combobox, ZCookiebar as z_cookiebar, ZFooter as z_footer, ZHeader as z_header, ZIcon as z_icon, ZIconPackage as z_icon_package, ZInfoBox as z_info_box, ZInput as z_input, ZInputLabel as z_input_label, ZInputMessage as z_input_message, ZLink as z_link, ZList as z_list, ZListItem as z_list_item, ZLogo as z_logo, ZMenuDropdown as z_menu_dropdown, ZPaginationBar as z_pagination_bar, ZPaginationPage as z_pagination_page, ZPanelElem as z_panel_elem, ZSelect as z_select, ZStepper as z_stepper, ZStepperItem as z_stepper_item, ZToggleButton as z_toggle_button, ZTooltip as z_tooltip };
