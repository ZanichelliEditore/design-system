  ...
  `,o={parameters:{controls:{exclude:["flow"]}},render:e=>t`<z-app-header-deprecated
    ...
    >
      ...
      ${e.hero?"":t`<img
          ...
          />`}
      ${y()}
    </z-app-header-deprecated>`},f={parameters:{controls:{exclude:["searchPageUrl","enableSearch"]}},render:e=>t`<z-app-header-deprecated
      flow=${e.flow}
      enable-search
      style="--app-header-content-max-width: ${e["--app-header-content-max-width"]}"
    >
      ...
      <h2 slot="subtitle">Payoff dell'applicazione</h2>
      ${n()}
    </z-app-header-deprecated>`},g={parameters:{controls:{exclude:["searchPageUrl","enableSearch"]}},decorators:[e=>t`
...
} satisfies Story`,...(J=(X=u.parameters)==null?void 0:X.docs)==null?void 0:J.source}}};var K,Q,ee;f.parameters={...f.parameters,docs:{...(K=f.parameters)==null?void 0:K.docs,source:{originalSource:`{
  parameters: {
    controls: {
...
} satisfies Story`,...(ee=(Q=f.parameters)==null?void 0:Q.docs)==null?void 0:ee.source}}};var ae,te,re;g.parameters={...g.parameters,docs:{...(ae=g.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  parameters: {
    controls: {
      exclude: ["searchPageUrl", "enableSearch"]
    }
...
} satisfies Story`,...(re=(te=g.parameters)==null?void 0:te.docs)==null?void 0:re.source}}};const Le=["Title","Subtitle","TopSubtitle","Menu","LongTitle","VeryLongMenu","OffcanvasMenu","Stuck","MaxWidth","CoverHeroWithSlottedImage","Searchbar","SearchPageButton"];export{u as CoverHeroWithSlottedImage,s as LongTitle,m as MaxWidth,p as Menu,d as OffcanvasMenu,g as SearchPageButton,f as Searchbar,c as Stuck,i as Subtitle,o as Title,h as TopSubtitle,l as VeryLongMenu,Le as __namedExportsOrder,Ce as default};
