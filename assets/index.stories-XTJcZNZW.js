import{r as e}from"./lit-CgIPLKVa.js";import"./z-button-BRN_Z_XJ.js";import"./z-date-picker-tXbFWF1V.js";import{t}from"./taggedTemplateLiteral-BA-xtlkT.js";import"./z-modal-C4ozv2sZ.js";import"./z-select-ByEX2Egk.js";var n,r={title:`ZModal`,component:`z-modal`,args:{modalid:`my-modal`,modaltitle:`My modal title`,modalsubtitle:`My modal subtitle`,closeButtonLabel:`chiudi modale`,alertdialog:!1,closable:!0,scrollInside:!0,lockPageScroll:!0,"--z-modal-content-padding":`calc(var(--space-unit) * 2)`},decorators:[r=>e(n||=t([`
      <script>
        function openZModal() {
      ...
      <\/script>
      `,`
    `]),r())]},i={args:{modalid:`my-modal-short`},render:t=>e`
    <z-modal
      modalid=${t.modalid}
      modaltitle=${t.modaltitle}
      modalsubtitle=${t.modalsubtitle}
      close-button-label=${t.closeButtonLabel}
      alertdialog=${t.alertdialog}
      closable=${t.closable}
      scroll-inside=${t.scrollInside}
      lock-page-scroll=${t.lockPageScroll}
      style="--z-modal-content-padding: ${t[`--z-modal-content-padding`]}"
    >
  ...
  `},a={args:{modalid:`my-modal-long`},render:t=>e`
    <z-modal
      modalid=${t.modalid}
      modaltitle=${t.modaltitle}
      modalsubtitle=${t.modalsubtitle}
  ...
  render: args => html\`
    ...
    <z-button onclick="openZModal()">apri modale</z-button>
  \`
} satisfies Story`,...a.parameters?.docs?.source}}};var o=[`ShortText`,`LongText`];export{a as LongText,i as ShortText,o as __namedExportsOrder,r as default};