  ...
  `,n={parameters:{controls:{exclude:["flow"]}},render:e=>t`<z-app-header
    ...
    >
      ...
      ${e.hero?"":t`<img
          ...
          />`}
      ${y()}
    </z-app-header>`},f={parameters:{controls:{exclude:["searchPageUrl","enableSearch"]}},render:e=>t`<z-app-header
      flow=${e.flow}
      enable-search
      style="--app-header-content-max-width: ${e["--app-header-content-max-width"]}"
    >
      ...
      <h2 slot="subtitle">Payoff dell'applicazione</h2>
      ${o()}
    </z-app-header>`},g={parameters:{controls:{exclude:["searchPageUrl","enableSearch"]}},decorators:[e=>t`
