import{x as n}from"./lit-element-DGXdXVoE.js";import{o as i}from"./style-map-DWZVjDvr.js";import{I as m}from"./index-DlGlwqHM.js";import{a as r}from"./storybook-utils-DAVCxM-F.js";import"./index-RDOHYzgn.js";import"./directive-CF8sV3Lr.js";import"./chunk-GKNNPQCW-BkHQSocK.js";import"./index-BJyMe-bF.js";const k={title:"ZTag",component:"z-tag",argTypes:{icon:{control:{type:"select"},options:Object.keys(m).sort()},"--z-tag-text-color":r(),"--z-tag-bg":r()},args:{text:"In progress",expandable:!1,icon:"gear"}},o={render:t=>n`<z-tag
      icon=${t.icon}
