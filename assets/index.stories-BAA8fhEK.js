import{x as v}from"./lit-element-DGXdXVoE.js";import{P as t}from"./index-BBy8evlc.js";import{g as k}from"./storybook-utils-DX4XXC0w.js";import"./index-BmQSwon9.js";import"./index-Cq1ipkkm.js";import{s as w,g as i}from"./chunk-L4EGOTBX-lo-pZyle.js";import"./entry-preview-Cx7Tr7Nx.js";import{d as y,H as T,h as r}from"./index-BZ0rSFNp.js";import"./index-KOgRmbf5.js";import"./utils-CkA37blO.js";import"./breakpoints-p3CVLX0Q.js";import"./index-DrFu-skq.js";const S=":host{--z-tooltip-theme--surface:var(--color-surface01);--z-tooltip-theme--text:var(--color-default-text);--z-tooltip-shadow-filter:drop-shadow(0 1px 2px var(--shadow-color-base));--z-tooltip-padding:var(--space-unit)}z-popover{--z-popover-theme--surface:var(--z-tooltip-theme--surface);--z-popover-theme--text:var(--z-tooltip-theme--text);--z-popover-padding:var(--z-tooltip-padding);--z-popover-shadow-filter:var(--z-tooltip-shadow-filter)}:host([dark]) z-popover{--z-popover-theme--surface:var(--color-surface05);--z-popover-theme--text:var(--color-text-inverse)}",E=class extends T{constructor(){super(),this.__registerHost(),this.__attachShadow(),this.position=t.AUTO,this.dark=!1,this.open=!1,this.closable=!0}onPopoverOpenChange(){this.open=this.popoverEl.open}render(){return r("z-popover",{key:"4d35c14fdc687c3ede128f010475ab3d787fdfa8",ref:o=>this.popoverEl=o,bindTo:this.bindTo,open:this.open,position:this.position,closable:this.closable,center:!0,showArrow:!0},r("slot",{key:"0ad37e903536bbec412625f8e282764331abd43d"}))}static get style(){return S}};y(E,[1,"z-tooltip",{position:[520],dark:[516],open:[1540],bindTo:[8,"bind-to"],closable:[4]},[[0,"openChange","onPopoverOpenChange"]]]);const s={schemaVersion:"1.0.0",modules:[{kind:"javascript-module",path:"",declarations:[{kind:"class",name:"ZTooltip",tagName:"z-tooltip",customElement:!0,members:[{kind:"field",name:"position",type:"any",description:"Tooltip position.",default:"PopoverPosition.AUTO"},{kind:"field",name:"dark",type:"boolean",description:"Enable tooltip dark mode.",default:"false"},{kind:"field",name:"open",type:"boolean",description:"The open state of the tooltip.",default:"false"},{kind:"field",name:"bindTo",type:"any",description:"The selector or the element bound with the tooltip."},{kind:"field",name:"closable",type:"boolean",description:'Reflects `closable` prop of the popover.\n"If true, the popover can be closed by clicking outside of it or pressing the escape key.\nOtherwise, it will be closed only programmatically (by setting `open` to `false`)."',default:"true"}],events:[],cssProperties:[{name:"--z-tooltip-theme--surface",description:"background color of the popover."},{name:"--z-tooltip-theme--text",description:"foreground color of the popover."},{name:"--z-tooltip-shadow-filter",description:"drop-shadow filter of the popover."}]}],exports:[{kind:"js",name:"ZTooltip",declaration:{name:"ZTooltip",module:"src/components/z-tooltip/index.tsx"}},{kind:"custom-element-definition",name:"z-tooltip",declaration:{name:"ZTooltip",module:"src/components/z-tooltip/index.tsx"}}]}]};w({...i()||{},...s,modules:[...(i()||{}).modules||[],...s.modules]});var a=Object.freeze,O=Object.defineProperty,g=(o,x)=>a(O(o,"raw",{value:a(o.slice())})),p,l;const F={title:"ZTooltip",component:"z-tooltip",argTypes:{position:{options:[t.AUTO,t.TOP,t.BOTTOM,t.LEFT,t.RIGHT,t.TOP_LEFT,t.TOP_RIGHT,t.BOTTOM_LEFT,t.BOTTOM_RIGHT],control:{type:"select"}},"--z-tooltip-theme--surface":k()},args:{dark:!1,"--z-tooltip-theme--surface":"var(--color-surface01)",position:t.LEFT},parameters:{docs:{description:{component:'To be sure the algorithm finds the right container, when calculating the position, set its position to `position: relative;`\nOn the following Story, the "position" prop can be set only for the original positions of the `z-tooltip` by design.'}}}},n={render:o=>v(p||(p=g([`
  ...
  render: args => html\`
    ...
    <\/script>
  \`
} satisfies Story`,...(h=(m=e.parameters)==null?void 0:m.docs)==null?void 0:h.source},description:{story:"When `closable` property is set to `false`, you can open the tooltip on hover and still click things outside without closing it.\nIn the Story below, the tooltip is opened hovering the button.",...(z=(b=e.parameters)==null?void 0:b.docs)==null?void 0:z.description}}};const R=["Default","AutocloseOff"];export{e as AutocloseOff,n as Default,R as __namedExportsOrder,F as default};
