import{r as e}from"./lit-CgIPLKVa.js";import{i as t}from"./z-icon-6rrsih2X.js";import{R as n}from"./beans-CNd94UMz.js";import"./z-color-picker-Dy4qFbiR.js";import"./z-tool-PDNmSWER.js";var r={title:`ZTool`,component:`z-tool`,argTypes:{tooltipPosition:{options:Object.values(n),control:{type:`select`}},indicatorColor:{control:`color`},icon:{options:Object.keys(t),control:{type:`select`}}},args:{active:!1,disabled:!1,htmlAriaLabel:`Impostazioni`,icon:`gear`,indicatorColor:``,tooltip:`Impostazioni`,tooltipPosition:n.TOP}},i={render:t=>e`<div class="tool-container">
      <z-tool
        icon=${t.icon}
        tooltip=${t.tooltip}
