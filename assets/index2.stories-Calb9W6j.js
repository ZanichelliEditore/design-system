import{r as e}from"./lit-CgIPLKVa.js";import{n as t}from"./z-icon-6rrsih2X.js";import{n}from"./storybook-utils-DtpJwcUL.js";var r={title:`ZIcon`,component:`z-icon`,argTypes:{fill:{options:n().map(e=>e.replace(`--`,``)),control:{type:`select`}}},args:{name:`download`,height:24,width:24,fill:`color-primary01`}},i={render:t=>e`<z-icon
      name=${t.name}
      height=${t.height}
      width=${t.width}
      fill=${t.fill}
