...
Leave it undefined for the default card.`},{kind:"field",name:"coverIcon",type:"string",description:"Name of the icon to place over the image cover"},{kind:"field",name:"showShadow",type:"boolean",description:"Enable shadow. Default: false.",default:"false"},{kind:"field",name:"clickable",type:"boolean",description:'Enable "clickable" styles like hover background and cursor, focus shadow on the whole card, etc.',default:"false"}],events:[],cssProperties:[{name:"--aspect-ratio",description:"Cover aspect ratio. Default: `1.62`"},{name:"--z-card--border-color",description:"Default: `var(--gray200)`"},{name:"--z-card--color-cover-background",description:"Cover color. Default: `var(--color-surface01)`"},{name:"--z-card--text-background",description:"Background color for the `text` variant. Default: `var(--color-surface01)`"},{name:"--z-card--text-border-radius",description:"Default: `none`"},{name:"--z-card--text-border",description:"Configure CSS `border`. Default: `none`"},{name:"--z-card--text-padding",description:"Configure CSS `padding`. Default: `none`"}],slots:[{name:"cover",description:"Image cover"},{name:"metadata",description:"Metadata"},{name:"title",description:"Title"},{name:"text",description:"Text content"},{name:"action",description:"Actions"}]}],exports:[{kind:"js",name:"ZCard",declaration:{name:"ZCard",module:"src/components/z-card/index.tsx"}},{kind:"custom-element-definition",name:"z-card",declaration:{name:"ZCard",module:"src/components/z-card/index.tsx"}}]}]};W({...h()||{},...b,modules:[...(h()||{}).modules||[],...b.modules]});var p=Object.freeze,O=Object.defineProperty,Z=(t,P)=>p(O(t,"raw",{value:p(t.slice())})),m;const G={title:"ZCard",component:"z-card",argTypes:{variant:{control:{type:"inline-radio",labels:{null:"default"}},options:[null,...Object.values(l)]}},args:{variant:null,showShadow:!1,clickable:!1}},e={render:t=>o`
  ...
  `},s={args:{"--z-card--text-border":"2px solid var(--gray800)","--z-card--text-border-radius":"4px","--z-card--text-padding":"16px 8px"},parameters:{controls:{exclude:["variant"]}},render:t=>o`<z-card
      ...
      .showShadow="${t.showShadow}"
      .clickable="${t.clickable}"
      style=${A({"--z-card--text-background":"var(--color-white)","--z-card--text-border":`${t["--z-card--text-border"]}`,"--z-card--text-border-radius":`${t["--z-card--text-border-radius"]}`,"--z-card--text-padding":`${t["--z-card--text-padding"]}`})}
    >
      <h2
        class="body-5"
        slot="metadata"
  ...
  `])),t.variant)};var u,v,g;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: args => html\`
    <z-card
      class="demo-card"
  ...
  \`
} satisfies Story`,...(g=(v=e.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};var f,z,x;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
  ...
  render: args => html\`
    ...
    <div id="click-alert-container">Card click count: 0</div>
  \`
} satisfies Story`,...(T=(j=i.parameters)==null?void 0:j.docs)==null?void 0:T.source}}};const J=["WithImage","WithImageAndIcon","ColorCover","TextVariantPrimaryBackground","TextVariantWhiteBackgroundAndBordered","WithImageAndClickListener"];export{r as ColorCover,c as TextVariantPrimaryBackground,s as TextVariantWhiteBackgroundAndBordered,e as WithImage,i as WithImageAndClickListener,n as WithImageAndIcon,J as __namedExportsOrder,G as default};
