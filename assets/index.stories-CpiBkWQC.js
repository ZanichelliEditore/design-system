import{x as f}from"./lit-element-DGXdXVoE.js";import"./index-BG26UsES.js";import"./index-DG5VvcyV.js";import{s as x,g as u}from"./chunk-L4EGOTBX-lo-pZyle.js";import"./entry-preview-Cx7Tr7Nx.js";import{d as y,H as z,h as t,a as S}from"./index-BZ0rSFNp.js";import{B as A}from"./index-CjlG6izv.js";import"./index-DrFu-skq.js";const w=`html{scroll-behavior:smooth}z-anchor-navigation nav{display:none;flex-direction:column;justify-content:flex-start;row-gap:calc(var(--space-unit) / 2)}z-anchor-navigation[collapsed] nav{display:flex;margin-top:var(--space-unit)}z-anchor-navigation nav a{display:-webkit-box;overflow:clip;width:100%;box-sizing:border-box;padding:calc(var(--space-unit) * 1.5) calc(var(--space-unit) * 2);-webkit-box-orient:vertical;color:inherit;font-weight:inherit;-webkit-line-clamp:2;overflow-clip-margin:content-box;text-decoration:none}z-anchor-navigation nav * a:not(:only-child){padding-right:calc(var(--space-unit) * 5)}@supports not (overflow-clip-margin: content-box){z-anchor-navigation nav a{display:inline-block;overflow:hidden;-webkit-line-clamp:none;text-overflow:ellipsis;white-space:nowrap}}z-anchor-navigation nav>*{position:relative;border-left:var(--border-size-large) solid var(--color-surface04);color:var(--color-default-text);font-family:var(--font-family-sans);transition:background-color 0.3s ease-in-out,
    border-color 0.3s ease-in-out,
    color 0.3s ease-in-out}z-anchor-navigation nav>[data-current]{border-left-color:var(--color-primary01);color:var(--color-link-primary);font-weight:var(--font-sb)}z-anchor-navigation nav>*>*:is(z-button,button){position:absolute;top:50%;right:0;transform:translateY(-50%);transition:opacity 0.3s ease-in-out}z-anchor-navigation nav>*:focus:focus-visible,z-anchor-navigation nav>*>*:focus:focus-visible{box-shadow:var(--shadow-focus-primary);outline:none}z-anchor-navigation nav button{padding:0;border:none;margin:0;background-color:transparent}@media (min-width: 768px){z-anchor-navigation z-button.toggle{display:none !important}z-anchor-navigation nav{display:flex}z-anchor-navigation nav>*>:is(z-button,button){opacity:0;pointer-events:none}@media (hover: hover){z-anchor-navigation nav>:is([data-current],:hover,:focus,:focus-within)>:is(z-button,button){opacity:1;pointer-events:unset}z-anchor-navigation nav>*:hover{border-left-color:var(--color-hover-secondary);background-color:var(--color-hover-surface);color:var(--color-hover-link)}}z-anchor-navigation[hide-unselected] nav>*:not([data-current],:hover,:focus,:focus-within){color:transparent;fill:transparent}}`,C=class extends z{constructor(){super(),this.__registerHost(),this.hideUnselected=!1,this.autoCurrent=!0,this.collapsed=!1}setCurrent(){const e=Array.from(this.nav.querySelectorAll("a")).find(i=>i.href===this.host.ownerDocument.location.href);Array.from(this.nav.children).forEach(i=>{const o=i instanceof HTMLAnchorElement?i:i.querySelector("a"),s=o===e;o.setAttribute("aria-current",s.toString()),i.toggleAttribute("data-current",s)})}toggleCollapsed(){this.collapsed=!this.collapsed}componentDidLoad(){this.autoCurrent&&(window.addEventListener("hashchange",this.setCurrent.bind(this)),this.setCurrent())}disconnectedCallback(){window.removeEventListener("hashchange",this.setCurrent)}render(){return t(S,{key:"9b0ddfb60edd3c44243885390a1698e6c9887478",collapsed:this.collapsed},t("z-button",{key:"6bd4c5c9ad2a49b2bd1d103bf0f7de076dbf1061",class:"toggle",variant:A.SECONDARY,icon:this.collapsed?"chevron-up":"chevron-down",onClick:this.toggleCollapsed.bind(this)},"salta a"),t("nav",{key:"b629e3fa48a03b67c24706c9d468c97a1129baab",ref:e=>this.nav=e},t("slot",{key:"cce00ff8e78994407169ea312ace517a0c6f3812"})))}get host(){return this}static get style(){return w}};y(C,[4,"z-anchor-navigation",{hideUnselected:[516,"hide-unselected"],autoCurrent:[4,"auto-current"],collapsed:[32]}]);const r={schemaVersion:"1.0.0",modules:[{kind:"javascript-module",path:"",declarations:[{kind:"class",name:"ZAnchorNavigation",tagName:"z-anchor-navigation",customElement:!0,members:[{kind:"field",name:"hideUnselected",type:"boolean",description:`If enabled, the text of each anchor will be hidden unless
