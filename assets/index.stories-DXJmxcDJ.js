  ...
  render: args => <Fragment>
      <z-modal {...args} style={extractCSSVars(args)}>
        <div slot="modalContent">
          ...
          <z-select items='[{"id":"item_1","name":"first item","selected":false},{"id":"item_2","name":"second item","selected":true},{"id":"item_3","name":"disabled item","selected":false,"disabled":true},{"id":"item_4","name":"fourth item","selected":false}]' label="this is the label" placeholder="select placeholder" message="helper text" autocomplete={false} noresultslabel="Nessun risultato"></z-select>
        </div>
      </z-modal>
      <z-button onClick={openZModal}>apri modale</z-button>
    </Fragment>
} satisfies Story`,...g.parameters?.docs?.source}}},_=[`ShortText`,`LongText`]}))();export{g as LongText,h as ShortText,_ as __namedExportsOrder,f as default};