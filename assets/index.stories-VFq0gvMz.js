import{x as l}from"./lit-element-DGXdXVoE.js";import{B as i,C as s}from"./index-C_NTAvuu.js";import"./index-CyXq-ivh.js";import"./index-CAsmEsw1.js";import"./chunk-GKNNPQCW-BkHQSocK.js";import"./index-BJyMe-bF.js";const x={title:"ZButton",component:"z-button",args:{variant:i.PRIMARY,size:s.BIG,disabled:!1,icon:"download",ariaLabel:"Clicca sul bottone",role:"button"},argTypes:{variant:{options:Object.values(i),control:{type:"inline-radio"}},size:{options:Object.values(s),control:{type:"inline-radio"}}},render:a=>l`<z-button
      variant=${a.variant}
      size=${a.size}
      disabled=${a.disabled}
      icon=${a.icon}
