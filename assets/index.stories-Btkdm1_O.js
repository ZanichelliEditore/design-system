import{x as s}from"./lit-element-DGXdXVoE.js";const t={title:"ZScrollbar",parameters:{docs:{description:{component:`<p>If applied to elements with CSS property "overflow:scroll", the class will apply to both the vertical AND the horizontal scrollbars. To avoid this, use "overflow-y" instead.</p>
Bear in mind that the scrollbar behaves in different ways depending on the browser: <br />
  ...
  \`
}`,...(r=(l=i.parameters)==null?void 0:l.docs)==null?void 0:r.source}}};const a=["Default"];export{i as Default,a as __namedExportsOrder,t as default};
