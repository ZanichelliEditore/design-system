import{n as e}from"./chunk-DnJy8xQt.js";import{Z as t,rt as n}from"./iframe-C2Ij1bKG.js";import{K as r,b as i,f as a}from"./beans-zckFsBZy.js";import{i as o,s}from"./iconset-BfOAkyaN.js";import{n as c,t as l}from"./index15-YRuWWKpC.js";var u,d=e((()=>{c(),u=l})),f=e((()=>{})),p,m,h;e((()=>{t(),r(),s(),d(),f(),p={title:`ZInfoReveal`,component:u,argTypes:{icon:{control:{type:`select`},options:Object.keys(o).sort()},size:{control:{type:`inline-radio`},options:Object.values(a)},position:{options:Object.values(i),control:{type:`inline-radio`}}},parameters:{layout:`centered`}},m={args:{label:``,icon:`informationsource`,size:a.BIG,position:i.TOP_RIGHT},render:e=>n(`div`,{class:`z-info-reveal-story-wrapper`},n(`z-button`,{size:e.size},`Button`),n(`z-info-reveal`,e,n(`div`,null,`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quem enim ardorem studii censetis fuisse in Archimede, qui dum in pulvere quaedam describit attentius, ne patriam quidem captam esse senserit?`)))},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    label: "",
