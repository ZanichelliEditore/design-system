import{x as o}from"./lit-element-DGXdXVoE.js";import{Q as u}from"./index-C_NTAvuu.js";import"./index-DlGlwqHM.js";import{s as z,g as r}from"./chunk-GKNNPQCW-BkHQSocK.js";import{d as D,H as T,c,h as t,a as N}from"./index-BJyMe-bF.js";const P=':host{--z-notification--top-offset:0;display:flex;width:100%;box-sizing:border-box;align-items:flex-start;padding:calc(var(--space-unit) * 2);border-bottom:var(--border-size-medium) solid var(--color-surface03);font-family:var(--font-family-sans);outline:none}:host[sticky]{position:sticky;top:var(--z-notification--top-offset)}:host[sticky],:host([showshadow]){box-shadow:var(--shadow-3)}:host([type="success"]){background:var(--color-success-inverse)}:host([type="warning"]){background:var(--color-warning-inverse)}:host([type="error"]){background:var(--color-error-inverse)}.status-icon,.close-button{display:flex;height:20px;align-items:center}:host([type="success"]) .status-icon{fill:var(--color-success01)}:host([type="warning"]) .status-icon{fill:var(--color-warning02)}:host([type="error"]) .status-icon{fill:var(--color-error01)}:host>button,.content-container>button{padding:0;border:none;margin:0;background:transparent;cursor:pointer;font-family:inherit}.status-icon+.content-container{margin-left:var(--space-unit)}.content-container{display:flex;flex:1 auto;flex-wrap:wrap;align-items:baseline;justify-content:space-between;row-gap:calc(var(--space-unit) * 2)}.content-text{max-width:800px;color:var(--color-default-text);font-size:var(--font-size-2);font-weight:var(--font-rg);letter-spacing:0.16px;line-height:20px}.action-button{color:var(--color-primary01);font-size:var(--font-size-1);font-weight:var(--font-sb);letter-spacing:0.32px;line-height:16px}.action-button:focus{box-shadow:var(--shadow-focus-primary);outline:none !important}.content-container+.close-button{margin-left:calc(var(--space-unit) * 2)}.close-button z-icon{fill:var(--color-primary01)}@media only screen and (min-width: 768px){.content-container{flex-wrap:nowrap}.content-text+.action-button{margin-left:calc(var(--space-unit) * 5)}}',E=class extends T{handleActionButtonClick(e){e.preventDefault(),this.notificationAction.emit()}handleCloseButtonClick(e){e.preventDefault(),this.notificationClose.emit()}constructor(){super(),this.__registerHost(),this.__attachShadow(),this.notificationAction=c(this,"notificationAction",7),this.notificationClose=c(this,"notificationClose",7),this.contenticonname=void 0,this.actiontext=void 0,this.type=void 0,this.showclose=!1,this.showshadow=!1,this.sticky=!1,this.handleActionButtonClick=this.handleActionButtonClick.bind(this),this.handleCloseButtonClick=this.handleCloseButtonClick.bind(this)}render(){var e;return t(N,{key:"9137abe58fe1b80cb97c8c01c790b45501c96870"},this.contenticonname&&t("z-icon",{key:"cd512853256e7a5e3beb4d80aa205eac31312b2f",class:"status-icon",name:this.contenticonname,width:16,height:16}),t("div",{key:"5a84041e003c16ad18bb1ea25090d9583d34f6a7",class:"content-container"},t("div",{key:"e979649f61acc12438edbf6ee17b236b03d0cd60",class:"content-text"},t("slot",{key:"686be64dc0e518c1b6fd4973bd80ac01ccc9d84e"})),!!(!((e=this.actiontext)===null||e===void 0)&&e.trim())&&t("button",{key:"1844eb0ad68ba15bf742a2ca37164cb02d2e2a38",class:"action-button",type:"button",onClick:this.handleActionButtonClick},this.actiontext)),this.showclose&&t("button",{key:"0696b1393d8a97145a0529e44d4f56fe35795436",class:"close-button",type:"button",onClick:this.handleCloseButtonClick},t("z-icon",{key:"0bbdb99c939b7424e2bd7fba20307714c0cfeb39",name:"multiply-circle",width:16,height:16})))}static get style(){return P}};D(E,[1,"z-notification",{contenticonname:[1],actiontext:[1],type:[520],showclose:[4],showshadow:[516],sticky:[516]}]);const l={schemaVersion:"1.0.0",modules:[{kind:"javascript-module",path:"",declarations:[{kind:"class",name:"ZNotification",tagName:"z-notification",customElement:!0,members:[{kind:"field",name:"contenticonname",type:"string",description:"Name of the icon on the left of the content"},{kind:"field",name:"actiontext",type:"string",description:"Action button text"},{kind:"field",name:"type",type:"any",description:"Alert variant type"},{kind:"field",name:"showclose",type:"boolean",description:"Enable close icon",default:"false"},{kind:"field",name:"showshadow",type:"boolean",description:"Enable shadow.",default:"false"},{kind:"field",name:"sticky",type:"boolean",description:"Enable sticky notification bar.",default:"false"}],events:[{kind:"event",name:"notificationAction",description:"Call to action clicked"},{kind:"event",name:"notificationClose",description:"Close button clicked"}],cssProperties:[{name:"--z-notification--top-offset",description:"The top offset of the notification. Use it when `sticky` prop is set to `true` and you need the notification to stay under other sticky elements. Default: 0px."}],slots:[{name:"-",description:"The text of the notification."}]}],exports:[{kind:"js",name:"ZNotification",declaration:{name:"ZNotification",module:"src/components/z-notification/index.tsx"}},{kind:"custom-element-definition",name:"z-notification",declaration:{name:"ZNotification",module:"src/components/z-notification/index.tsx"}}]}]};z({...r()||{},...l,modules:[...(r()||{}).modules||[],...l.modules]});const I={title:"ZNotification",component:"z-notification",argTypes:{type:{control:{type:"inline-radio"},options:Object.values(u)}},args:{contenticonname:"checkmark-circle-filled",actiontext:"Annulla",showclose:!1,sticky:!1,type:u.SUCCESS}},s={render:e=>o`
    <z-notification
  ...
  \`
} satisfies Story`,...(C=(w=n.parameters)==null?void 0:w.docs)==null?void 0:C.source},description:{story:"To use the inline variant set the `sticky` property to `false`.",...(S=($=n.parameters)==null?void 0:$.docs)==null?void 0:S.description}}};const L=["Default","LongText","BannerVariant","InlineVariant"];export{i as BannerVariant,s as Default,n as InlineVariant,a as LongText,L as __namedExportsOrder,I as default};
