import{x as d}from"./lit-element-DGXdXVoE.js";import{o as z}from"./style-map-DWZVjDvr.js";import{P as r}from"./index-CjlG6izv.js";import{a as t}from"./storybook-utils-DAVCxM-F.js";import"./index-BG26UsES.js";import"./index-DG5VvcyV.js";import"./index-CTXxCIft.js";import"./directive-CF8sV3Lr.js";import"./chunk-L4EGOTBX-lo-pZyle.js";import"./entry-preview-Cx7Tr7Nx.js";import"./index-DrFu-skq.js";import"./index-BZ0rSFNp.js";var p=Object.freeze,f=Object.defineProperty,g=(e,h)=>p(f(e,"raw",{value:p(e.slice())})),i,s;const w={title:"ZPopover",component:"z-popover",argTypes:{position:{options:Object.values(r),control:{type:"select"}},"--z-popover-theme--surface":t(),"--z-popover-theme--text":t()},args:{"--z-popover-theme--surface":"var(--color-surface01)","--z-popover-theme--text":"var(--color-default-text)"},parameters:{docs:{description:{component:"To be sure the AUTO algorithm finds the right container when calculating the position, set its container's position to `position: relative;`"}}}},o={args:{position:r.RIGHT_BOTTOM},render:e=>d(i||(i=g([`
  ...
  render: args => html\`
    ...
    <\/script>
  \`
} satisfies Story`,...(m=(u=n.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};const M=["ContextualMenuLike","TooltipLike"];export{o as ContextualMenuLike,n as TooltipLike,M as __namedExportsOrder,w as default};
