import{x as o}from"./lit-element-DGXdXVoE.js";import{J as u}from"./index-CjlG6izv.js";import"./index-DG5VvcyV.js";import{s as z,g as r}from"./chunk-L4EGOTBX-lo-pZyle.js";import"./entry-preview-Cx7Tr7Nx.js";import{d as D,H as T,c,h as t,a as N}from"./index-BZ0rSFNp.js";import"./index-DrFu-skq.js";const P=':host{--z-notification--top-offset:0;display:flex;width:100%;box-sizing:border-box;align-items:flex-start;padding:calc(var(--space-unit) * 2);border-bottom:var(--border-size-medium) solid var(--color-surface03);font-family:var(--font-family-sans);outline:none}:host[sticky]{position:sticky;top:var(--z-notification--top-offset)}:host[sticky],:host([showshadow]){box-shadow:var(--shadow-3)}:host([type="success"]){background:var(--color-success-inverse)}:host([type="warning"]){background:var(--color-warning-inverse)}:host([type="error"]){background:var(--color-error-inverse)}.status-icon,.close-button{display:flex;height:20px;align-items:center}:host([type="success"]) .status-icon{fill:var(--color-success01)}:host([type="warning"]) .status-icon{fill:var(--color-warning02)}:host([type="error"]) .status-icon{fill:var(--color-error01)}:host>button,.content-container>button{padding:0;border:none;margin:0;background:transparent;cursor:pointer;font-family:inherit}.status-icon+.content-container{margin-left:var(--space-unit)}.content-container{display:flex;flex:1 auto;flex-wrap:wrap;align-items:baseline;justify-content:space-between;row-gap:calc(var(--space-unit) * 2)}.content-text{max-width:800px;color:var(--color-default-text);font-size:var(--font-size-2);font-weight:var(--font-rg);letter-spacing:0.16px;line-height:20px}.action-button{color:var(--color-primary01);font-size:var(--font-size-1);font-weight:var(--font-sb);letter-spacing:0.32px;line-height:16px}.action-button:focus{box-shadow:var(--shadow-focus-primary);outline:none !important}.content-container+.close-button{margin-left:calc(var(--space-unit) * 2)}.close-button z-icon{fill:var(--color-primary01)}@media only screen and (min-width: 768px){.content-container{flex-wrap:nowrap}.content-text+.action-button{margin-left:calc(var(--space-unit) * 5)}}',Q=class extends T{handleActionButtonClick(e){e.preventDefault(),this.notificationAction.emit()}handleCloseButtonClick(e){e.preventDefault(),this.notificationClose.emit()}constructor(){super(),this.__registerHost(),this.__attachShadow(),this.notificationAction=c(this,"notificationAction",7),this.notificationClose=c(this,"notificationClose",7),this.contenticonname=void 0,this.actiontext=void 0,this.type=void 0,this.showclose=!1,this.showshadow=!1,this.sticky=!1,this.handleActionButtonClick=this.handleActionButtonClick.bind(this),this.handleCloseButtonClick=this.handleCloseButtonClick.bind(this)}render(){var e;return t(N,{key:"05f5b12174e213c65e74a3b09aeec09e686f11f4"},this.contenticonname&&t("z-icon",{key:"e8df46dc742a160868f47f4173db4b2bf9766fc3",class:"status-icon",name:this.contenticonname,width:16,height:16}),t("div",{key:"6ac39a9e372f556c3e05ce3a9fbbec7145012623",class:"content-container"},t("div",{key:"18168928dfd2a453307127031cece2270fb61152",class:"content-text"},t("slot",{key:"686d35e62745a839beb7154b98bf9d783b787c71"})),!!(!((e=this.actiontext)===null||e===void 0)&&e.trim())&&t("button",{key:"93c95c6c1121e30a1e7b645320de3c88f38e75ed",class:"action-button",type:"button",onClick:this.handleActionButtonClick},this.actiontext)),this.showclose&&t("button",{key:"833e18cee5b3baa314f8c60de09faea29a8195e5",class:"close-button",type:"button",onClick:this.handleCloseButtonClick},t("z-icon",{key:"87b043cd09f352488f01b8ec07bdef13f904232d",name:"multiply-circle",width:16,height:16})))}static get style(){return P}};D(Q,[1,"z-notification",{contenticonname:[1],actiontext:[1],type:[520],showclose:[4],showshadow:[516],sticky:[516]}]);const l={schemaVersion:"1.0.0",modules:[{kind:"javascript-module",path:"",declarations:[{kind:"class",name:"ZNotification",tagName:"z-notification",customElement:!0,members:[{kind:"field",name:"contenticonname",type:"string",description:"Name of the icon on the left of the content"},{kind:"field",name:"actiontext",type:"string",description:"Action button text"},{kind:"field",name:"type",type:"any",description:"Alert variant type"},{kind:"field",name:"showclose",type:"boolean",description:"Enable close icon",default:"false"},{kind:"field",name:"showshadow",type:"boolean",description:"Enable shadow.",default:"false"},{kind:"field",name:"sticky",type:"boolean",description:"Enable sticky notification bar.",default:"false"}],events:[{kind:"event",name:"notificationAction",description:"Call to action clicked"},{kind:"event",name:"notificationClose",description:"Close button clicked"}],cssProperties:[{name:"--z-notification--top-offset",description:"The top offset of the notification. Use it when `sticky` prop is set to `true` and you need the notification to stay under other sticky elements. Default: 0px."}],slots:[{name:"-",description:"The text of the notification."}]}],exports:[{kind:"js",name:"ZNotification",declaration:{name:"ZNotification",module:"src/components/z-notification/index.tsx"}},{kind:"custom-element-definition",name:"z-notification",declaration:{name:"ZNotification",module:"src/components/z-notification/index.tsx"}}]}]};z({...r()||{},...l,modules:[...(r()||{}).modules||[],...l.modules]});const _={title:"ZNotification",component:"z-notification",argTypes:{type:{control:{type:"inline-radio"},options:Object.values(u)}},args:{contenticonname:"checkmark-circle-filled",actiontext:"Annulla",showclose:!1,sticky:!1,type:u.SUCCESS}},s={render:e=>o`
  ...
  \`
} satisfies Story`,...(C=(w=n.parameters)==null?void 0:w.docs)==null?void 0:C.source},description:{story:"To use the inline variant set the `sticky` property to `false`.",...(S=($=n.parameters)==null?void 0:$.docs)==null?void 0:S.description}}};const Z=["Default","LongText","BannerVariant","InlineVariant"];export{i as BannerVariant,s as Default,n as InlineVariant,a as LongText,Z as __namedExportsOrder,_ as default};
