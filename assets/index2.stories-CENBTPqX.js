import{n as e}from"./chunk-DnJy8xQt.js";import{$ as t,Q as n,X as r,et as i,it as a,nt as o,rt as s}from"./iframe-CjBLtZOw.js";import{Y as c,j as l}from"./beans-DwSZ05Mp.js";import{o as u,t as d}from"./storybook-utils-X33q-Ruv.js";import{n as f}from"./index3-D4sd3q6W.js";var p,m,h,g=e((()=>{s(),f(),p=()=>`:host{--z-notification--top-offset:0;--z-notification--content-max-width:100%;display:block;width:100%}.main-container{display:flex;max-width:var(--z-notification--content-max-width);align-items:flex-start;padding:calc(var(--space-unit) * 2) var(--z-notification--inline-padding, calc(var(--space-unit) * 2));margin:0 auto;background-color:transparent;font-family:var(--font-family-sans)}:host([sticky]){position:sticky;top:var(--z-notification--top-offset)}:host([sticky]),:host([showshadow]){box-shadow:var(--shadow-3)}:host([type="success"]){background:var(--color-inverse-success)}:host([type="warning"]){background:var(--color-inverse-warning)}:host([type="error"]){background:var(--color-inverse-error)}.status-icon,.close-button{display:flex;height:20px;align-items:center}:host([type="success"]) .status-icon{fill:var(--color-default-success)}:host([type="warning"]) .status-icon{fill:var(--color-default-warning)}:host([type="error"]) .status-icon{fill:var(--color-default-error)}:host([borderposition="bottom"]){border-bottom:var(--border-size-medium) solid var(--color-surface03)}:host([borderposition="top"]){border-top:var(--border-size-medium) solid var(--color-surface03)}button{padding:0;border:none;margin:0;background:transparent;cursor:pointer;font-family:inherit}.status-icon+.content-container{margin-left:var(--space-unit)}.content-container{display:flex;flex:1 auto;flex-wrap:wrap;align-items:baseline;justify-content:space-between;row-gap:calc(var(--space-unit) * 2)}.content-text{width:100%;color:var(--color-default-text);font-size:var(--font-size-2);font-weight:var(--font-rg);letter-spacing:0.16px;line-height:1.4}.action-button{color:var(--color-primary01);font-size:var(--font-size-1);font-weight:var(--font-sb);letter-spacing:0.32px;line-height:1.333;outline:none}.action-button:focus-visible{box-shadow:var(--shadow-focus-primary)}.content-container+.close-button{margin-left:calc(var(--space-unit) * 2)}.close-button z-icon{fill:var(--color-primary01)}@media (min-width: 768px){.content-container{flex-wrap:nowrap}.content-text+.action-button{margin-left:calc(var(--space-unit) * 5)}}`,m=a(class extends n{handleActionButtonClick(e){e.preventDefault(),this.notificationAction.emit()}handleCloseButtonClick(e){e.preventDefault(),this.notificationClose.emit()}constructor(e){super(),e!==!1&&this.__registerHost(),this.__attachShadow(),this.notificationAction=i(this,`notificationAction`,7),this.notificationClose=i(this,`notificationClose`,7),this.showclose=!1,this.showshadow=!1,this.sticky=!1,this.borderposition=`bottom`,this.handleActionButtonClick=this.handleActionButtonClick.bind(this),this.handleCloseButtonClick=this.handleCloseButtonClick.bind(this)}render(){return o(t,{key:`dc72b8c965151d9928aa0ddede2796c09fdc5da5`},o(`div`,{key:`a3492b0ec98ed322e2e6b41b10ae7f7141a794f1`,class:`main-container`},this.contenticonname&&o(`z-icon`,{key:`a6754bf4dd0803636e223465e8e0f7d3f0289fd5`,class:`status-icon`,name:this.contenticonname,width:16,height:16}),o(`div`,{key:`b0761286fda860b2531b97f3550160cbaba31c69`,class:`content-container`},o(`div`,{key:`ea7441390672258a330fb137c17376c0f736b022`,class:`content-text`},o(`slot`,{key:`63c90279f0a02606bace42317f9329f4a92b0523`})),!!this.actiontext?.trim()&&o(`button`,{key:`510ab69472d1e530aef292bfa416f50a7f222d0b`,class:`action-button`,type:`button`,onClick:this.hand
et magna velit. Duis eleifend dolor at sagittis ornare. Aenean commodo massa enim, ac varius augue varius quis.`,y={title:`ZNotification`,component:h,argTypes:{type:{control:{type:`inline-radio`},options:Object.values(l)},borderposition:{control:{type:`inline-radio`},options:[`top`,`bottom`]}},args:{"--z-notification--content-max-width":`100%`,contenticonname:`checkmark-circle-filled`,borderposition:`bottom`,actiontext:`Annulla`,showclose:!1,sticky:!1,type:l.SUCCESS}},b={render:e=>o(`z-notification`,{...e,style:d(e)},o(`div`,{class:`notification-container`},o(`strong`,null,`NOVITÀ`),`: Testo che descrive le novità.`))},x={render:e=>o(`z-notification`,{...e,style:d(e)},o(`div`,null,`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent rhoncus magna imperdiet malesuada interdum. Curabitur volutpat mi purus, in maximus nisl volutpat quis. Suspendisse sed vestibulum magna. Quisque molestie, justo non pretium egestas, lorem elit malesuada turpis, et malesuada sapien nunc a urna. Curabitur sagittis augue turpis, eu consectetur purus consectetur vitae.`))},S={args:{"--z-notification--top-offset":`0`},parameters:{controls:{exclude:[`sticky`]}},render:e=>o(`div`,{class:`banner-notification-demo`},o(`z-notification`,{...e,style:d(e),sticky:!0},`Questo è il testo della notifica`),o(`div`,{class:`heading-1-sb`},`Titolo della pagina`),o(`div`,{class:`body-1`},v))},C={args:{"--z-notification--content-max-width":`768px`},render:e=>o(`div`,null,o(`z-notification`,{...e,style:d(e)},o(`div`,null,`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent rhoncus magna imperdiet malesuada interdum. Curabitur volutpat mi purus, in maximus nisl volutpat quis.`)),o(`div`,{class:`z-notification-demo-page`,style:{"max-width":e[`--z-notification--content-max-width`]}},o(`div`,{class:`heading-1`},`Titolo della pagina`),o(`div`,{class:`body-1`},v)))},w={parameters:{controls:{exclude:[`sticky`]}},render:e=>o(`div`,{class:`inline-notification-demo`},o(`z-notification`,{...e,style:d(e),sticky:!1},`Questo è il testo della notifica`),o(`div`,{class:`content`},o(`div`,{class:`heading-1`},`Titolo della scheda`),o(`div`,{class:`body-1`},`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent rhoncus magna imperdiet malesuada interdum. Curabitur volutpat mi purus, in maximus nisl volutpat quis. Suspendisse sed vestibulum magna.`)))},T={args:{borderposition:`top`},render:e=>o(`div`,{class:`z-notification-border-position-demo`},o(`z-notification`,{...e,style:d(e)},o(`div`,{class:`notification-container`},o(`strong`,null,`NOVITÀ`),`: Testo che descrive le novità.`)))},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  render: args => <z-notification {...args} style={extractCSSVars(args)}>
  ...
  render: args => <div class="banner-notification-demo">
      <z-notification {...args} style={extractCSSVars(args)} sticky={true}>
  ...
  render: args => <div>
      <z-notification {...args} style={extractCSSVars(args)}>
        <div>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent rhoncus magna imperdiet malesuada interdum.
          Curabitur volutpat mi purus, in maximus nisl volutpat quis.
        </div>
      </z-notification>
      <div class="z-notification-demo-page" style={{
      "max-width": args["--z-notification--content-max-width"]
    }}>
  ...
  render: args => <div class="inline-notification-demo">
      <z-notification {...args} style={extractCSSVars(args)} sticky={false}>
        Questo è il testo della notifica
      </z-notification>
      <div class="content">
...
} satisfies Story`,...w.parameters?.docs?.source},description:{story:"To have an inline notification keep the `sticky` property set to `false`.",...w.parameters?.docs?.description}}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  args: {
    borderposition: "top"
  },
  render: args => <div class="z-notification-border-position-demo">
      <z-notification {...args} style={extractCSSVars(args)}>
        <div class="notification-container">
          <strong>NOVITÀ</strong>: Testo che descrive le novità.
        </div>
...
} satisfies Story`,...T.parameters?.docs?.source},description:{story:`The position of the border can be changed to correctly display the notification when put on the bottom of the screen.`,...T.parameters?.docs?.description}}},E=[`Default`,`LongText`,`StickyBanner`,`CenteredContent`,`Inline`,`BorderPosition`]}))();export{T as BorderPosition,C as CenteredContent,b as Default,w as Inline,x as LongText,S as StickyBanner,E as __namedExportsOrder,y as default};