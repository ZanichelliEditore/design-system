import{x as i}from"./lit-element-DGXdXVoE.js";import{C as t}from"./index-CudiBDUm.js";import{a as f}from"./storybook-utils-DX4XXC0w.js";import"./chunk-L4EGOTBX-lo-pZyle.js";import"./entry-preview-Cx7Tr7Nx.js";import"./index-DrFu-skq.js";import"./index-jSWaPMNY.js";import"./iframe-C8K8X7fj.js";const S={title:"ZIcon",component:"z-icon",argTypes:{fill:{options:f().map(o=>o.replace("--","")),control:{type:"select"}}},args:{name:"download",height:24,width:24,fill:"color-primary01"}},r={render:o=>i`<z-icon
      name=${o.name}
      height=${o.height}
      width=${o.width}
      fill=${o.fill}
