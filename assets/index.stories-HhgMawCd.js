import{x as d}from"./lit-element-DGXdXVoE.js";import{B as s,C as c,I as l}from"./index-C0TNZEjZ.js";import"./index-B6eQiPIy.js";import"./index-Bo_H2aQL.js";import"./chunk-L4EGOTBX-lo-pZyle.js";import"./entry-preview-Cx7Tr7Nx.js";import"./index-DrFu-skq.js";import"./index-CedYZwFP.js";import"./iframe-DzRr37qK.js";const G={title:"ZButton",component:"z-button",args:{variant:s.PRIMARY,size:c.BIG,disabled:!1,icon:"download",iconPosition:l.LEFT,ariaLabel:"Clicca sul bottone",htmlrole:"button"},argTypes:{variant:{options:Object.values(s),control:{type:"inline-radio"}},size:{options:Object.values(c),control:{type:"inline-radio"}},iconPosition:{options:Object.values(l),control:{type:"inline-radio"}}},render:o=>d`<z-button
      variant=${o.variant}
      size=${o.size}
      disabled=${o.disabled}
      icon=${o.icon}
...
} satisfies Story`,...(T=(k=t.parameters)==null?void 0:k.docs)==null?void 0:T.source}}};const Y=["Primary","SecondaryXSmall","TertiarySmall","IconOnly","LinkButton","IconRight"];export{i as IconOnly,t as IconRight,e as LinkButton,r as Primary,a as SecondaryXSmall,n as TertiarySmall,Y as __namedExportsOrder,G as default};
