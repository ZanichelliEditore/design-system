import"./lit-element--ufgQf_M.js";import{x as s}from"./lit-html-rc9TYZL2.js";const a={title:"ZScrollbar",parameters:{docs:{description:{component:`<p>If applied to elements with CSS property "overflow:scroll", the class will apply to both the vertical AND the horizontal scrollbars. To avoid this, use "overflow-y" instead.</p>
Bear in mind that the scrollbar behaves in different ways depending on the browser: <br />
  ...
  `};var e,l,r;i.parameters={...i.parameters,docs:{...(e=i.parameters)==null?void 0:e.docs,source:{originalSource:`{
  render: () => html\`
    <div class="z-scrollbar-story">
      <div class="scrollbar-container z-scrollbar">
        <p>
  ...
  \`
}`,...(r=(l=i.parameters)==null?void 0:l.docs)==null?void 0:r.source}}};const n=["Default"];export{i as Default,n as __namedExportsOrder,a as default};
