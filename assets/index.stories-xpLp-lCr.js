import{n as e}from"./chunk-DnJy8xQt.js";import{dt as t,gt as n,ut as r}from"./iframe-CcPk1Sjy.js";import{K as i,M as a,R as o}from"./beans-zckFsBZy.js";import{n as s,o as c,t as l}from"./storybook-utils-BCDbkA4t.js";import{t as u}from"./internal-B2hQ6mZe.js";var d=e((()=>{})),f,p,m,h,g,_,v,y,b,x,S;e((()=>{r(),u(),i(),c(),d(),f=e=>{let t=e.target.closest(`.popover-container`)?.querySelector(`z-popover`);t&&(t?.open?t.open=!1:t.open=!0)},p=e=>{if(e.draggable)return;let t=0,n=0,r=!1,i={x:0,y:0};e.style.position=`absolute`,e.draggable=!0,e.addEventListener(`mousedown`,a=>{a.preventDefault(),a.stopPropagation(),r=!0,t=e.offsetLeft-a.clientX,n=e.offsetTop-a.clientY,i={x:a.clientX,y:a.clientY}}),document.addEventListener(`mouseup`,t=>{t.preventDefault(),t.stopPropagation(),r=!1,!(i.x!==t.clientX||i.y!==t.clientY)&&setTimeout(()=>{f({...t,target:e})},0)}),document.addEventListener(`mousemove`,i=>{if(r){let r=e.parentElement,a=Math.max(Math.min(i.clientX+t,r.clientWidth-e.offsetWidth),0),o=Math.max(Math.min(i.clientY+n,r.clientHeight-e.offsetHeight),0);e.style.left=`${a}px`,e.style.top=`${o}px`}})},m={title:`ZPopover`,component:`z-popover`,argTypes:{position:{options:Object.values(a).filter(e=>e!==a.AUTO),control:{type:`select`}},"--z-popover-theme--surface":s(),"--z-popover-theme--text":s()},args:{position:null,"--z-popover-theme--surface":`var(--color-surface01)`,"--z-popover-theme--text":`var(--color-default-text)`,"--z-popover-padding":`0`},parameters:{docs:{story:{inline:!1,iframeHeight:500}},controls:{exclude:[`bind-to`]}}},h={args:{"--z-popover-padding":`var(--space-unit)`,"--z-popover-shadow-filter":`drop-shadow(0 1px 2px var(--shadow-color-base))`,center:!1,showArrow:!1,closable:!0},beforeEach:()=>{document.addEventListener(`DOMContentLoaded`,()=>{let e=document.querySelector(`#demo-trigger`);e&&p(e)})},render:e=>n(t,null,n(`div`,{class:`popover-container`},n(`z-popover`,{...e,style:l(e),bindTo:`#demo-trigger`},n(`div`,{class:`popover-content`},`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`)),n(`z-button`,{id:`demo-trigger`,icon:`plus-filled`})),n(`p`,{class:`heading-2`},`You can move the button to see the positioning adaptation while the popover is open.`))},g={args:{"--z-popover-theme--surface":`var(--color-surface01)`,"--z-popover-padding":`var(--space-unit)`,position:a.RIGHT_BOTTOM},render:e=>n(`div`,{class:`popover-container`},n(`z-popover`,{...e,style:l(e),bindTo:`#trigger`},n(`z-list`,null,n(`z-list-element`,{"divider-type":`element`},`Elemento 1`),n(`z-list-element`,{"divider-type":`element`},`Elemento 2`),n(`z-list-element`,null,`Elemento 3`))),n(`z-button`,{id:`trigger`,icon:`plus-filled`,onClick:f}))},_={args:{position:a.RIGHT,"--z-popover-padding":`var(--space-unit)`},render:e=>n(`div`,{class:`popover-container popover-container-tooltip`},n(`z-popover`,{...e,style:l(e),center:!0,showArrow:!0,bindTo:`#trigger`},n(`div`,{class:`popover-content`},`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`)),n(`z-button`,{id:`trigger`,icon:`plus-filled`,onClick:f}))},v={args:{position:a.TOP,"--z-popover-padding":`var(--space-unit)`},render:e=>n(`div`,{class:`popover-container popover-container-tooltip`},n(`div`,{class:`popover-internal-container`},n(`div`,{class:`popover-internal-container-2`},n(`z-popover`,{...e,style:l(e),center:!0,showArrow:!0,bindTo:`#trigger`},n(`div`,{class:`popover-content`},`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`)),n(`z-button`,{id:`trigger`,icon:`plus-filled`,onClick:f}))))},y=null,b=()=>{y&&(y.open=!0)},x={args:{position:a.TOP,"--z-popover-padding":`var(--space-unit)`},render:e=>n(`div`,{class:`popover-container`},n(`z-button`,{id:`offcanvas-trigger`,onClick:b},`open offcanvas`),n(`z-offcanvas`,{transitiondirection:o.UP,showBackdrop:!0,ref:e=>y=e},n(`div`,{slot:`canvasContent`},n(`z-popover`,{...e,style:l(e),"bind-to":`#popover-trigger`},n(`div`,{class:`popover-content`},`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`)),n(`z-button`,{id:`popover-trigger`,icon:`plus-filled`,onClick:f}))))},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
