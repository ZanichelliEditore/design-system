...
- a set of classes and CSS custom props for section titles`}}}},a=`The quick brown fox jumps over the lazy dog`,o=[`--font-size-1`,`--font-size-2`,`--font-size-3`,`--font-size-4`,`--font-size-5`,`--font-size-6`,`--font-size-7`,`--font-size-8`,`--font-size-9`,`--font-size-10`,`--font-size-11`,`--font-size-12`,`--font-size-13`,`--font-size-14`,`--font-size-15`,`--font-size-16`,`--font-size-17`],s=4,c=5,l=3,u=6,d=e=>e?`-${e}`:``,f=e=>{let t=getComputedStyle(document.documentElement);return`${Number.parseFloat(t.getPropertyValue(e))*Number.parseFloat(t.getPropertyValue(`font-size`))}px`},p={argTypes:{fontWeight:{options:[`--font-lt`,`--font-rg`,`--font-sb`,`--font-bd`],control:{type:`inline-radio`}}},args:{fontWeight:`--font-rg`},render:e=>t(`div`,{class:`type-scale`},o.map(n=>[t(`span`,{class:`body-5-sb`},n),t(`span`,{class:`body-5`},f(n)),t(`span`,{class:`sample-text`,style:{fontSize:`var(${n})`,fontFamily:`var(${e.fontFamily})`,fontWeight:`var(${e.fontWeight})`}},a)]))},m={argTypes:{headingWeight:{options:[`lt`,null,`sb`],control:{type:`inline-radio`,labels:{lt:`Light`,null:`Regular`,sb:`Semibold`}}},fontWeight:{options:[null,`sb`],control:{type:`inline-radio`,labels:{null:`Regular`,sb:`Semibold`}}}},args:{headingWeight:null,fontWeight:null},render:e=>t(`div`,{class:`typography-classes`},t(`div`,{class:`section-title-classes`},Array.from({length:u},(e,t)=>t+1).map(e=>t(`div`,{class:`typography-group`},t(`div`,{class:`section-title-${e}`},`Section title ${e}`),t(`div`,{class:`body-5-sb`},`.section-title-${e} / --section-title-${e}`)))),t(`div`,{class:`heading-classes`},Array.from({length:s},(e,t)=>t+1).map(n=>t(`div`,{class:`typography-group`},t(`div`,{class:`heading-${n}${d(e.headingWeight)}`,style:{fontFamily:`var(${e.fontFamily})`}},`Heading `,n),t(`div`,{class:`body-5-sb`},`.heading-${n}${d(e.headingWeight)}`)))),t(`div`,{class:`body-classes`},Array.from({length:c},(e,t)=>t+1).map(n=>t(`div`,{class:`typography-group`},t(`div`,{class:`body-${n}${d(e.fontWeight)}`,style:{fontFamily:`var(${e.fontFamily})`}},`Body `,n),t(`div`,{class:`body-5-sb`},`.body-${n}${d(e.fontWeight)}`)))),t(`div`,{class:`interactive-classes`},Array.from({length:l},(e,t)=>t+1).map(n=>t(`div`,{class:`typography-group`},t(`div`,{class:`interactive-${n}${d(e.fontWeight)}`,style:{fontFamily:`var(${e.fontFamily})`}},`Interactive `,n),t(`div`,{class:`body-5-sb`},`.interactive-${n}${d(e.fontWeight)}`)))),t(`div`,{class:`helper-classes`},t(`div`,{class:`typography-group`},t(`div`,{class:`helper${d(e.fontWeight)}`,style:{fontFamily:`var(${e.fontFamily})`}},`Helper`),t(`div`,{class:`body-5-sb`},`.helper${d(e.fontWeight)}`))))},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  argTypes: {
    fontWeight: {
