import"./lit-element--ufgQf_M.js";import{x as i}from"./lit-html-rc9TYZL2.js";const x={title:"Typography",argTypes:{fontFamily:{options:["--font-family-sans","--font-family-serif"],control:{type:"inline-radio"}}},args:{fontFamily:"--font-family-sans"},parameters:{docs:{description:{component:`The typographic styles are based on the \`IBM Plex\` font family.
