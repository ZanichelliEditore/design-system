import{r as e}from"./lit-CgIPLKVa.js";import{i as t}from"./z-icon-jtOHWf42.js";import{t as n}from"./storybook-utils-DtpJwcUL.js";import{t as r}from"./style-map-CH-uIwiZ.js";import"./z-tag-xeObdDf3.js";var i={title:`ZTag`,component:`z-tag`,argTypes:{icon:{control:{type:`select`},options:Object.keys(t).sort()},"--z-tag-text-color":n(),"--z-tag-bg":n()},args:{text:`In progress`,expandable:!1,icon:`gear`}},a={render:t=>e`<z-tag
      icon=${t.icon}
