import{n as e}from"./chunk-DnJy8xQt.js";import{gt as t,ut as n}from"./iframe-CcPk1Sjy.js";import{i as r,s as i}from"./iconset-BfOAkyaN.js";var a=e((()=>{})),o,s,c,l,u;e((()=>{n(),i(),a(),o={title:`CSS Components/ZLink`,parameters:{a11y:{disable:!0}},argTypes:{colorVariant:{options:[`z-link`,`z-link-blue`,`z-link-red`,`z-link-inverse`],control:{type:`inline-radio`}},icon:{options:Object.keys(r),control:{type:`select`}},"z-link-icon":{if:{arg:`icon`,truthy:!0}}},args:{colorVariant:`z-link`,text:`Zanichelli.it`,icon:null,"z-link-active":!1,"z-link-disabled":!1,"z-link-underline":!1,"z-link-icon":!1,"z-link-sb":!1}},s=e=>({"z-link":!0,"z-link-blue":e.colorVariant===`z-link-blue`,"z-link-red":e.colorVariant===`z-link-red`,"z-link-inverse":e.colorVariant===`z-link-inverse`,"z-link-active":e[`z-link-active`],"z-link-disabled":e[`z-link-disabled`],"z-link-underline":e[`z-link-underline`],"z-link-icon":e.icon||e[`z-link-icon`],"z-link-sb":e[`z-link-sb`]}),c={render:e=>t(`div`,{class:{"z-link-story":!0,"dark-bg":e.colorVariant===`z-link-inverse`}},t(`a`,{href:`zanichelli.it`,class:s(e)},e.icon?t(`z-icon`,{name:e.icon}):``,` `,e.text))},l={render:e=>t(`div`,{class:{"z-link-story":!0,"dark-bg":e.colorVariant===`z-link-inverse`}},t(`button`,{class:s(e)},e.icon?t(`z-icon`,{name:e.icon}):``,` `,e.text))},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
