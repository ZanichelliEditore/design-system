import{n as e}from"./chunk-DnJy8xQt.js";import{gt as t,ut as n}from"./iframe-CcPk1Sjy.js";import{K as r,M as i}from"./beans-zckFsBZy.js";import{n as a,o,t as s}from"./storybook-utils-BCDbkA4t.js";import{n as c,t as l}from"./index21-Cjk8Tg_r.js";var u,d=e((()=>{l(),u=c})),f=e((()=>{})),p,m,h,g,_,v,y,b,x;e((()=>{n(),r(),o(),d(),f(),p={title:`ZTooltip`,component:u,argTypes:{position:{options:[i.AUTO,i.TOP,i.BOTTOM,i.LEFT,i.RIGHT,i.TOP_LEFT,i.TOP_RIGHT,i.BOTTOM_LEFT,i.BOTTOM_RIGHT],control:{type:`select`}},"--z-tooltip-theme--surface":a()},args:{dark:!1,"--z-tooltip-theme--surface":`var(--color-surface01)`,position:i.LEFT},parameters:{controls:{exclude:[`bind-to`]},docs:{description:{component:'To be sure the algorithm finds the right container, when calculating the position, set its position to `position: relative;`\nOn the following Story, the "position" prop can be set only for the original positions of the `z-tooltip` by design.'}}}},h=()=>{m.open=!m.open},g={render:e=>t(`div`,{class:`tooltip-container`},t(`z-button`,{id:`trigger`,icon:`plus-filled`,onClick:h}),t(`z-tooltip`,{...e,ref:e=>m=e,style:s(e),bindTo:`#trigger`},t(`div`,{class:`content-container`},t(`z-button`,null,`Open`),t(`z-button`,null,`Save as`),t(`z-button`,null,`Share`))))},_=()=>m.open=!0,v=()=>m.open=!1,y=e=>{let t=e.target.closest(`z-button`);switch(t.icon){case`arrow-clockwise-up-left`:t.icon=`arrow-clockwise-up-right`;break;case`arrow-clockwise-up-right`:t.icon=`arrow-clockwise-down-right`;break;case`arrow-clockwise-down-right`:t.icon=`arrow-clockwise-up-left`;break}},b={render:e=>t(`div`,{class:`tooltip-container`},t(`z-button`,{id:`info-button`,icon:`arrow-clockwise-up-left`,onMouseOver:_,onFocusin:_,onMouseOut:v,onFocusout:v,onClick:y}),t(`z-tooltip`,{...e,closable:!1,bindTo:`#info-button`,ref:e=>m=e,style:s(e)},t(`span`,{class:`tooltip-info-text`},`Clicca per fare girare la freccia`)))},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
