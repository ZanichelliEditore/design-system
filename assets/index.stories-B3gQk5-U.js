import{x as e}from"./lit-element-DGXdXVoE.js";import"./index-D2wViOEM.js";import{s as g,g as p}from"./chunk-L4EGOTBX-lo-pZyle.js";import"./entry-preview-Cx7Tr7Nx.js";import{d as v,H as _,h as o,a as I}from"./index-BZ0rSFNp.js";import"./index-z2hubHp2.js";import"./index-DrFu-skq.js";const w=":host{position:relative;display:flex;width:100%;max-width:100%;box-sizing:border-box;flex-direction:row;padding:0;margin:0;font-family:var(--font-family-sans);font-weight:var(--font-rg);list-style:none}@media (min-width: 768px){:host{padding:0 calc(var(--space-unit) * 2)}}",A=class extends _{constructor(){super(),this.__registerHost(),this.__attachShadow()}render(){return o(I,{key:"4b42468b1058b9850bca3de5b190283e741dfa7c",role:"navigation"},o("slot",{key:"9d0dc7bfcb68be79de9e6d02d3040c922b21be07"}))}static get style(){return w}};v(A,[1,"z-stepper"]);const d={schemaVersion:"1.0.0",modules:[{kind:"javascript-module",path:"",declarations:[{kind:"class",name:"ZStepper",tagName:"z-stepper",customElement:!0,members:[],events:[],slots:[{name:"-",description:"slot for `z-stepper-item`"}]}],exports:[{kind:"js",name:"ZStepper",declaration:{name:"ZStepper",module:"src/components/z-stepper/index.tsx"}},{kind:"custom-element-definition",name:"z-stepper",declaration:{name:"ZStepper",module:"src/components/z-stepper/index.tsx"}}]}]};g({...p()||{},...d,modules:[...(p()||{}).modules||[],...d.modules]});var a=Object.freeze,E=Object.defineProperty,L=(t,Z)=>a(E(t,"raw",{value:a(t.slice())})),m;const N={title:"ZStepper/ZStepper",component:"z-stepper",decorators:[t=>e`<div class="z-carousel-story-container">${t()}</div>`],subcomponents:{ZStepperItem:"z-stepper-item"}},r={render:()=>e(m||(m=L([`<script>
        const onClick = (elem) => {
          if (!elem.disabled) {
