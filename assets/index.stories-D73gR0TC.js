import{r as e}from"./lit-CgIPLKVa.js";import{i as t,t as n}from"./chunk-L4EGOTBX-KlzQXQPc.js";import{a as r,n as i,o as a}from"./client-DQfH-YhT.js";import{H as o,U as s}from"./beans-CNd94UMz.js";import"./z-button-ColY3FoG.js";import"./z-toast-notification-MrQVHAtx.js";var c=()=>`:host{position:fixed;z-index:10000;display:flex;flex-flow:column nowrap;margin-top:calc(var(--space-unit) * 2);margin-bottom:calc(var(--space-unit) * 2);font-family:var(--font-family-sans);font-weight:var(--font-rg)}::slotted(z-toast-notification){width:100vw}::slotted(:not(:last-child)){margin-bottom:calc(var(--space-unit) * 1)}:host([position="bottom-centre"]),:host([position="bottom-right"]),:host([position="bottom-left"]){bottom:0;align-items:flex-end;justify-content:flex-end}:host([position="top-left"]),:host([position="top-right"]),:host([position="top-centre"]){top:0;align-items:flex-start;justify-content:flex-start}@media only screen and (min-width: 768px){:host{margin:calc(var(--space-unit) * 3)}:host([position="top-centre"]){top:0;left:50%;align-items:center;justify-content:flex-start;transform:translateX(-50%)}:host([position="top-left"]){top:0;left:0;align-items:flex-start;justify-content:flex-start}:host([position="top-right"]){top:0;right:0;align-items:flex-end;justify-content:flex-start}:host([position="bottom-centre"]){bottom:0;left:50%;align-items:center;justify-content:flex-end;transform:translateX(-50%)}:host([position="bottom-right"]){right:0;bottom:0;align-items:flex-end;justify-content:flex-end}:host([position="bottom-left"]){bottom:0;left:0;align-items:flex-start;justify-content:flex-end}::slotted(z-toast-notification){width:50vw}}@media only screen and (min-width: 1366px){:host{margin:calc(var(--space-unit) * 4)}::slotted(z-toast-notification){width:33vw}}`;r(class extends i{constructor(e){super(),e!==!1&&this.__registerHost(),this.__attachShadow(),this.position=o.TOP_RIGHT,this.newestontop=!0,this.notificationArray=[]}watchPropNewestontop(e){this.hostElement.append(...this.notificationArray.reverse()),e?this.hostElement.shadowRoot.addEventListener(`slotchange`,this.slotChangeHandler):this.hostElement.shadowRoot.removeEventListener(`slotchange`,this.slotChangeHandler)}componentWillLoad(){this.newestontop&&this.handleNewestOnTop()}handleNewestOnTop(){this.notificationArray=Array.from(this.hostElement.children),this.hostElement.append(...this.notificationArray.reverse()),this.hostElement.shadowRoot.addEventListener(`slotchange`,this.slotChangeHandler.bind(this))}slotChangeHandler(){let e=Array.from(this.hostElement.children).filter(e=>!this.notificationArray.includes(e));e&&e.forEach(e=>{this.notificationArray.push(e);let t=e;e.remove(),this.hostElement.prepend(t)})}render(){return a(`slot`,{key:`29e7ea359024d2214bbc885d34cc49cc6c86281f`,name:`toasts`})}get hostElement(){return this}static get watchers(){return{newestontop:[{watchPropNewestontop:0}]}}static get style(){return c()}},[257,`z-toast-notification-list`,{position:[520],newestontop:[4]},void 0,{newestontop:[{watchPropNewestontop:0}]}]);var l={schemaVersion:`1.0.0`,modules:[{kind:`javascript-module`,path:``,declarations:[{kind:`class`,name:`ZToastNotificationList`,tagName:`z-toast-notification-list`,customElement:!0,members:[{kind:`field`,name:`position`,type:`any`,description:`Set the position of toast notification list - top-left, top-centre, top-right, bottom-left, bottom-centre, bottom-right`,default:`ToastNotificationPosition.TOP_RIGHT`},{kind:`field`,name:`newestontop`,type:`boolean`,description:`Set the entry position of new notification in the list`,default:`true`}],events:[]}],exports:[{kind:`js`,name:`ZToastNotificationList`,declaration:{name:`ZToastNotificationList`,module:`src/components/z-toast-notification-list/index.tsx`}},{kind:`custom-element-definition`,name:`z-toast-notification-list`,declaration:{name:`ZToastNotificationList`,module:`src/components/z-toast-notification-list/index.tsx`}}]}]};t({...n()||{},...l,modules:[...(n()||{}).modules||[],...l.modules]});var u=(t,n=s.SLIDE_IN_DOWN,r)=>e`<div class="z-toast-notification-container">
