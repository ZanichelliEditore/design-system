import{x as a}from"./lit-element-DGXdXVoE.js";import{D as o,f as r}from"./index-C_NTAvuu.js";import{g as d}from"./storybook-utils-DAVCxM-F.js";import"./index-UUZX2LE-.js";import"./chunk-GKNNPQCW-BkHQSocK.js";import"./index-BJyMe-bF.js";const z={title:"ZDivider",component:"z-divider",argTypes:{size:{control:{type:"select"},options:Object.values(o)},orientation:{control:{type:"select"},options:Object.values(r)},color:{control:{type:"select"},options:d().map(e=>e.replace("--",""))}},args:{size:o.SMALL,color:"gray200",orientation:r.HORIZONTAL}},i={render:e=>a`<div style="height: 300px; padding: 24px">
      <z-divider
        size="${e.size}"
        color="${e.color}"
