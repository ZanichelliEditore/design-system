import{x as i}from"./lit-element-DGXdXVoE.js";import{C as t}from"./index-DN_DTmEP.js";import{a as f}from"./storybook-utils-DX4XXC0w.js";import"./chunk-L4EGOTBX-lo-pZyle.js";import"./entry-preview-Cx7Tr7Nx.js";import"./index-DrFu-skq.js";import"./index-BZ0rSFNp.js";const u={title:"ZIcon",component:"z-icon",argTypes:{fill:{options:f().map(o=>o.replace("--","")),control:{type:"select"}}},args:{name:"download",height:24,width:24,fill:"color-primary01"}},r={render:o=>i`<z-icon
      name=${o.name}
      height=${o.height}
      width=${o.width}
      fill=${o.fill}
  ...
  render: args => html\`<z-icon
    ...
    ></z-icon>\`
} satisfies Story`,...(g=(p=e.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};const S=["Default","ZIconRem","ColorIndicator"];export{e as ColorIndicator,r as Default,n as ZIconRem,S as __namedExportsOrder,u as default};
