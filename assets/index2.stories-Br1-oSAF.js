import{r as e}from"./lit-CgIPLKVa.js";import{i as t,t as n}from"./chunk-L4EGOTBX-KlzQXQPc.js";import{a as r,n as i,o as a,r as o}from"./client-Dpr5AR8E.js";import{t as s}from"./taggedTemplateLiteral-BA-xtlkT.js";import"./z-stepper-item-BuDq6ePE.js";var c=()=>`:host{position:relative;display:flex;width:100%;max-width:100%;box-sizing:border-box;flex-direction:row;padding:0;margin:0;font-family:var(--font-family-sans);font-weight:var(--font-rg);list-style:none}@media (min-width: 768px){:host{padding:0 calc(var(--space-unit) * 2)}}`;r(class extends i{constructor(e){super(),e!==!1&&this.__registerHost(),this.__attachShadow()}render(){return a(o,{key:`2107e77ef316a9980b45267f1aece07494d234ff`,role:`navigation`},a(`slot`,{key:`89a8da301afa08eca920c44f11feaa832af4f5aa`}))}static get style(){return c()}},[257,`z-stepper`]);var l={schemaVersion:`1.0.0`,modules:[{kind:`javascript-module`,path:``,declarations:[{kind:`class`,name:`ZStepper`,tagName:`z-stepper`,customElement:!0,members:[],events:[],slots:[{name:`-`,description:"slot for `z-stepper-item`"}]}],exports:[{kind:`js`,name:`ZStepper`,declaration:{name:`ZStepper`,module:`src/components/z-stepper/index.tsx`}},{kind:`custom-element-definition`,name:`z-stepper`,declaration:{name:`ZStepper`,module:`src/components/z-stepper/index.tsx`}}]}]};t({...n()||{},...l,modules:[...(n()||{}).modules||[],...l.modules]});var u,d={title:`ZStepper/ZStepper`,component:`z-stepper`,decorators:[t=>e`<div class="z-carousel-story-container">${t()}</div>`],subcomponents:{ZStepperItem:`z-stepper-item`}},f={render:()=>e(u||=s([`<script>
        const onClick = (elem) => {
          if (!elem.disabled) {
