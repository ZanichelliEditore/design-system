import{x as n}from"./lit-element-DGXdXVoE.js";import"./index-4zd9oTjS.js";import"./index-DlJyvK0a.js";import"./index-BONHzS9T.js";import{s as F,g as p}from"./chunk-L4EGOTBX-lo-pZyle.js";import"./entry-preview-Cx7Tr7Nx.js";import{d as G,H as D,h as d,a as W}from"./index-BYI030T8.js";import{K as u}from"./index-C0TNZEjZ.js";import"./index-8S3OXAZj.js";import"./index-Bi3gOHE_.js";import"./index-BcT8BT0S.js";import"./utils-DvUzZReC.js";import"./breakpoints-p3CVLX0Q.js";import"./index-DrFu-skq.js";import"./iframe-ZSMUqasm.js";const M=()=>":host,*{box-sizing:border-box}:host{display:flex;width:fit-content;align-items:center;padding:0;border:var(--border-size-small) solid var(--color-surface03);background-color:var(--color-surface01);border-radius:calc(var(--border-radius) + var(--border-size-small));box-shadow:var(--shadow-4);gap:calc(var(--space-unit) / 2)}::slotted(z-divider){height:calc(var(--space-unit) * 4.5) !important}@media (max-width: 767px){:host{--z-toolbar-columns:6;position:relative;display:grid;max-width:100%;background:repeating-linear-gradient(         to bottom,         transparent 0,         transparent calc(var(--space-unit) * 5.5),         var(--color-surface03) calc(var(--space-unit) * 5.5),         var(--color-surface03) calc(var(--space-unit) * 5.5 + 1px)       )       center / calc(100% - var(--space-unit)) 100% no-repeat var(--color-surface01);gap:var(--border-size-small) calc(var(--space-unit) / 2);grid-template-columns:repeat(var(--z-toolbar-columns, auto-fill), minmax(44px, auto))}::slotted(z-divider){display:none !important}}",_=class extends D{constructor(o){super(),o!==!1&&this.__registerHost(),this.__attachShadow(),this.currentFocusIndex=0,this.toolItems=[]}componentDidLoad(){this.collectToolItems(),this.updateTabIndexes();let o=parseInt(getComputedStyle(this.hostElement).getPropertyValue("--z-toolbar-columns")||"6");o=this.toolItems.length<=o?this.toolItems.length:o,this.hostElement.style.setProperty("--z-toolbar-columns",o.toString())}collectToolItems(){this.toolItems=Array.from(this.hostElement.querySelectorAll("z-tool:not(:scope z-tool z-tool)"))}updateTabIndexes(){this.toolItems.forEach((o,l)=>{o.setTabIndex(l===this.currentFocusIndex?0:-1)})}focusToolAt(o,l="next"){const t=this.toolItems[o];if(t){if(this.currentFocusIndex=o,!t.disabled){t.setFocus(),this.updateTabIndexes();return}l==="next"?this.focusNextTool():this.focusPreviousTool()}}focusNextTool(){const o=(this.currentFocusIndex+1)%this.toolItems.length;this.focusToolAt(o)}focusPreviousTool(){const o=(this.currentFocusIndex-1+this.toolItems.length)%this.toolItems.length;this.focusToolAt(o,"previous")}closeSiblingSubmenusOnOpen(o){if(o.detail!==!0)return;const l=o.target.closest("z-tool");!l||!this.toolItems.includes(l)||this.toolItems.forEach(t=>{t!==l&&t.open&&(t.open=!1)})}closeSiblingTooltipsOnOpen(o){if(o.detail!==!0)return;const l=o.target;this.toolItems.includes(l)&&this.toolItems.forEach(t=>{t!==l&&t.closeTooltip()})}handleKeyDown(o){const t=o.target.closest("z-tool");if(!t||!this.toolItems.includes(t))return;const i=this.toolItems.indexOf(t);switch(i!==-1&&(this.currentFocusIndex=i),o.key){case u.ARROW_RIGHT:o.preventDefault(),this.focusNextTool();break;case u.ARROW_LEFT:o.preventDefault(),this.focusPreviousTool();break}}handleFocusIn(o){const t=o.target.closest("z-tool"),i=this.toolItems.indexOf(t);i!==-1&&i!==this.currentFocusIndex&&(this.currentFocusIndex=i,this.updateTabIndexes())}render(){return d(W,{key:"4a621cf1bca170b85126c91ace732f6bd892da30",role:"toolbar","aria-label":this.htmlAriaLabel},d("slot",{key:"ace1afdda00e9edd84193be0b2d5c816a2b09198",onSlotchange:()=>{this.collectToolItems(),this.updateTabIndexes()}}))}get hostElement(){return this}static get style(){return M()}};G(_,[257,"z-toolbar",{htmlAriaLabel:[1,"html-aria-label"],currentFocusIndex:[32]},[[0,"toggleSubmenu","closeSiblingSubmenusOnOpen"],[0,"toggleTooltip","closeSiblingTooltipsOnOpen"],[0,"keydown","handleKeyDown"],[0,"focusin","handleFocusIn"]]]);const m={schemaVersion:"1.0.0",modules:[{kind:"javascript-module",path:"",declarations:[{kind:"class",name:"ZToolbar",tagName:"z-toolbar",customElement:!0,members:[{kind:"field",name:"htmlAriaLabel",type:"string",description:"Accessible label for the toolbar."}],events:[],cssProperties:[{name:"--z-toolbar-columns",description:"Number of items per row in the toolbar. Only applies on mobile viewport, when the toolbar can be displayed in a multi-row layout. Default: `6`."}]}],exports:[{kind:"js",name:"ZToolbar",declaration:{name:"ZToolbar",module:"src/components/z-toolbar/index.tsx"}},{kind:"custom-element-definition",name:"z-toolbar",declaration:{name:"ZToolbar",module:"src/components/z-toolbar/index.tsx"}}]}]};F({...p()||{},...m,modules:[...(p()||{}).modules||[],...m.modules]});const oo={title:"ZToolbar",component:"z-toolbar",args:{htmlAriaLabel:"Toolbar principale"},decorators:[o=>n`<div
  ...
  \`
} satisfies Story`,...(g=(h=e.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};var v,S,f;a.parameters={...a.parameters,docs:{...(v=a.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: args => html\`
    <z-toolbar html-aria-label=\${args.htmlAriaLabel}>
      <z-tool
        icon="gear"
  ...
  \`
} satisfies Story`,...(f=(S=a.parameters)==null?void 0:S.docs)==null?void 0:f.source}}};var I,w,x;r.parameters={...r.parameters,docs:{...(I=r.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: args => html\`
    <z-toolbar html-aria-label=\${args.htmlAriaLabel}>
      <z-tool
        icon="bg-color"
  ...
  \`
} satisfies Story`,...(O=($=z.parameters)==null?void 0:$.docs)==null?void 0:O.source}}};const to=["Default","WithDividers","WithNestedToolbar","WithDisabledTool","WithActiveTool","MultilineMobile"];export{e as Default,z as MultilineMobile,s as WithActiveTool,c as WithDisabledTool,a as WithDividers,r as WithNestedToolbar,to as __namedExportsOrder,oo as default};
