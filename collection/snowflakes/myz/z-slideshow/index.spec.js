...
describe("Suite test ZSlideshow", () => {
    ...
    it("Test render ZSlideshow with data set and click on scroll right and left", async () => {
        ...
        const scrollRight = page.root.shadowRoot.querySelector("z-icon.right");
        const scrollLeft = page.root.shadowRoot.querySelector("z-icon.left");
        let lengthSlide = 3;
        while (lengthSlide > 0) {
            expect(page.root).toEqualHtml(`
      <z-slideshow data="[&quot;https://link1.png&quot;, &quot;https://link2.png&quot; ,&quot;https://link3.png&quot;]">
         <mock:shadow-root>
           <div>
             <main>
               <z-icon class="${lengthSlide === 3 ? "disabled" : "false"} left scroll" height="40" name="chevron-left-circle" role="button" tabindex="0" width="40"></z-icon>
               <div id="slides" style="width: NaNpx; transform: translate(-NaNpx);">
               ...
               <z-icon class="${lengthSlide === 1 ? "disabled" : "false"} right scroll" height="40" name="chevron-right-circle" role="button" tabindex="0" width="40"></z-icon>
             </main>
             <footer>
               <div class="footer-left">
                 <slot name="footer-left"></slot>
