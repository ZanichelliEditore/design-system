...
export class ZListElement {
    ...
    render() {
        return (h(Host, { key: '8b3fcd0834960a5549178f3f26d48b8236f27449', "aria-expanded": this.expandable ? this.showInnerContent : null, onClick: this.handleClick, onFocus: () => this.ariaDescendantFocus.emit(this.listElementId), onKeyDown: this.handleKeyDown, clickable: this.clickable && !this.disabled, tabIndex: this.htmlTabindex }, h("div", { key: '6cd5ef8d54e9bb0780737cbd300a3809464c9901', class: "container", style: { color: `var(--${this.color})` }, tabindex: "-1", id: `z-list-element-id-${this.listElementId}`, part: "list-item-container" }, h("div", { key: '4ba2505a4483ec70134f6b39ce18351b679db379', class: "z-list-element-container" }, this.renderExpandableButton(), this.renderContent()), this.renderExpandedContent()), this.dividerType === ListDividerType.ELEMENT && (h("z-divider", { key: 'ac96ea3379df56b2a3b67164d52a0633764aab23', color: this.dividerColor, size: this.dividerSize }))));
    }
